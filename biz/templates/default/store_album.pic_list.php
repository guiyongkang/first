				...
				<td><?php if(is_array($output['pic_list']) && !empty($output['pic_list'])){?>
					<form name="select_sort" id="select_sort">
						...
						<select name="sort" id="img_sort">
							<option value="0"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '0'){?>selected <?php }?> ><?php echo $lang['album_sort_upload_time_desc'];?></option>
							<option value="1"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '1'){?>selected <?php }?> ><?php echo $lang['album_sort_upload_time_asc'];?></option>
							<option value="2"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '2'){?>selected <?php }?> ><?php echo $lang['album_sort_img_size_desc'];?></option>
							<option value="3"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '3'){?>selected <?php }?> ><?php echo $lang['album_sort_img_siza_asc'];?></option>
							<option value="4"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '4'){?>selected <?php }?> ><?php echo $lang['album_sort_img_name_desc'];?></option>
							<option value="5"  <?php if(isset($_GET['sort']) && $_GET['sort'] == '5'){?>selected <?php }?> ><?php echo $lang['album_sort_img_name_asc'];?></option>
						</select>
					</form>
					<?php }?></td>
			</tr>
...
$(function() {
    ...
    $('input[nctype="replace_image"]').each(function(){
        $(this).fileupload({
            dataType: 'json',
            url: '<?php echo APP_URL;?>/index.php?act=store_album&op=replace_image_upload&id=' + $(this).attr('id'),
    ...
    $('#fileupload').fileupload({
        dataType: 'json',
        url: '<?php echo APP_URL;?>/index.php?act=store_album&op=image_upload',
        add: function (e,data) {
...
function submit_form(type){
	...
	$('#checkboxform').attr('action','<?php echo APP_URL?>/index.php?act=store_album&op=album_pic_'+type);
