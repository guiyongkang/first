...
<script src="<?=RESOURCE_SITE_URL?>/js/jquery.ajaxContent.pack.js"></script>
<script src="<?=RESOURCE_SITE_URL?>/js/jquery-ui/i18n/zh-CN.js"></script>
<script src="<?=RESOURCE_SITE_URL?>/js/common_select.js"></script>
<script type="text/javascript" src="<?=RESOURCE_SITE_URL?>/js/fileupload/jquery.iframe-transport.js" charset="utf-8"></script>
<script type="text/javascript" src="<?=RESOURCE_SITE_URL?>/js/fileupload/jquery.ui.widget.js" charset="utf-8"></script>
<script type="text/javascript" src="<?=RESOURCE_SITE_URL?>/js/fileupload/jquery.fileupload.js" charset="utf-8"></script>
<script src="<?=RESOURCE_SITE_URL?>/js/jquery.poshytip.min.js"></script>
<script src="<?=RESOURCE_SITE_URL?>/js/jquery.mousewheel.js"></script>
<script type="text/javascript" src="<?=RESOURCE_SITE_URL?>/js/jquery.charCount.js"></script>
<!--[if lt IE 8]>
  <script src="<?=RESOURCE_SITE_URL?>/js/json2.js"></script>
<![endif]-->
<script src="<?=APP_RESOURCE_SITE_URL?>/js/store_goods_add.step2.js"></script>
<link rel="stylesheet" type="text/css" href="<?=RESOURCE_SITE_URL?>/js/jquery-ui/themes/ui-lightness/jquery.ui.css"  />
<style type="text/css">
#fixedNavBar {
...
<div class="item-publish">
	<form method="post" id="goods_form" action="<?php if ($output['edit_goods_sign']) { echo urlBiz('store_goods_online', 'edit_save_goods');} else { echo urlBiz('store_goods_add', 'save_goods');}?>">
		...
		<div class="ncsc-form-goods">
			...
			<dl>
				...
				<dd id="gcategory"> <?php echo $output['goods_class']['gc_tag_name'];?> <a class="ncsc-btn" href="<?php if ($output['edit_goods_sign']) { echo urlBiz('store_goods_online', 'edit_class', array('commonid' => $output['goods']['goods_commonid'], 'ref_url' => getReferer())); } else { echo urlBiz('store_goods_add', 'add_step_one'); }?>"><?php echo $lang['nc_edit'];?></a>
			...
			<dl>
				...
				<dd>
					<input name="g_name" type="text" class="text w400" value="<?php echo isset($output['goods']) ? $output['goods']['goods_name'] : ''; ?>" />
					<span></span>
			...
			<dl>
				...
				<dd>
					<textarea name="g_jingle" class="textarea h60 w400"><?php echo isset($output['goods']) ? $output['goods']['goods_jingle'] : ''; ?></textarea>
					<span></span>
			...
			<dl>
				...
				<dd nc_type="no_spec">
					<input name="g_price" value="<?php echo isset($output['goods']) ? $output['goods']['goods_price'] : ''; ?>" type="text"  class="text w60" />
					<em class="add-on"><font style="font-weight:bold">积分</font></em> <span></span>
			...
			<dl>
				...
				<dd>
					<input name="g_marketprice" value="<?php echo isset($output['goods']) ? $output['goods']['goods_marketprice'] : ''; ?>" type="text" class="text w60" />
					<em class="add-on"><font style="font-weight:bold">积分</font></em> <span></span>
			...
			<dl>
				...
				<dd>
					<input name="g_costprice" value="<?php echo isset($output['goods']) ? $output['goods']['goods_costprice'] : ''; ?>" type="text" class="text w60" />
					<em class="add-on"><font style="font-weight:bold">积分</font></em> <span></span>
			...
			<dl>
				...
				<dd>
					<input name="g_discount" value="<?php echo isset($output['goods']) ? $output['goods']['goods_discount'] : ''; ?>" type="text" class="text w60" readonly="readonly" style="background:#E7E7E7 none;" />
					<em class="add-on">%</em>
			...
			<dl nc_type="spec_group_dl_<?php echo $i;?>" nctype="spec_group_dl" class="spec-bg" <?php if($k == '1'){?>spec_img="t"<?php }?>>
				...
				<dd <?php if($k == '1'){?>nctype="sp_group_val"<?php }?>>
					<ul class="spec">
						...
						<?php }?>
						<?php }?>
						<li data-param="{gc_id:<?php echo $output['goods_class']['gc_id'];?>,sp_id:<?php echo $k;?>,url:'<?php echo urlBiz('store_goods_add', 'ajax_add_spec');?>'}">
			...
			<dl>
				...
				<dd>
					<input name="g_alarm" value="<?php echo isset($output['goods']) ? $output['goods']['goods_storage_alarm'] : '';?>" type="text" class="text w60" />
					<span></span>
			...
			<dl>
				...
				<dd nc_type="no_spec">
					<p>
						<input name="g_serial" value="<?php echo isset($output['goods']) ? $output['goods']['goods_serial'] : ''; ?>" type="text"  class="text"  />
					</p>
				...
				<dd>
					<div class="ncsc-goods-default-pic">
						<div class="goodspic-uplaod">
							<div class="upload-thumb"> <img nctype="goods_image" src="<?php echo thumb(isset($output['goods']) ? $output['goods'] : array(), 240);?>"/> </div>
							<input type="hidden" name="image_path" id="image_path" nctype="goods_image" value="<?php echo isset($output['goods']) ? $output['goods']['goods_image'] : ''?>" />
							<span></span>
							<p class="hint"><?php echo $lang['store_goods_step2_description_one'];?><?php printf(isset($lang['store_goods_step2_description_two']) ? $lang['store_goods_step2_description_two'] : '',intval($output['setting_config']['image_max_filesize'])/1024);?></p>
							<div class="handle">
								...
								<a class="ncsc-btn mt5" nctype="show_image" href="<?php echo urlBiz('store_album', 'pic_list', array('item'=>'goods'));?>"><i class="icon-picture"></i>从图片空间选择</a> <a href="javascript:void(0);" nctype="del_goods_demo" class="ncsc-btn mt5" style="display: none;"><i class="icon-circle-arrow-up"></i>关闭相册</a></div>
						</div>
					</div>
					<div id="demo"></div>
				</dd>
			...
			<dl style="overflow: visible;">
				...
				<dd>
					<div class="ncsc-brand-select">
						<div class="selection">
							<input name="b_name" id="b_name" value="<?php echo isset($output['goods']) ? $output['goods']['brand_name'] : '';?>" type="text" class="text w180" readonly="readonly" />
							<input type="hidden" name="b_id" id="b_id" value="<?php echo isset($output['goods']) ? $output['goods']['brand_id'] : '';?>" />
							<em class="add-on" nctype="add-on"><i class="icon-collapse"></i></em></div>
						<div class="ncsc-brand-select-container">
							<div class="brand-index" data-tid="<?php echo $output['goods_class']['type_id'];?>" data-url="<?php echo urlBiz('store_goods_add', 'ajax_get_brand');?>">
			...
			<dl>
				...
				<dd id="ncProductDetails">
					<div class="tabs">
						<ul class="ui-tabs-nav" jquery1239647486215="2" style="display:none;">
							<li class="selected"><a href="#panel-1" jquery1239647486215="8"><i class="icon-desktop"></i> 电脑端</a></li>
							<li class="ui-tabs-selected"><a href="#panel-2" jquery1239647486215="9"><i class="icon-mobile-phone"></i>手机端</a></li>
						</ul>
						<div id="panel-1" class="ui-tabs-panel ui-tabs-hide" jquery1239647486215="4">
							<?php showEditor('g_body',isset($output['goods']) ? $output['goods']['goods_body'] : '','100%','480px','visibility:hidden;',"false",$output['editor_multimedia']);?>
							<div class="hr8">
								<div class="ncsc-upload-btn"> <a href="javascript:void(0);"><span>
						...
						<div id="panel-2" class="ui-tabs-panel" jquery1239647486215="5">
							...
							<div class="ncsc-mobile-edit-area" nctype="mobile_editor_area">
								...
								<div class="ncsc-mea-text" nctype="mea_txt" style="display: none;">
									...
									<a class="text-close" nctype="meat_cancel" href="javascript:void(0);">X</a> </div>
							</div>
							<input name="m_body" autocomplete="off" type="hidden" value='<?php echo isset($output['goods']) ? $output['goods']['mobile_body'] : '';?>'>
						</div>
					</div>
				</dd>
			</dl>
			<dl>
				...
				<dd> <span class="mr50">
					...
					<select name="plate_top">
						...
						<option value="<?php echo $val['plate_id']?>" <?php if (isset($output['goods']['plateid_top']) && ($output['goods']['plateid_top'] == $val['plate_id'])) {?>selected="selected"<?php }?>><?php echo $val['plate_name'];?></option>
						<?php }?>
						<?php }?>
					</select>
					...
					<select name="plate_bottom">
						...
						<option value="<?php echo $val['plate_id']?>" <?php if (isset($output['goods']['plateid_bottom']) && ($output['goods']['plateid_bottom'] == $val['plate_id'])) {?>selected="selected"<?php }?>><?php echo $val['plate_name'];?></option>
						<?php }?>
						<?php }?>
					</select>
					</span> </dd>
			...
			<dl class="special-01">
				...
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input type="radio" name="is_gv" value="1" id="is_gv_1" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>checked<?php }?> />
							<label for="is_gv_1">是</label>
						</li>
						<li>
							<input type="radio" name="is_gv" value="0" id="is_gv_0" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 0) {?>checked<?php }?> />
			...
			<dl class="special-01" nctype="virtual_valid" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 0) {?>style="display:none;"<?php }?>>
			...
			<dl class="special-01" nctype="virtual_valid" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 0) {?>style="display:none;"<?php }?>>
				...
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input type="radio" name="g_vinvalidrefund" id="g_vinvalidrefund_1" value="1" <?php if (isset($output['goods']) && $output['goods']['virtual_invalid_refund'] ==1) {?>checked<?php }?>>
							<label for="g_vinvalidrefund_1">是</label>
						</li>
						<li>
							<input type="radio" name="g_vinvalidrefund" id="g_vinvalidrefund_0" value="0" <?php if (isset($output['goods']) && $output['goods']['virtual_invalid_refund'] == 0) {?>checked<?php }?>>
			...
			<!-- 只有可发布虚拟商品才会显示 E --> 
			<!-- F码商品专有项 S -->
			<dl class="special-02" nctype="virtual_null" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
				<dt>F码商品<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input type="radio" name="is_fc" id="is_fc_1" value="1" <?php if (isset($output['goods']) && $output['goods']['is_fcode'] == 1) {?>checked<?php }?>>
							<label for="is_fc_1">是</label>
						</li>
						<li>
							<input type="radio" name="is_fc" id="is_fc_0" value="0" <?php if (isset($output['goods']) && $output['goods']['is_fcode'] == 0) {?>checked<?php }?>>
			...
			<dl class="special-02" nctype="fcode_valid" <?php if (isset($output['goods']) && $output['goods']['is_fcode'] == 0) {?>style="display:none;"<?php }?>>
				<dt>
					<?php if (empty($output['edit_goods_sign'])) {?>
					<i class="required">*</i>
					<?php }?>
			...
			<?php if (isset($output['goods']) && $output['goods']['is_fcode'] == 1) {?>
			<dl class="special-02" nctype="fcode_valid">
				<dt> <a class="ncsc-btn-mini ncsc-btn-red" href="<?php echo urlBiz('store_goods_online', 'download_f_code_excel', array('commonid' => isset($output['goods']['goods_commonid']) ? $output['goods']['goods_commonid'] : 0));?>">下载F码</a>&nbsp;&nbsp;F码<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<ul class="ncsc-form-radio-list">
			...
			<!-- F码商品专有项 E --> 
			<!-- 预售商品 S -->
			<dl class="special-03" nctype="virtual_null" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
				<dt>预售<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input type="radio" name="is_presell" id="is_presell_1" value="1" <?php if(isset($output['goods']) && $output['goods']['is_presell'] == 1) {?>checked<?php }?>>
							<label for="is_presell_1">是</label>
						</li>
						<li>
							<input type="radio" name="is_presell" id="is_presell_0" value="0" <?php if(isset($output['goods']) && $output['goods']['is_presell'] == 0) {?>checked<?php }?>>
			...
			<dl class="special-03" nctype="is_presell" <?php if (isset($output['goods']) && $output['goods']['is_presell'] == 0) {?>style="display:none;"<?php }?>>
				<dt><i class="required">*</i>发货日期<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<input type="text" name="g_deliverdate" id="g_deliverdate" class="w80 text" value="<?php if (isset($output['goods']) && $output['goods']['presell_deliverdate'] > 0) {echo date('Y-m-d', $output['goods']['presell_deliverdate']);}?>">
					<em class="add-on"><i class="icon-calendar"></i></em> <span></span>
			...
			<dl>
				...
				<dd>
					<input type="hidden" value="<?php echo isset($output['goods']['areaid_2']) ? $output['goods']['areaid_2'] : (isset($output['goods']['areaid_1']) ? $output['goods']['areaid_1'] : '');?>" name="region" id="region">
					<input type="hidden" value="<?php echo isset($output['goods']['areaid_1']) ? $output['goods']['areaid_1'] : '';?>" name="province_id" id="_area_1">
					<input type="hidden" value="<?php echo isset($output['goods']['areaid_2']) ? $output['goods']['areaid_2'] : '';?>" name="city_id" id="_area_2">
					</p>
				</dd>
			</dl>
			<dl nctype="virtual_null" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
				<dt><?php echo $lang['store_goods_index_goods_transfee_charge'].$lang['nc_colon']; ?></dt>
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input id="freight_0" nctype="freight" name="freight" class="radio" type="radio" <?php if (isset($output['goods']) && intval($output['goods']['transport_id']) == 0) {?>checked="checked"<?php }?> value="0">
							<label for="freight_0">固定运费</label>
							<div nctype="div_freight" <?php if (isset($output['goods']) && intval($output['goods']['transport_id']) != 0) {?>style="display: none;"<?php }?>>
								<input id="g_freight" class="w50 text" nc_type='transport' type="text" value="<?php printf('%.2f', isset($output['goods']) ? floatval($output['goods']['goods_freight']) : 0);?>" name="g_freight">
								<em class="add-on"><font style="font-weight:bold">积分</font></em> </div>
						</li>
						<li>
							<input id="freight_1" nctype="freight" name="freight" class="radio" type="radio" <?php if (isset($output['goods']) && intval($output['goods']['transport_id']) != 0) {?>checked="checked"<?php }?> value="1">
							<label for="freight_1"><?php echo $lang['store_goods_index_use_tpl'];?></label>
							<div nctype="div_freight" <?php if (isset($output['goods']) && intval($output['goods']['transport_id']) == 0) {?>style="display: none;"<?php }?>>
								<input id="transport_id" type="hidden" value="<?php echo isset($output['goods']) ? $output['goods']['transport_id'] : '';?>" name="transport_id">
								<input id="transport_title" type="hidden" value="<?php echo isset($output['goods']) ? $output['goods']['transport_title'] : '';?>" name="transport_title">
								<span id="postageName" class="transport-name" <?php if (!empty($output['goods']) && intval($output['goods']['transport_id'])) {?>style="display: inline-block;"<?php }?>><?php echo isset($output['goods']['transport_title']) ? $output['goods']['transport_title'] : '';?></span><a href="JavaScript:void(0);" onclick="window.open('index.php?act=store_transport&type=select')" class="ncbtn" id="postageButton"><i class="icon-truck"></i><?php echo $lang['store_goods_index_select_tpl'];?></a> </div>
						</li>
					</ul>
					<p class="hint">运费设置为 0 积分，前台商品将显示为免运费。</p>
				</dd>
			</dl>
			<!-- 商品物流信息 E -->
			<h3 id="demo5" nctype="virtual_null" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>发票信息</h3>
			<dl nctype="virtual_null" <?php if (isset($output['goods']) && $output['goods']['is_virtual'] == 1) {?>style="display:none;"<?php }?>>
				<dt>是否开增值税发票：</dt>
				<dd>
					<ul class="ncsc-form-radio-list">
			...
			<dl>
				...
				<dd><span class="new_add"><a href="javascript:void(0)" id="add_sgcategory" class="ncsc-btn"><?php echo $lang['store_goods_index_new_class'];?></a> </span>
					...
					<select name="sgcate_id[]" class="sgcategory" style="margin-right:3px;">
			...
			<dl style="display:none;">
				...
				<dd>
					<ul class="ncsc-form-radio-list">
						<li>
							<input type="radio" name="is_appoint" id="is_appoint_1" value="1"  <?php if(isset($output['goods']) && $output['goods']['is_appoint'] == 1) {?>checked<?php }?>>
							<label for="is_appoint_1">是</label>
						</li>
						<li>
							<input type="radio" name="is_appoint" id="is_appoint_0" value="0"  <?php if(isset($output['goods']) && $output['goods']['is_appoint'] == 0) {?>checked<?php }?>>
			...
			<dl style="display:none;" nctype="is_appoint"  <?php if (isset($output['goods']) && $output['goods']['is_appoint'] == 0) {?>style="display:none;"<?php }?>>
				<dt><i class="required">*</i>发售日期<?php echo $lang['nc_colon'];?></dt>
				<dd>
					<input type="text" name="g_saledate" id="g_saledate" class="w80 text" value="<?php if (isset($output['goods']) && $output['goods']['appoint_satedate'] > 0) {echo date('Y-m-d', $output['goods']['appoint_satedate']);}?>">
					<span></span>
		...
		<div class="bottom tc hr32">
			<label class="submit-border">
				<input type="submit" class="submit" value="<?php if (!empty($output['edit_goods_sign'])) {echo '提交';} else {?><?php echo $lang['store_goods_add_next'];?>，上传商品图片<?php }?>" />
			</label>
		</div>
	</form>
</div>
...
var APP_RESOURCE_SITE_URL = "<?php echo APP_RESOURCE_SITE_URL;?>";
...
$(function(){
    ...
    $('#goods_form').validate({
        ...
        rules : {
			...
			g_fccount : {
				<?php if (empty($output['edit_goods_sign'])) {?>required	: function() {if ($("#is_fc_1").prop("checked")) {return true;} else {return false;}},<?php }?>
				range		: [1,100]
			},
			g_fcprefix : {
				<?php if (empty($output['edit_goods_sign'])) {?>required	: function() {if ($("#is_fc_1").prop("checked")) {return true;} else {return false;}},<?php }?>
...
function recursionSpec($len,$sign) {
    if($len < $sign){
        ...
        echo "str +='<td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][marketprice]\" data_type=\"marketprice\" nc_type=\"'+spec_bunch+'|marketprice\" value=\"\" /><em class=\"add-on\"><font style=\"font-weight:bold\">积分</font></em></td><td><input class=\"text price\" type=\"text\" name=\"spec['+spec_bunch+'][price]\" data_type=\"price\" nc_type=\"'+spec_bunch+'|price\" value=\"\" /><em class=\"add-on\"><font style=\"font-weight:bold\">积分</font></em></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][stock]\" data_type=\"stock\" nc_type=\"'+spec_bunch+'|stock\" value=\"\" /></td><td><input class=\"text stock\" type=\"text\" name=\"spec['+spec_bunch+'][alarm]\" data_type=\"alarm\" nc_type=\"'+spec_bunch+'|alarm\" value=\"\" /></td><td><input class=\"text sku\" type=\"text\" name=\"spec['+spec_bunch+'][sku]\" nc_type=\"'+spec_bunch+'|sku\" value=\"\" /></td></tr>';\n";
        for($i=0; $i< $len; $i++){
            echo "}\n";
        }
    }
...
<?php if (!empty($output['goods']) && (!isset($_GET['class_id']) || $_GET['class_id'] <= 0) && !empty($output['sp_value']) && !empty($output['spec_checked']) && !empty($output['spec_list'])){?>
//  编辑商品时处理JS
$(function(){
	var E_SP = new Array();
	var E_SPV = new Array();
...
<script src="<?php echo APP_RESOURCE_SITE_URL;?>/js/scrolld.js"></script> 
