<?php defined('SAFE_CONST') or exit('Access Invalid!');?>
  ...
  <table class="ncsc-table-style">
    ...
    <tbody>
      ...
      <tr class="bd-line">
      <td></td>
      <td><div class="pic-thumb"><a href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank"><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>"/></a></div></td>
        <td class="tl"><dl class="goods-name">
          <dt><a href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank"><?php echo $val['groupbuy_name'];?></a></dt><dd></dd></dl></td>
