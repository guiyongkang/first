...
<dl>
	...
	<dd>未生成&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="javascript:void(0);" id="build_voucher">点击生成代金券卡密</a></dd>
</dl>
<?php } ?>
...
<dl>
	...
	<dd>
		<input type="text" class="w340" onclick="oCopy(this)" value="<?php echo APP_URL.DS;?>index.php?act=voucher&op=getvoucher&tid=<?php echo $output['t_info']['voucher_t_id'];?>" readonly/>
		<script>
	function oCopy(obj){
      obj.select();
...
<h3>已生成代金券 <a id="voucher_exportbtn" class="ncbtn-mini" href="javascript:void(0);" onclick="javascript:go('index.php?act=store_voucher&op=voucher_export&tid=<?php echo $output['t_info']['voucher_t_id']; ?>');" title="导出Excel" style="float: right; margin-right: 10px; display: none;">导出Excel</a> </h3>
