...
<div class="ncsc-form-default">
  <form id="form_setting" method="post" action="<?php echo urlBiz('store_decoration', 'decoration_setting_save');?>">
    <dl>
    ...
    <dl>
      ...
      <dd> <a href="<?php echo urlBiz('store_decoration', 'decoration_edit', array('decoration_id' => $output['decoration_id']));?>" class="ncsc-btn ncsc-btn-acidblue mr5" target="_blank"><i class="icon-puzzle-piece"></i>装修页面</a> <a id="btn_build" href="<?php echo urlBiz('store_decoration', 'decoration_build', array('decoration_id' => $output['decoration_id']));?>" class="ncsc-btn ncsc-btn-orange" target="_blank"><i class="icon-magic"></i>生成页面</a>
