...
<div class="ncsc-form-default">
	<dl>
		...
		<dd>
			<form id="design_form"
				action="<?php echo urlBiz('store_waybill', 'waybill_design_save');?>"
				method="post">
	...
	<div class="bottom">
		<label class="submit-border">
			...
			class="submit" value="<?php echo $lang['nc_submit'];?>">
		</label>
	</div>
</div>
<div id="dialog_item_edit" class="eject_con" style="display: none;">
	...
	<dl>
		<dt>左偏移量：</dt>
		<dd>
			<input id="dialog_left" class="w60 text" type="text" value="">
			<em
				class="add-on">mm</em> </dd>
	</dl>
	<dl>
		<dt>上偏移量：</dt>
		<dd>
			<input id="dialog_top" class="w60 text" type="text" value="">
			<em
				class="add-on">mm</em> </dd>
	</dl>
	<dl>
		<dt>宽：</dt>
		<dd>
			<input id="dialog_width" class="w60 text" type="text" value="">
			<em
				class="add-on">mm</em> </dd>
	</dl>
	<dl>
		<dt>高：</dt>
		<dd>
			<input id="dialog_height" class="w60 text" type="text" value="">
			<em
				class="add-on">mm</em> </dd>
	</dl>
	<div class="bottom pt10 pb10"> <a id="btn_dialog_submit" class="ncsc-btn ncsc-btn-green"
			href="javascript:;">确认</a> <a id="btn_dialog_cancel" class="ncsc-btn"
