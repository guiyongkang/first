...
<form method="get" id="formSearch">
	<table class="search-form">
		...
		<tr>
			...
			<td class="w180"><input type="text" class="text w70" name="query_start_date" id="query_start_date" value="<?php echo $_GET['query_start_date']; ?>"/>
				&#8211;
				<input type="text" class="text w70" name="query_end_date" id="query_end_date" value="<?php echo $_GET['query_end_date']; ?>"/></td>
...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td><a target="_blank" href="index.php?act=store_vr_order&op=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a></td>
		</tr>
		<?php } ?>
		<?php } else { ?>
		<tr>
