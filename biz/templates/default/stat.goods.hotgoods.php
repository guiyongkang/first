    	...
    	<div>
    		<table class="ncsc-default-table">
              ...
              <tbody>
                ...
                <tr class="bd-line">
                  <td><?php echo $k+1; ?></td>
                  <td class="tl"><span class="over_hidden w400 h20"><a href="<?php echo urlBiz('goods', 'index', array('goods_id' => $v['goods_id']));?>" target="_blank"><?php echo $v['goods_name'];?></a></span></td>
