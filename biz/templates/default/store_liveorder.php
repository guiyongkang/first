...
<div class="tabmenu">
  ...
  <a href="javascript:void(0);" class="ncsc-btn ncsc-btn-orange" dialog_id="store_msg_info" dialog_title="兑换码验证" dialog_width="640" nc_type="dialog" uri="<?php echo urlBiz('store_liveorder', 'store_liveverify');?>"><i class="icon-edit"></i>兑换码验证</a> </div>
...
<table class="ncsc-table-style order">
  ...
  <tr>
    <td class="bdl"></td>
    <td class="w50"><div class="pic-thumb"><a href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>" target="_blank"><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>"/></a></div></td>
    <td class="tl"><dl class="goods-name">
        <dt><a target="_blank" href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$val['groupbuy_id']));?>"><?php echo $val['item_name'];?></a></dt>
        <dd></dd>
      </dl></td>
