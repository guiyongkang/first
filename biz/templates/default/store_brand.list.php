...
<table class="search-form">
	<form method="get">
		...
		<tr>
			...
			<td class="w160"><input type="text" class="text" name="brand_name" value="<?php echo isset($_GET['brand_name']) ? $_GET['brand_name'] : ''; ?>"/></td>
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td class="nscs-table-handle"><?php if ($val['brand_apply'] == 0) { ?>
				<span><a href="javascript:void(0)" class="btn-blue" nc_type="dialog" dialog_title="<?php echo $lang['store_goods_brand_edit'];?>" dialog_id="my_goods_brand_edit" dialog_width="480" uri="index.php?act=store_brand&op=brand_add&brand_id=<?php echo $val['brand_id']; ?>"><i class="icon-edit"></i>
				<p><?php echo $lang['nc_edit'];?></p>
				</a></span> <span><a href="javascript:void(0)" class="btn-red" onclick="ajax_get_confirm('<?php echo $lang['nc_ensure_del'];?>', 'index.php?act=store_brand&op=drop_brand&brand_id=<?php echo $val['brand_id']; ?>');"><i class="icon-trash"></i>
