...
<div class="ncsc-flow-item">
	...
	<div class="item-goods">
		...
		<dl>
			<dt>
				<div class="ncsc-goods-thumb-mini"><a href="<?php echo urlBiz('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <img src="<?php echo thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,240); ?>>')" onMouseOut="toolTip()" /> </a></div>
			</dt>
			<dd><a href="<?php echo urlBiz('goods','index',array('goods_id'=> $val['goods_id'])); ?>" target="_blank"> <?php echo $val['goods_name']; ?> </a> <?php echo $lang['currency'];?><?php echo $val['goods_price'];?>&nbsp;*&nbsp;<?php echo $val['goods_num'];?><font color="#AAA">(<?php echo $lang['complain_text_num'];?>)</font> <span><?php echo orderGoodsType($val['goods_type']);?></span></dd>
		</dl>
		<?php } ?>
		<?php } ?>
	</div>
	<div class="item-order">
		...
		<dl class="line">
			...
			<dd><a href="<?php echo APP_URL;?>/index.php?act=store_order&op=show_order&order_id=<?php echo $output['order']['order_id'];?>" target="_blank"> <?php echo $output['order']['order_sn'];?> </a><a href="javascript:void(0);" class="a">更多<i class="icon-angle-down"></i>
