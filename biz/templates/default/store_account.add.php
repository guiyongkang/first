...
<div class="ncsc-form-default">
  <form id="add_form" action="<?php echo urlBiz('store_account', 'account_save');?>" method="post">
    <dl>
...
$(document).ready(function(){
    jQuery.validator.addMethod("seller_name_exist", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlBiz('store_account', 'check_seller_name_exist');?>',  
            async:false,  
    ...
    jQuery.validator.addMethod("check_member_password", function(value, element, params) { 
        ...
        $.ajax({  
            type:"GET",  
            url:'<?php echo urlBiz('store_account', 'check_seller_member');?>',  
            async:false,  
