...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_search_goods').on('click', function() {
            var url = "<?php echo urlBiz('store_promotion_xianshi', 'goods_select');?>";
        ...
        $('#div_goods_search_result').on('click', '#btn_submit', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlBiz('store_promotion_xianshi', 'xianshi_goods_add');?>', 
        ...
        $('#btn_edit_xianshi_goods_submit').on('click', function() {
            ...
            if(!isNaN(xianshi_price) && xianshi_price > 0 && xianshi_price < goods_price) {
                $.post('<?php echo urlBiz('store_promotion_xianshi', 'xianshi_goods_price_edit');?>',
        ...
        $('#xianshi_goods_list').on('click', '[nctype="btn_del_xianshi_goods"]', function() {
            ...
            if(confirm('确认删除？')) {
                var xianshi_goods_id = $(this).attr('data-xianshi-goods-id');
                $.post('<?php echo urlBiz('store_promotion_xianshi', 'xianshi_goods_delete');?>',
...
<div class="alert"> <strong><?php echo $lang['nc_explain'];?><?php echo $lang['nc_colon'];?></strong>
	<ul>
...
<div id="dialog_edit_xianshi_goods" class="eject_con" style="display:none;">
	...
	<dl>
		...
		<dd>
			...
			<p id="dialog_edit_xianshi_goods_error" style="display:none;">
				<label for="dialog_edit_xianshi_goods_error" class="error"><i class='icon-exclamation-sign'></i>折扣价格不能为空，且必须小于商品价格</label>
			</p>
	</dl>
	<div class="eject_con">
