...
<div class="ncsc-form-default">
	<form id="add_form" action="<?php echo urlBiz('store_waybill', 'waybill_save');?>" method="post" enctype="multipart/form-data">
		...
		<dl>
			...
			<dd>
				<input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_name'] : '';?>" name="waybill_name" id="waybill_name" class="w120 text">
				<span></span>
		...
		<dl>
			...
			<dd>
				<input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_width'] : '';?>" name="waybill_width" id="waybill_width" class="w60 text">
		...
		<dl>
			...
			<dd>
				<input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_height'] : '';?>" name="waybill_height" id="waybill_height" class="w60 text">
				<em class="add-on">mm</em> <span></span>
		...
		<dl>
			...
			<dd>
				<input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_top'] : '0';?>" name="waybill_top" id="waybill_top" class="w60 text">
				<em class="add-on">mm</em> <span></span>
		...
		<dl>
			...
			<dd>
				<input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_left'] : '0';?>" name="waybill_left" id="waybill_left" class="w60 text">
				<em class="add-on">mm</em> <span></span>
