		...
		<dl>
			...
			<dd>
				<div class="ncsc-upload-thumb store-sns-pic">
					<p><img nctype="normal_img" src="<?php echo APP_TEMPLATES_URL?>/images/member/default_image.png"/></p>
				...
				<p class="hint"><?php printf($lang['store_sns_normal_tips'],intval($output['setting_config']['image_max_filesize'])/1024);?></p>
			</dd>
		</dl>
		<dl>
...
$(function(){
	...
	$('a[nctype="get_img"]').ajaxContent({
		...
		loaderType:"img",
		loadingMsg:APP_TEMPLATES_URL+"/images/transparent.gif",
	...
	$('#normal_file').unbind().live('change', function(){
		$('img[nctype="normal_img"]').attr('src',APP_TEMPLATES_URL+"/images/loading.gif");
