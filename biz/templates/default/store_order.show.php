		...
		<div class="ncsc-order-details">
			...
			<div class="content">
				<dl>
					...
					<dd><?php echo $output['order_info']['extend_order_common']['reciver_name'];?>&nbsp; <?php echo $output['order_info']['extend_order_common']['reciver_info']['phone'];?>&nbsp; <?php echo $output['order_info']['extend_order_common']['reciver_info']['address'];?><?php echo !empty($output['order_info']['extend_order_common']['reciver_info']['dlyp']) ? '[自提服务站]' : '';?></dd>
				</dl>
				<dl>
					<dt>发&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;票：</dt>
					<dd>
		...
		<table class="ncsc-default-table order">
			<thead>
				<tr>
					...
					<th class="" style="display:none;"><strong>实付 * 佣金比 = 应付佣金(积分)</strong></th>
					<th>交易操作</th>
				</tr>
			</thead>
			<tbody>
				...
				<tr class="bd-line">
					...
					<td class="commis bdl bdr" style="display:none;"><?php if ($goods['commis_rate'] != 200) { ?>
				...
				<tr class="bd-line">
					...
					<td colspan="6" class="tl"><div class="ncsc-goods-gift">赠品：
							<ul>
								...
								<li><a title="赠品：<?php echo $zengpin_info['goods_name'];?> * <?php echo $zengpin_info['goods_num'];?>" target="_blank" href="javascript:;"><img src="<?php echo $zengpin_info['image_60_url']; ?>" /></a></li>
								<?php } ?>
							</ul>
						</div></td>
				</tr>
			...
			<tfoot>
				...
				<tr>
					<td colspan="20"><dl class="ncsc-store-sales">
							...
							<dd>使用了面额为 <?php echo $output['order_info']['extend_order_common']['voucher_price'];?> 积分的代金券，编码：<?php echo $output['order_info']['extend_order_common']['voucher_code'];?></span></dd>
							<?php } ?>
						</dl></td>
				</tr>
				<?php } ?>
				<tr>
					<td colspan="20"><dl class="freight">
						...
						<dl class="sum">
							...
							<dd><em><?php echo $output['order_info']['order_amount']; ?></em>积分</dd>
						</dl></td>
				</tr>
			</tfoot>
		</table>
...
$(function(){
    $('#show_shipping').on('hover',function(){
        var_send = '<?php echo date("Y-m-d H:i:s",$output['order_info']['extend_order_common']['shipping_time']); ?>&nbsp;&nbsp;<?php echo isset($lang['member_show_seller_has_send']) ? $lang['member_show_seller_has_send'] : '';?><br/>';
    	$.getJSON('index.php?act=store_deliver&op=get_express&e_code=<?php echo isset($output['order_info']['express_info']['e_code']) ? $output['order_info']['express_info']['e_code'] : ''?>&shipping_code=<?php echo $output['order_info']['shipping_code']?>&t=<?php echo random(7);?>',function(data){
    		if(data){
    			data = var_send+data;
