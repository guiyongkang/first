		...
		<div id="saleRefundReturn">
			...
			<div class="ncsc-form-default">
				...
				<form id="post_form" method="post" action="index.php?act=store_return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
					...
					<div class="bottom">
						<label class="submit-border"> <a class="submit" id="confirm_button"><?php echo $lang['nc_ok'];?></a> </label>
						<label class="submit-border"> <a href="javascript:history.go(-1);" class="submit"><i class="icon-reply"></i>返回列表</a> </label>
					</div>
				</form>
			</div>
		</div>
	</div>
	<?php require template('store_refund_right');?>
</div>
