...
<div class="wrap">
	...
	<form method="post" id="form_snssetting" action="index.php?act=store_sns&op=setting">
		...
		<table class="ncsc-default-table">
			...
			<tbody>
				<tr class="bd-line">
					<td><input type="checkbox" name="new" <?php if(isset($output['sauto_info']['sauto_new']) && $output['sauto_info']['sauto_new'] == 1){?>checked="checked"<?php }?> value="1" /></td>
					<td class="tl"><strong><?php echo $lang['store_sns_new_selease'];?></strong>
						<textarea nctype="charcount" class="textarea w400" name="new_title" rows="2" id="new_title"><?php echo !empty($output['sauto_info']) ? $output['sauto_info']['sauto_newtitle'] : '';?></textarea>
				...
				<tr class="bd-line">
					<td><input type="checkbox" name="xianshi" <?php if(!empty($output['sauto_info']) && $output['sauto_info']['sauto_xianshi'] == 1){?>checked="checked"<?php }?> value="1" /></td>
					<td class="tl"><strong><?php echo $lang['store_sns_xianshi'];?></strong>
						<textarea nctype="charcount" class="w400" name="xianshi_title" rows="2" id="xianshi_title"><?php echo !empty($output['sauto_info']) ? $output['sauto_info']['sauto_xianshititle'] : '';?></textarea>
				...
				<tr class="bd-line">
					<td><input type="checkbox" name="mansong" <?php if(!empty($output['sauto_info']) && $output['sauto_info']['sauto_mansong'] == 1){?>checked="checked"<?php }?> value="1" /></td>
					<td class="tl"><strong><?php echo $lang['store_sns_mansong'];?></strong>
						<textarea nctype="charcount" class="w400" name="mansong_title" rows="2" id="mansong_title"><?php echo !empty($output['sauto_info']) ? $output['sauto_info']['sauto_mansongtitle'] : '';?></textarea>
				...
				<tr class="bd-line">
					<td><input type="checkbox" name="bundling" <?php if(!empty($output['sauto_info']) && $output['sauto_info']['sauto_bundling'] == 1){?>checked="checked"<?php }?> value="1" /></td>
					<td class="tl"><strong><?php echo $lang['store_sns_bundling'];?></strong>
						<textarea nctype="charcount" class="w400" name="bundling_title" rows="2" id="bundling_title"><?php echo !empty($output['sauto_info']) ? $output['sauto_info']['sauto_bundlingtitle'] : '';?></textarea>
				...
				<tr class="bd-line">
					<td><input type="checkbox" name="groupbuy" <?php if(!empty($output['sauto_info']) && $output['sauto_info']['sauto_groupbuy'] == 1){?>checked="checked"<?php }?> value="1" /></td>
					<td class="tl"><strong><?php echo $lang['store_sns_gronpbuy'];?></strong>
						<textarea nctype="charcount" class="w400" name="groupbuy_title" rows="2" id="groupbuy_title"><?php echo !empty($output['sauto_info']) ? $output['sauto_info']['sauto_bundlingtitle'] : '';?></textarea>
