...
<form method="post" id="goods_combo" action="<?php echo urlBiz('store_goods_online', 'save_combo');?>">
    ...
    <div class="combo-goods" nctype="choose_goods_list">
      <ul>
        ...
        <li>
          ...
          <div class="pic-thumb"> <a target="_blank" href="<?php echo urlBiz('goods', 'index', array('goods_id' => $combo['goods_id']));?>"> <img src="<?php echo cthumb($combo['goods_image'], '240', $_SESSION['store_id']);?>"> </a> </div>
          <dl>
            <dt><a target="_blank" href="<?php echo urlBiz('goods', 'index', array('goods_id' => $combo['goods_id']));?>"><?php echo $combo['goods_name'];?></a></dt>
...
$(function(){
    ...
    $('a[nctype="search_combo"]').click(function(){
        _url = "<?php echo urlBiz('store_goods_online', 'search_goods');?>";
