...
<form method="get" action="index.php" target="_self">
	<table class="search-form">
		...
		<tr>
			<td class="tr"><div class="fl"><a class="ncsc-btn-mini tip" title="点击进入设置价格区间页面，下方统计图将根据您设置的价格区间进行统计" href="index.php?act=statistics_general&op=pricesetting" target="_blank">设置价格区间</a></div>
				<div class="fr">
...
<table id="pricerang_table" class="ncsc-default-table">
	<tbody>
		<tr id="row_0">
			<td class="tl"><?php if ($output['statjson']){ ?>
