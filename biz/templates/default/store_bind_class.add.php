...
<div class="ncsc-form-default">
	<form method="post"
		action="index.php?act=store_info&op=bind_class_save" target="_parent"
		name="store_bind_class_form" id="store_bind_class_form">
		<input type="hidden" name="form_submit" value="ok" /> <input
			id="goods_class" name="goods_class" type="hidden" value="">
		<dl>
            ...
            <?php }?>
            <?php }?>
          </select> <span> <label id="error_message"
					style="display: none" class="error" for="sn_title"><i
						class="icon-exclamation-sign"></i>请选择分类</label>
				</span>
			</dd>
		</dl>
		<div class="bottom">
			<label class="submit-border"><input type="button"
				id="btn_add_bind_class" class="submit"
...
$(document).ready(function(){
    ...
    $('#btn_add_bind_class').on('click', function() {
        ...
        //showDialog('确认申请吗？', 'confirm', '', function(){
