  ...
  <form id="add_form" action="index.php?act=store_livegroup&op=groupbuy_add" method="post" enctype="multipart/form-data">
    ...
    <dl>
      ...
      <dd>
        ...
        <p class="hint">原价为所抢线下服务活动的正常销售价格，作为抢购价格参考及折扣率换算，必须是0.01~1000000之间的数字(单位：积分)</p>
      </dd>
    </dl>
    <dl>
      ...
      <dd>
        ...
        <p class="hint">抢购价格线下服务类活动的促销价格，必须是0.01~1000000之间的数字(单位：积分)，并小于原价，线下抢购不产生任何物流运输费用</p>
      </dd>
    </dl>
    <dl>
...
$(document).ready(function(){
    ...
    $('[nctype="btn_upload_image"]').fileupload({
        dataType: 'json',
            url: "<?php echo urlBiz('store_livegroup', 'image_upload');?>",
            add: function(e, data) {
