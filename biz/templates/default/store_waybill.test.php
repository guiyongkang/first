...
.print-btn i {
 background:
 url(<?php echo APP_TEMPLATES_URL?>/images/ncsc_bg_img.png)  scroll no-repeat 0 -460px;
...
.print-btn:hover a, .print-layout .print-btn a:hover {
	color: #FFF;
	text-decoration: none;
}
</style>
