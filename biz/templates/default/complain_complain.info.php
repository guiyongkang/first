	...
	<dd>
		<?php
                        if(empty($output['complain_info']['complain_pic1'])&&empty($output['complain_info']['complain_pic2'])&&empty($output['complain_info']['complain_pic3'])) {
                            ...
                            $pic_link = APP_URL.'/index.php?act=show_pics&type=complain&pics=';
...
<table class="order ncsc-table-style">
	...
	<tbody>
		...
		<tr>
			<td class="bdl"></td>
			<td><div class="goods-pic-small"><span class="thumb size60"><i></i><a href="<?php echo urlBiz('goods', 'index', array('goods_id'=>$complain_goods['goods_id']));?>" target="_blank"> <img onload="javascript:DrawImage(this,60,60);" src="<?php echo cthumb($complain_goods['goods_image'], 60,$output['order_info']['store_id']);?>"/> </a></span></div></td>
			<td><a href="<?php echo urlBiz('goods', 'index', array('goods_id'=>$complain_goods['goods_id']));?>" target="_blank"> <?php echo $complain_goods['goods_name'];?> </a></td>
