...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_account', 'account_edit', array('seller_id' => $value['seller_id']));?>" class="btn-blue"><i class="icon-edit"></i>
				<p><?php echo $lang['nc_edit'];?></p>
				</a> </span><span><a nctype="btn_del_account" data-seller-id="<?php echo $value['seller_id'];?>" href="javascript:;" class="btn-red"><i class="icon-trash"></i>
...
<form id="del_form" method="post" action="<?php echo urlBiz('store_account', 'account_del');?>">
