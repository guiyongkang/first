...
<div class="ncsc-flow-layout">
	...
	<div class="ncsc-flow-item">
		...
		<div class="item-goods">
			...
			<dl>
				<dt>
					<div class="ncsc-goods-thumb-mini"><a target="_blank" href="<?php echo urlBiz('goods','index',array('goods_id'=>$goods['goods_id']));?>"><img src="<?php echo thumb($goods, 60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($goods,'240'); ?>>')" onMouseOut="toolTip()"/></a></div>
				</dt>
				<dd><a target="_blank" href="<?php echo urlBiz('goods','index',array('goods_id'=>$goods['goods_id']));?>"><?php echo $goods['goods_name']; ?></a><span class="rmb-price"><i class="mr5"><?php echo $goods['goods_price']; ?></i>&nbsp;*&nbsp;<?php echo $goods['goods_num']; ?></span></dd>
				</dt>
			</dl>
			<?php } } ?>
		</div>
