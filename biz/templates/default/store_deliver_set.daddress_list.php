...
<table class="ncsc-default-table" >
	...
	<tbody>
		...
		<tr class="bd-line">
			<td><label for="is_default_<?php echo $address['address_id'];?>">
					<input type="radio" id="is_default_<?php echo $address['address_id'];?>" name="is_default" <?php if ($address['is_default'] == 1) echo 'checked';?> value="<?php echo $address['address_id'];?>">
					<?php echo $lang['store_daddress_default'];?></label></td>
