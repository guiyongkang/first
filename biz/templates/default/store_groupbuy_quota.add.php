...
<div class="ncsc-form-default">
	<form id="add_form" action="<?php echo urlBiz('store_groupbuy', 'groupbuy_quota_add_save');?>" method="post">
		<dl>
			<dt><i class="required">*</i>购买数量</dt>
			<dd>
				<input id="groupbuy_quota_quantity" name="groupbuy_quota_quantity" type="text" class="text w30" />
