...
<div class="ncsc-oredr-show">
	...
	<div class="ncsc-order-contnet">
		<table class="ncsc-default-table order">
			...
			<tbody>
				<tr>
					<th colspan="20"><span class="ml10" title="虚拟订单号">虚拟订单号：<?php echo $output['order_info']['order_sn'];?></span><span>下单时间：<?php echo date("Y-m-d H:i",$output['order_info']['add_time']);?></span><span><?php echo isset($output['store']['store_name'] ) ? $output['store']['store_name'] : '';?></span></th>
				</tr>
				<tr>
					<td class="bdl"></td>
					<td><div class="pic-thumb"><a href="javascript:;" onMouseOver="toolTip('<img src=<?php echo thumb($output['order_info'], 240);?>>')" onMouseOut="toolTip()"/><img src="<?php echo thumb($output['order_info'], 60);?>"/></a></div></td>
					<td class="tl"><dl class="goods-name">
							<dt><?php echo $output['order_info']['goods_name'];?></dt>
							<dd><span class="sale-type">
			...
			<tfoot>
				...
				<tr>
					<th colspan="20"><dl class="ncsc-store-sales">
							<?php if(!empty($output['order_info']['voucher_code'])){ ?>
							<dd><span>&emsp;使用了 <strong><?php echo $output['order_info']['voucher_price'];?></strong> 积分 代金券（编码：<?php echo $output['order_info']['voucher_code'];?>）</span></dd>
							<?php } ?>
						</dl>
					</th>
				</tr>
