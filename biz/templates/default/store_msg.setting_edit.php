<div class="eject_con">
	...
	<form method="post" target="_parent"
		action="<?php echo urlBiz('store_msg', 'save_msg_setting');?>"
		...
		<dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="message_forced"
					...
					<?php if (!empty($output['smsetting_info']['sms_message_switch'])) {?>
					checked="checked" <?php }?> />
				<strong>商家消息提醒<?php echo $lang['nc_colon'];?></strong> </dt>
		...
		<dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="short_forced" id="short_forced"
					...
					checked="checked" <?php }?> />
				<strong>手机短信提醒<?php echo $lang['nc_colon'];?></strong> </dt>
			<dd>
		...
		<dl>
			<dt>
				<input type="checkbox" class="checkbox mr5" name="mail_forced" id="mail_forced"
					...
					checked="checked" <?php }?> />
				<strong>邮件提醒<?php echo $lang['nc_colon'];?></strong> </dt>
			<dd>
