...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-acidblue" target="_blank"><i class="icon-print"></i>
				<p>测试</p>
		...
		<?php }else{?>
		<tr>
			<td colspan="20" class="norecord"><div class="warning-option"><i class="icon-warning-sign"></i><span>还没有可用的运单模板，<a href="<?php echo urlBiz('store_waybill', 'waybill_add');?>">去建立模板</a></span></div></td>
		</tr>
		<?php }?>
	</tbody>
	
</table>
<form id="bind_form" action="<?php echo urlBiz('store_waybill', 'waybill_bind_save');?>" method="post">
