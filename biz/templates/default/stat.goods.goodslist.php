...
<form method="get" action="index.php" target="_self" id="formSearch">
	<table class="search-form">
		...
		<tr>
			<td class="tr"><div class="fr">&nbsp;&nbsp;商品名称
					<input type="text" class="text w150" name="search_gname" value="<?php echo isset($_GET['search_gname']) ? $_GET['search_gname'] : ''; ?>" />
...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			<td><div class="pic-thumb"><img src="<?php echo thumb($v, 60);?>"/></div></td>
