...
<table class="ncsc-table-style">
  ...
  <tbody>
    ...
    <tr class="bd-line">
      ...
      <td class="goods-price"><a href="<?php echo urlBiz('show_store', 'index', array('store_id'=>$val['store_id']));?>" target="_blank"><?php echo $val['store_name'];?></a></td>
      ...
      <td><?php if ($val['voucher_state'] == '1'){?>
        <a href="<?php echo urlBiz('show_store', 'index', array('store_id'=>$val['store_id']));?>" target="_blank"><?php echo $lang['voucher_voucher_readytouse'];?></a>
