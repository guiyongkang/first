...
<div class="tabmenu">
	...
	<a href="javascript:void(0)" class="ncsc-btn ncsc-btn-green" nc_type="dialog" dialog_title="<?php echo $lang['store_goods_class_new_class'];?>" dialog_id="my_category_add" dialog_width="480" uri="<?php echo urlBiz('store_goods_class', 'index', array('type' => 'ok'));?>" title="<?php echo $lang['store_goods_class_new_class'];?>"><?php echo $lang['store_goods_class_new_class'];?></a></div>
...
$(function()
{
    ...
    var path = "<?php echo APP_TEMPLATES_URL;?>/images/";
    if (map.length > 0)
    {
        var option = {
