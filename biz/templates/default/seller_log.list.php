...
<form method="get">
	...
	<table class="search-form">
		<tr>
			<td>&nbsp;</td>
			<th>账号</th>
			<td class="w100"><input type="text" class="text w80" name="seller_name" value="<?php echo isset($_GET['seller_name']) ? trim($_GET['seller_name']) : ''; ?>" /></td>
			<th>日志内容</th>
			<td class="w160"><input type="text" class="text w150" name="log_content" value="<?php echo isset($_GET['log_content']) ? trim($_GET['log_content']) : ''; ?>" /></td>
			<th>时间</th>
