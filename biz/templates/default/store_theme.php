...
<div class="ncsc-store-templet">
  <dl class="current-style">
    ...
    <dd><a href="<?php echo urlBiz('show_store', 'index', array('store_id' => $output['store_info']['store_id']));?>" class="ncsc-btn"><?php echo $lang['store_theme_homepage'];?></a></dd>
  </dl>
...
function preview_theme(style_name){
    var screenshot = '<?php echo APP_TEMPLATES_URL;?>/store/style/' + style_name + '/screenshot.jpg';
