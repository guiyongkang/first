...
<script>
  $(function() {
    ...
    var galleries = $('.ad-gallery').adGallery({loader_image:'<?php echo APP_TEMPLATES_URL;?>/images/loading.gif', start_at_index:<?php echo intval($_GET['start_index']);?>, slideshow:{enable: false,start_label: '<?php echo $lang['album_pinfo_autoplay'];?>', stop_label: '<?php echo $lang['album_pinfo_suspend'];?>'}});
...
function ajax_change_imgmessage(url){
	...
	$.getJSON("<?php echo APP_URL; ?>/index.php?act=store_album&op=ajax_change_imgmessage", {'url':url}, function(data){
