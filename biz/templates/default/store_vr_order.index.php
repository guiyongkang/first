...
<div class="tabmenu">
	...
	<a href="<?php echo urlBiz('store_vr_order', 'exchange');?>" class="ncsc-btn ncsc-btn-orange"><i class="icon-edit"></i>兑换兑换码</a> </div>
...
<table class="ncsc-default-table order">
	...
	<?php if (!empty($output['order_list']) and is_array($output['order_list'])) { ?>
	...
	<tbody>
		...
		<tr>
			<td class="bdl"></td>
			<td class="w70"><div class="ncsc-goods-thumb"><img src="<?php echo thumb($order,60);?>" onMouseOver="toolTip('<img src=<?php echo thumb($order,240);?>>')" onMouseOut="toolTip()"/></div></td>
			<td class="tl"><dl class="goods-name">
					<dt><?php echo $order['goods_name']; ?></dt>
					<dd>
