...
<div class="ncsc-form-default">
	<form id="add_form" action="<?php echo urlBiz('store_waybill', 'waybill_setting_save');?>" method="post">
		...
		<dl>
			...
			<dd>
				<input class="w60 text" name="store_waybill_left" type="text" value="<?php echo $output['store_waybill_left'];?>" />
		...
		<dl>
			...
			<dd>
				<input class="w60 text" name="store_waybill_top" type="text" value="<?php echo $output['store_waybill_top'];?>" />
				<em class="add-on">mm</em> <span></span>
