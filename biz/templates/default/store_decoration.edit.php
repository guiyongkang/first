...
<link href="<?php echo APP_TEMPLATES_URL?>/css/shop_custom.css" rel="stylesheet" type="text/css">
...
<div class="ncsc-decoration-layout">
  <div class="ncsc-decoration-menu" id="waypoints">
    ...
    <ul class="menu">
      ...
      <li><a id="btn_preview" href="<?php echo urlBiz('store_decoration', 'decoration_preview', array('decoration_id' => $_GET['decoration_id']));?>" target="_blank"><i class="preview"></i>设计预览</a></li>
...
<script type="text/javascript"> 
    ...
    var URL_DECORATION_ALBUM_UPLOAD = '<?php echo urlBiz('store_decoration', 'decoration_album_upload');?>';
    var URL_DECORATION_BACKGROUND_SETTING_SAVE = '<?php echo urlBiz('store_decoration', 'decoration_background_setting_save');?>';
    var URL_DECORATION_NAV_SAVE = '<?php echo urlBiz('store_decoration', 'decoration_nav_save');?>';
    var URL_DECORATION_BANNER_SAVE = '<?php echo urlBiz('store_decoration', 'decoration_banner_save');?>';
    var URL_DECORATION_BLOCK_ADD = '<?php echo urlBiz('store_decoration', 'decoration_block_add');?>';
    var URL_DECORATION_BLOCK_DEL = '<?php echo urlBiz('store_decoration', 'decoration_block_del');?>';
    var URL_DECORATION_BLOCK_SAVE = '<?php echo urlBiz('store_decoration', 'decoration_block_save');?>';
    var URL_DECORATION_BLOCK_SORT = '<?php echo urlBiz('store_decoration', 'decoration_block_sort');?>';
    var URL_DECORATION_GOODS_SEARCH = '<?php echo urlBiz('store_decoration', 'goods_search');?>';
    var LOADING_IMAGE = '<?php echo APP_TEMPLATES_URL . DS . 'images/loading.gif';?>';
    var POSHYTIP = {
