...
<link href="<?php echo APP_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
<!--[if IE 7]>
  <link href="<?php echo APP_RESOURCE_SITE_URL;?>/font/font-awesome/css/font-awesome-ie7.min.css" rel="stylesheet" type="text/css">
<![endif]-->
<style type="text/css">
body {
...
<form id="spec_form" method="post" action="<?php echo APP_URL;?>/index.php?act=store_spec&op=save_spec">
...
$(function(){
    ...
    $('a[nctype="submit-btn"]').click(function(){
        ...
        if (_submit) {
            ajaxpost('spec_form', '<?php echo APP_URL;?>/index.php?act=store_spec&op=save_spec', '', 'onerror');
        }
    });
