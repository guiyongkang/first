...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_account_group', 'group_edit', array('group_id' => $value['group_id']));?>" class="btn-blue"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlBiz('store_account_group', 'group_del');?>">
