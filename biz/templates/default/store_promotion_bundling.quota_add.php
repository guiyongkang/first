...
<div class="ncsc-form-default">
	...
	<form id="add_form" action="index.php?act=store_promotion_bundling&op=bundling_renew" method="post">
		...
		<dl>
			...
			<dd>
				<input id="bundling_quota_quantity" name="bundling_quota_quantity" type="text" class="text w50"/>
				<em class="add-on"><?php echo $lang['nc_month'];?></em><span></span>
				<p class="hint"><?php echo $lang['bundling_price_explain1'];?></p>
				<p class="hint"><?php printf($lang['bundling_price_explain2'], intval($output['setting_config']['promotion_bundling_price']));?></p>
...
$(document).ready(function(){
	...
	$("#add_form").validate({
		...
		submitHandler:function(form){
			var unit_price = parseInt(<?php echo $output['setting_config']['promotion_bundling_price'];?>);
