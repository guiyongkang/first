...
<div class="ncsc-flow-item">
	...
	<div class="item-goods">
		...
		<dl>
			<dt>
				<div class="ncsc-goods-thumb-mini"><a href="javascript:;"> <img src="<?php echo thumb($val,60); ?>" onMouseOver="toolTip('<img src=<?php echo thumb($val,240); ?>>')" onMouseOut="toolTip()" /></a></div>
			</dt>
			<dd><a href="javascript:;"><?php echo $val['goods_name']; ?></a> <?php echo $lang['currency'];?><?php echo $val['goods_price']; ?> * <?php echo $val['goods_num']; ?> <font color="#AAA">(数量)</font> <span><?php echo orderGoodsType($val['goods_type']);?></span> </dd>
		</dl>
		<?php } ?>
		<?php } ?>
	</div>
