  ...
  <table class="ncsc-table-style">
    ...
    <tbody>
      <tr class="bd-line">
		<td></td>
		<td>
			<div class="goods-pic-small"><span class="thumb size60"><i></i><a target="_blank" href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"><img src="<?php echo lgthumb($output['live_groupbuy']['groupbuy_pic'],20); ?>" /></a></span></div>		
		</td>
		<td><a target="_blank" href="<?php echo urlBiz('show_live_groupbuy','groupbuy_detail',array('groupbuy_id'=>$output['live_groupbuy']['groupbuy_id']));?>"><?php echo $output['order']['item_name']?></a></td>
