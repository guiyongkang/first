...
<form method="get" action="index.php">
	...
	<table class="search-form">
		<tr>
			...
			<th>审核状态</th>
			<td class="w90"><select name="verify">
	...
	<thead>
		...
		<tr>
			...
			<td colspan="10"><label for="all"><?php echo $lang['nc_select_all'];?></label>
				<a href="javascript:void(0);" class="ncsc-btn-mini" nc_type="batchbutton" uri="<?php echo urlBiz('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a>
		</tr>
		<?php } ?>
	</thead>
	<tbody>
		...
		<tr>
			...
			<td><div class="pic-thumb"> <a href="<?php echo urlBiz('goods', 'index', array('goods_id' => $output['storage_array'][$val['goods_commonid']]['goods_id']));?>" target="_blank"><img src="<?php echo thumb($val, 60);?>"/></a></div></td>
			<td class="tl"><dl class="goods-name">
					<dt style="max-width: 450px !important;">
						...
						<?php }?>
						<a href="<?php echo urlBiz('goods', 'index', array('goods_id' => $output['storage_array'][$val['goods_commonid']]['goods_id']));?>" target="_blank"><?php echo $val['goods_name']; ?></a></dt>
			...
			<td><p><?php echo $output['verify'][$val['goods_verify']];?></p>
				<?php if ($val['goods_verify'] == 0) {?>
				<p><?php echo $val['goods_verifyremark'];?></p>
				<?php }?></td>
...
<script type="text/javascript" src="<?php echo APP_RESOURCE_SITE_URL;?>/js/store_goods_list.js" charset="utf-8"></script> 