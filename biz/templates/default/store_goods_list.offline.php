...
<form method="get" action="index.php">
	...
	<table class="search-form">
		<tr>
			...
			<td class="w160"><input type="text" class="text" name="keyword" value="<?php echo isset($_GET['keyword']) ? $_GET['keyword'] : ''; ?>"/></td>
...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><a href="javascript:void(0)" onclick="ajax_get_confirm('','<?php echo urlBiz('store_goods_offline', 'goods_show', array('commonid' => $val['goods_commonid']));?>')" class="ncsc-btn"><?php echo $lang['store_goods_index_show'];?></a></td>
			...
			<td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_goods_online', 'edit_goods', array('commonid' => $val['goods_commonid']));?>" class="btn-blue"><i class="icon-edit"></i>
	...
	<tfoot>
		<tr>
			...
			<th colspan="10"><label for="all2"><?php echo $lang['nc_select_all'];?></label>
				<a href="javascript:void(0);" class="ncsc-btn-mini" nc_type="batchbutton" uri="<?php echo urlBiz('store_goods_online', 'drop_goods');?>" name="commonid" confirm="<?php echo $lang['nc_ensure_del'];?>"><i class="icon-trash"></i><?php echo $lang['nc_del'];?></a> <a href="javascript:void(0);" class="ncsc-btn-mini" nc_type="batchbutton" uri="<?php echo urlBiz('store_goods_offline', 'goods_show');?>" name="commonid"><i class="icon-level-up"></i><?php echo $lang['store_goods_index_show'];?></a></th>
		</tr>
		<tr>
