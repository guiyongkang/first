...
<div class="tabmenu">
	...
	<a title="建立模板" class="ncsc-btn ncsc-btn-green" href="<?php echo urlBiz('store_waybill', 'waybill_add');?>">添加模板</a> </div>
...
<table class="ncsc-default-table">
	...
	<tbody>
		...
		<tr class="bd-line">
			...
			<td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_waybill', 'waybill_design', array('waybill_id' => $value['waybill_id']));?>" class="btn-orange"><i class="icon-edit"></i>
				<p>设计</p>
				</a></span><span><a href="<?php echo urlBiz('store_waybill', 'waybill_test', array('waybill_id' => $value['waybill_id']));?>" class="btn-acidblue" target="_blank"><i class="icon-print"></i>
				<p>测试</p>
				</a></span><span><a href="<?php echo urlBiz('store_waybill', 'waybill_edit', array('waybill_id' => $value['waybill_id']));?>" class="btn-blue"><i class="icon-edit"></i>
				<p>编辑</p>
...
<form id="del_form" action="<?php echo urlBiz('store_waybill', 'waybill_del');?>" method="post">
