...
<div class="wrap">
  <div class="tabmenu">
    ...
    <a href="<?php echo urlBiz('store_navigation', 'navigation_add');?>" class="ncsc-btn ncsc-btn-green" title="添加导航">添加导航</a> </div>
  <table class="ncsc-default-table">
    ...
    <tbody>
      ...
      <tr class="bd-line">
        ...
        <?php $sn_href = empty($value['sn_url'])?urlBiz('show_store', 'show_article', array('store_id' => $_SESSION['store_id'], 'sn_id' => $value['sn_id'])):$value['sn_url'];?>
        ...
        <td class="nscs-table-handle"><span><a href="<?php echo urlBiz('store_navigation', 'navigation_edit', array('sn_id' => $value['sn_id']));?>" class="btn-blue"><i class="icon-edit"></i>
...
<form id="del_form" method="post" action="<?php echo urlBiz('store_navigation', 'navigation_del');?>">
