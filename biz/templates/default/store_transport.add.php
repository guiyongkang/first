...
<div class="ncsc-form-default">
	<form method="post" id="tpl_form" name="tpl_form" action="index.php?act=store_transport&op=save">
		...
		<dl>
			...
			<dd>
				<input type="text"  class="text"  id="title" autocomplete="off"  value="<?php echo isset($output['transport']) ? $output['transport']['title'] : '';?>" name="title">
	...
	<div id="dialog_areas" class="dialog-areas" style="display:none">
		<div class="ks-contentbox">
			...
			<form method="post">
				<ul id="J_CityList">
					<?php require(template('store_transport_area'));?>
				</ul>
		...
		<div class="ks-contentbox">
			...
			<form method="post">
				<div class="batch"><?php echo $lang['transport_note_1'].$lang['nc_colon'];?>
					...
					<em class="add-on"> <i class="icon-renminbi"></i> </em><?php echo $lang['transport_note_3'];?>
...
<script src="<?php echo APP_RESOURCE_SITE_URL;?>/js/transport.js"></script> 
<script>
$(function(){
