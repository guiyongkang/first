...
class statistics_industry extends BaseSellerControl
{
    private $search_arr;
    //处理后的参数
    private $gc_arr;
    ...
    public function hotOp()
    {
        ...
        $gc_id_depth = isset($this->gc_arr[$this->choose_gcid]['depth']) ? $this->gc_arr[$this->choose_gcid]['depth'] : '';
        ...
        core\tpl::showpage('stat.industry.hot');
    }
    /**
     * 价格分布
     */
    ...
    {
        $menu_array = array(1 => array('menu_key' => 'hot', 'menu_name' => '同行热卖', 'menu_url' => 'index.php?act=statistics_industry&op=hot'), 2 => array('menu_key' => 'price', 'menu_name' => '行业价格分布', 'menu_url' => 'index.php?act=statistics_industry&op=price'));
