...
INSERT INTO `shop_admin` (`admin_id`, `admin_name`, `admin_password`, `admin_login_time`, `admin_login_num`, `admin_is_super`, `admin_gid`) VALUES
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 1538042667, 188, 1, 0);
...
CREATE TABLE IF NOT EXISTS `shop_adv_click` (
...
CREATE TABLE IF NOT EXISTS `shop_album_pic` (
  ...
  `upload_time` int(10) unsigned NOT NULL COMMENT '图片上传时间',
  PRIMARY KEY (`apic_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='相册图片表' AUTO_INCREMENT=27 ;
...
(1, '微信图片_20180903172646', '', 1, '1_05894567016359907.jpg', 42581, '603x340', 1, 1536112701),
(2, '5a5cb04ccdff2_1024', '', 2, '2_05898942038726850.png', 557993, '1024x576', 2, 1536550203),
(3, 'A7M5mK5A1IIP1K5M3MW1PZ705YIpGP', '', 2, '2_05899718084373954.png', 313520, '784x268', 2, 1536627808),
(4, 'CPttF6qQJPQ9t9jJqp64HsEIFbEHmi', '', 2, '2_05899718092346628.png', 466966, '785x541', 2, 1536627809),
(5, 'd0stblI66WtJbwbIty7Y2ykgA4ybtK', '', 2, '2_05899718096713259.png', 537467, '736x685', 2, 1536627809),
(6, 'dsK4K5zkk8kkEl96KUuZ5K4ckVKzs8', '', 2, '2_05899718120778153.png', 669421, '787x604', 2, 1536627812),
(7, 'lGO2WZ92bWPPROZTGr5zdPcPOo90aG', '', 2, '2_05899718137344443.png', 634952, '755x463', 2, 1536627813),
(8, 'Nhl0vvR45RBa7bB70S58H408b0R140', '', 2, '2_05899718142182322.png', 714789, '780x542', 2, 1536627814),
(9, 'v30G0Wcg30GFjyWj3jhHIG3zYIhHdb', '', 2, '2_05899718150469094.png', 325964, '784x269', 2, 1536627815),
(10, 'G2p462w2G2xKWH23228W4V46DgwU6U', '', 2, '2_05899718155465471.png', 632984, '750x463', 2, 1536627815),
(11, 'zG8qVTLVzMvTtTXslZQ8tsTLCGy70C', '', 2, '2_05899718157801741.png', 605581, '779x538', 2, 1536627816),
(12, 'GCHuzzEBtsH2uETqa4c7qxO2EsNdUC', '', 2, '2_05899718167967473.png', 797667, '783x663', 2, 1536627817),
(13, 'E5Q50z75b5M0d7L5d5B5mP5Q5dlDU6', '', 2, '2_05899718190468045.png', 606454, '782x538', 2, 1536627819),
(14, '下载', '', 2, '2_05899719211702149.png', 329881, '380x379', 2, 1536627921),
(15, '下载', '', 2, '2_05899719948116912.png', 329881, '380x379', 2, 1536627994),
(16, '下载 (2)', '', 2, '2_05899721856221964.png', 203495, '358x376', 2, 1536628185),
(17, '7710207705_31876634', '', 2, '2_05899722000127424.jpg', 108548, '1080x1175', 2, 1536628200),
(18, '8880402580_31876634', '', 2, '2_05899722005128727.jpg', 72844, '1173x1080', 2, 1536628200),
(19, '8880408352_31876634', '', 2, '2_05899722010126277.jpg', 76968, '1080x1186', 2, 1536628201),
(20, '7722298757_31876634', '', 2, '2_05899722015594107.jpg', 108548, '1080x1175', 2, 1536628202),
(21, '8917409752_31876634', '', 2, '2_05899722021370256.jpg', 107640, '1080x1167', 2, 1536628202),
(22, '8917403765_31876634', '', 2, '2_05899722027624977.jpg', 108310, '1080x1175', 2, 1536628203),
(23, '7722415381_31876634', '', 2, '2_05899722032945292.jpg', 141466, '1080x1191', 2, 1536628203),
(24, '8880390887_31876634', '', 2, '2_05899722038099051.jpg', 107584, '1080x1232', 2, 1536628204),
(25, '7732004722_31876634', '', 2, '2_05899722043408345.jpg', 141466, '1080x1191', 2, 1536628204),
(26, '8917448189_31876634', '', 2, '2_05899722048565355.jpg', 159680, '1400x1080', 2, 1536628205);
...
INSERT INTO `shop_article` (`article_id`, `ac_id`, `article_url`, `article_show`, `article_sort`, `article_title`, `article_content`, `article_time`) VALUES
(1, 2, '', 1, 255, '关于我们', '关于我们', 1536114469),
(2, 2, '', 1, 255, '操作流程', '操作流程', 1536114494),
(3, 2, '', 1, 1, '123', 'ceshi', 1536114968);
...
CREATE TABLE IF NOT EXISTS `shop_cart` (
  ...
  `store_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '店铺id',
  `store_name` char(50) NOT NULL DEFAULT '' COMMENT '店铺名称',
  ...
  `goods_image` char(100) NOT NULL DEFAULT '' COMMENT '商品图片',
...
CREATE TABLE IF NOT EXISTS `shop_circle_mldefault` (
  ...
  PRIMARY KEY (`mld_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='成员头衔默认设置表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='会员参考头衔表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_cms_module` (
  ...
  PRIMARY KEY (`module_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='CMS模板模块表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='cms模块组件表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='cms模块框架表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='CMS导航表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='投诉主题表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_consult_type` (
  ...
  PRIMARY KEY (`ct_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='咨询类型表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_consume` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(10) DEFAULT '0' COMMENT '购买人id',
  `member_name` char(50) DEFAULT NULL COMMENT '购买人昵称',
  `consume_amount` decimal(10,2) DEFAULT '0.00' COMMENT '实际支付金额',
  `consume_time` int(10) DEFAULT '0' COMMENT '创建时间',
  `consume_remark` char(250) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
...
--
-- 表的结构 `shop_distributor_account`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_account` (
  `distributor_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) DEFAULT '0',
  `member_id` int(10) DEFAULT '0' COMMENT '会员ID',
  `level_id` int(10) DEFAULT '0' COMMENT '级别',
  `inviter_id` int(10) DEFAULT '0' COMMENT '推荐人',
  `dis_path` text COMMENT '父路径',
  `bonus` decimal(10,0) DEFAULT '0' COMMENT '可提现佣金余额',
  `addtime` int(10) DEFAULT '0' COMMENT '加入时间',
  `inviter_num` int(10) DEFAULT '0',
...
--
-- 表的结构 `shop_distributor_chat_msg`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_chat_msg` (
  `m_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `f_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `f_name` varchar(50) NOT NULL COMMENT '会员名',
  `f_ip` varchar(15) NOT NULL COMMENT '发自IP',
...
--
-- 表的结构 `shop_distributor_commission`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_commission` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `profit` decimal(10,0) DEFAULT '100' COMMENT '产品利润',
  `dis_commission` text COMMENT '统一分销佣金设置',
  `public_commission` text COMMENT '公排层级红包',
  `team_commission` text,
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `shop_distributor_fenhong`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_fenhong` (
  `detail_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(10) NOT NULL DEFAULT '0' COMMENT '会员ID',
  `team_id` int(10) NOT NULL DEFAULT '0' COMMENT '股东类型',
  `goods_id` int(10) DEFAULT '0' COMMENT '商品ID',
  `order_id` int(10) DEFAULT '0' COMMENT '订单ID',
  `order_type` tinyint(1) DEFAULT '0' COMMENT '订单类型 0 实物订单  1 虚拟订单 ',
  `goods_price` decimal(10,2) DEFAULT '0.00' COMMENT '商品价格',
  `goods_num` int(10) DEFAULT '0' COMMENT '数量',
  `total` decimal(10,2) DEFAULT '0.00' COMMENT '总金额',
  `number` int(10) DEFAULT '0' COMMENT '人数',
  `detail_bonus` decimal(10,2) DEFAULT '0.00' COMMENT '每人分红金额',
  `detail_desc` char(255) DEFAULT '' COMMENT '描述',
...
--
-- 表的结构 `shop_distributor_goods`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_goods` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `good_id` int(10) DEFAULT '0' COMMENT '产品id',
  `good_profit` decimal(10,0) DEFAULT '100' COMMENT '产品利润',
  `good_dis_commission` text COMMENT '分销佣金明细',
  `good_public_commission` text COMMENT '排位佣金明细',
  `good_public_inviter` decimal(10,2) DEFAULT '0.00' COMMENT '直接推荐奖',
  `good_public_parent` decimal(10,2) DEFAULT '0.00' COMMENT '见点奖（懒人奖）',
  `good_public_thankful` decimal(10,2) DEFAULT '0.00' COMMENT '感恩奖',
  `good_addtime` int(10) DEFAULT '0',
  `good_status` tinyint(1) DEFAULT '0' COMMENT '是否已设置',
  `good_team_commission` text,
  PRIMARY KEY (`item_id`),
...
--
-- 表的结构 `shop_distributor_goodsrecord`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_goodsrecord` (
  `record_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `buyer_id` int(10) DEFAULT '0' COMMENT '购买者ID',
  `owner_id` int(10) DEFAULT '0' COMMENT '分销商ID',
  `order_id` int(10) DEFAULT '0' COMMENT '订单id',
  `goods_id` int(10) DEFAULT '0' COMMENT '商品id',
  `goods_price` decimal(10,2) DEFAULT '0.00' COMMENT '购买价格',
  `goods_num` decimal(10,0) DEFAULT '0' COMMENT '购买数量',
  `record_addtime` int(10) DEFAULT '0' COMMENT '分销记录产生时间',
  `record_status` tinyint(4) DEFAULT '10' COMMENT '记录状态：0(已取消)10(默认):未付款;20:已付款;30:已发货;40:已收货;',
  `order_type` tinyint(1) DEFAULT '0' COMMENT '订单类型 0 实物订单 1 虚拟订单',
  ...
  KEY `goods_commonid` (`goods_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_distributor_goodsrecord_detail`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_goodsrecord_detail` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `record_id` int(10) DEFAULT '0' COMMENT '分销记录ID',
  `good_id` int(10) DEFAULT '0' COMMENT '商品id',
  `order_id` int(10) DEFAULT '0' COMMENT '订单id',
  `member_id` int(10) DEFAULT '0' COMMENT '获得佣金的会员member_id',
  `detail_level` smallint(10) DEFAULT '0' COMMENT '获得佣金时的所在级别',
  `detail_bonus` decimal(10,2) DEFAULT '0.00' COMMENT '佣金总额度',
  `detail_price` decimal(10,2) DEFAULT '0.00' COMMENT '单个商品的佣金额度',
  `detail_num` int(10) DEFAULT '0' COMMENT '购买的数量',
  `detail_desc` char(255) DEFAULT '' COMMENT '佣金描述',
  `detail_status` tinyint(4) DEFAULT '10' COMMENT '佣金状态  订单状态：0(已取消)10(默认):未付款;20:已付款;30:已发货;40:已收货;',
  `detail_addtime` int(10) DEFAULT '0' COMMENT '添加时间',
  `points_status` tinyint(4) DEFAULT '0' COMMENT '0==以前分返佣,1=全返',
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `item_id` (`item_id`) USING BTREE,
...
--
-- 表的结构 `shop_distributor_gp`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_gp` (
  `ralate_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `area_id` int(10) DEFAULT '0' COMMENT '分区ID',
  `member_id` int(10) DEFAULT '0' COMMENT '会员id',
  `rootid` int(10) DEFAULT '0' COMMENT '关系根点id',
  `inviterid` int(10) DEFAULT '0' COMMENT '直接推荐人',
  `parentpath` text COMMENT '按公排关系的父路径',
  `parentid` int(10) DEFAULT '0' COMMENT '上级ID',
  `distributor_y` int(11) DEFAULT '1' COMMENT '公排y轴',
  `distributor_x` int(11) DEFAULT '0' COMMENT '公排x轴',
  `status` tinyint(1) DEFAULT '1' COMMENT '0 已出局 1 正常',
  `addtime` int(10) DEFAULT '0',
  `flag_update` tinyint(1) DEFAULT '0' COMMENT '是否等待升级',
  PRIMARY KEY (`ralate_id`),
  UNIQUE KEY `ralate_id` (`ralate_id`) USING BTREE,
  KEY `distributor_y` (`distributor_y`) USING BTREE,
  KEY `distributor_x` (`distributor_x`) USING BTREE,
  KEY `distributor_inviterid` (`inviterid`) USING BTREE,
  KEY `distributor_rootid` (`rootid`) USING BTREE,
...
--
-- 表的结构 `shop_distributor_gp_area`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_gp_area` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `item_name` char(100) DEFAULT '',
  `item_condition` int(10) DEFAULT '0' COMMENT '升级条件  下级满多少晋级',
  `item_default` tinyint(1) DEFAULT '0' COMMENT '是否为默认',
  `item_note` varchar(255) DEFAULT '' COMMENT '没有公排访问相关页面提示语',
  `is_withdraw` tinyint(1) DEFAULT '0' COMMENT '本区奖励是否可提现',
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `shop_distributor_gp_detail`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_gp_detail` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `area_id` int(10) DEFAULT '0' COMMENT '分区ID',
  `record_id` int(10) DEFAULT '0' COMMENT '分销记录ID',
  `member_id` int(10) DEFAULT '0' COMMENT '获得佣金的会员member_id',
  `detail_type` char(20) DEFAULT '' COMMENT '奖项类型 invite 推荐奖 parent 见点奖 level 级别奖 thinkful 感恩奖',
  `detail_level` smallint(10) DEFAULT '0' COMMENT '获得佣金时的所在级别',
  `detail_bonus` decimal(10,2) DEFAULT '0.00' COMMENT '佣金总额度',
  `detail_desc` char(255) DEFAULT '' COMMENT '佣金描述',
  `detail_addtime` int(10) DEFAULT '0' COMMENT '添加时间',
  `detail_status` tinyint(1) DEFAULT '0' COMMENT '是否领取 0 否 1 是',
  `detail_outtradeno` char(255) DEFAULT '' COMMENT '红包/转账订单的本系统-微信商户单号',
  `detail_tradetime` int(10) DEFAULT '0' COMMENT '第三方交易时间',
  `detail_tradeno` char(255) DEFAULT '' COMMENT '第三方交易号',
  `detail_tradetype` char(20) DEFAULT 'wxhongbao' COMMENT '第三方交易类型 wxhongbao 微信红包 wxzhuanzhang 微信转账',
  PRIMARY KEY (`item_id`),
  UNIQUE KEY `item_id` (`item_id`) USING BTREE,
  KEY `record_id` (`record_id`) USING BTREE,
  KEY `member_id` (`member_id`) USING BTREE
...
--
-- 表的结构 `shop_distributor_level`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_level` (
  `level_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `level_name` char(100) DEFAULT '' COMMENT '级别名称',
  `level_come_type` tinyint(1) DEFAULT '0' COMMENT '成为分销商门槛类型6 无门槛\r\n1 一次性消费\r\n2 总消费额\r\n3 购买指定商品\r\n4 购买任意商品\r\n5 直接购买\r\n只是做记录  与设置表中的门槛相同',
  `level_come_value` char(255) DEFAULT '' COMMENT '成为分销商门槛具体值',
  `level_come_commission` text COMMENT '佣金级别，仅对直接购买有效',
  `level_update_type` tinyint(1) DEFAULT '3' COMMENT '3 购买指定产品 5 补差价',
  `level_update_value` char(255) DEFAULT '' COMMENT '升级门槛具体值',
  `level_update_commission` text COMMENT '升级佣金明细 仅对补差价有效',
  `level_thumb` char(255) DEFAULT '' COMMENT '级别图片',
  `level_addtime` int(10) DEFAULT '0',
  `level_default` tinyint(1) DEFAULT '0' COMMENT '是否为第一个分销商级别',
...
--
-- 表的结构 `shop_distributor_other_setting`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_other_setting` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `qrcode_bg` char(255) DEFAULT '' COMMENT '二维码背景图',
  `title_color` char(20) DEFAULT '#FFFFFF' COMMENT '昵称颜色',
  `qrcode_top` int(10) DEFAULT '350' COMMENT '二维码距头部',
  `qrcode_left` int(10) DEFAULT '135' COMMENT '二维码距左部',
  `qrcode_width` int(10) DEFAULT '0' COMMENT '二维码宽度',
  PRIMARY KEY (`item_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `shop_distributor_other_setting`
--

INSERT INTO `shop_distributor_other_setting` (`item_id`, `qrcode_bg`, `title_color`, `qrcode_top`, `qrcode_left`, `qrcode_width`) VALUES
(1, '/distributor/05585524126135060_small.jpg', '#FFFFFF', 350, 100, 300);

-- --------------------------------------------------------

--
-- 表的结构 `shop_distributor_setting`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_setting` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `dis_come_type` tinyint(1) DEFAULT '1' COMMENT '成为分销商门槛类型 1 一次性消费 2 总消费额 3 购买指定商品 4 购买任意商品 5 直接购买',
  `dis_goods_open` tinyint(1) DEFAULT '1' COMMENT '分销商产品是否获得佣金 0 否 1 是',
  `dis_bonus_level` smallint(4) DEFAULT '1' COMMENT '获得佣金级别',
  `dis_bonus_self` tinyint(1) DEFAULT '0' COMMENT '自销是否获得佣金',
  `dis_name` char(100) DEFAULT '分销商' COMMENT '分销商名称',
  `dis_bonus_name` char(100) DEFAULT '佣金' COMMENT '佣金名称',
  `public_open` tinyint(1) DEFAULT '1' COMMENT '公排状态 0 关闭 1 开启  默认开启',
  `public_bonus_level` smallint(4) DEFAULT '1' COMMENT '排位时获得佣金级别',
  `public_times` smallint(4) DEFAULT '2' COMMENT '排位递增形式',
  `public_multi` tinyint(1) DEFAULT '0' COMMENT '是否支持多点卡位 0 不支持 1 支持',
  `public_come_type` tinyint(1) DEFAULT '1' COMMENT '参与公排门槛 仅在支持多点卡位的情况下有效\r\n1 一次性消费\r\n2 总消费额\r\n3 购买指定商品\r\n4 购买任意商品',
  `public_come_value` char(255) DEFAULT '' COMMENT '参与排位条件',
  `public_out_level` smallint(4) DEFAULT '1' COMMENT '出局层次',
  `public_return_type` tinyint(1) DEFAULT '1' COMMENT '重新排位门槛 仅在单点卡位的情况下有效\r\n1 一次性消费\r\n2 总消费额\r\n3 购买指定商品\r\n4 购买任意商品\r\n6 不支持重新排位',
  `public_return_value` char(255) DEFAULT '' COMMENT '重新排位条件',
  `public_status` tinyint(1) DEFAULT '0' COMMENT '公排设置编辑状态  主要锁定排位递增形式选择',
  `member_inviter` tinyint(1) DEFAULT '0' COMMENT '必须通过邀请人方可注册会员 0 不需要 1 需要',
  PRIMARY KEY (`item_id`),
...
--
-- 表的结构 `shop_distributor_team`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_team` (
  `team_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `team_name` char(100) DEFAULT '' COMMENT '团队名称',
  `team_sort` int(10) DEFAULT '0' COMMENT '顺序',
  `team_invitenum` smallint(4) DEFAULT '0' COMMENT '需要直推人数',
  `team_addtime` int(10) DEFAULT NULL,
  PRIMARY KEY (`team_id`),
  UNIQUE KEY `teamid` (`team_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_distributor_withdraw_method`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_withdraw_method` (
  `method_id` int(6) unsigned NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) NOT NULL,
  `method_name` char(100) NOT NULL,
  `method_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 银行卡,1支付宝',
  `method_ctime` int(10) NOT NULL,
...
--
-- 表的结构 `shop_distributor_withdraw_methods`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_withdraw_methods` (
  `member_method_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `admin_id` int(10) NOT NULL DEFAULT '0',
  `member_id` int(10) NOT NULL DEFAULT '0',
  `method_name` char(50) NOT NULL COMMENT '提现方法名',
  `method_type` char(100) NOT NULL,
  `account_name` char(40) DEFAULT NULL COMMENT '银行卡则为户名，支付宝则为支付宝账号',
  `account_val` char(100) DEFAULT NULL COMMENT '银行卡编号',
  `bank_position` char(200) DEFAULT NULL COMMENT '开户行',
  `method_ctime` int(10) DEFAULT NULL COMMENT '添加时间',
  `method_status` tinyint(1) DEFAULT '1' COMMENT '开启状态',
  PRIMARY KEY (`member_method_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_distributor_withdraw_record`
--

CREATE TABLE IF NOT EXISTS `shop_distributor_withdraw_record` (
  `record_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `admin_id` varchar(10) NOT NULL COMMENT '平台编号',
  ...
  `record_ctime` int(11) unsigned NOT NULL COMMENT '创建时间',
...
(2, '包裹平邮', '1', 'youzhengguonei', 'B', '1', 'http://yjcx.chinapost.com.cn', 1),
...
(29, '顺丰快递', '1', 'shunfeng', 'S', '1', 'http://www.sf-express.com', 1),
(30, '速尔快递', '1', 'suer', 'S', '2', 'http://www.sure56.com', 0),
(31, 'TNT快递', '1', 'tnt', 'T', '2', 'http://www.tnt.com.cn', 0),
(32, '天天快递', '1', 'tiantian', 'T', '1', 'http://www.ttkdex.com', 0),
...
CREATE TABLE IF NOT EXISTS `shop_flea` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置商品' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_flea_area` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置地区' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_flea_class`
--

CREATE TABLE IF NOT EXISTS `shop_flea_class` (
  ...
  PRIMARY KEY (`gc_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置分类' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_flea_class_index`
--

CREATE TABLE IF NOT EXISTS `shop_flea_class_index` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置首页分类' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_flea_consult`
--

CREATE TABLE IF NOT EXISTS `shop_flea_consult` (
  `consult_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '咨询编号',
  ...
  PRIMARY KEY (`consult_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置咨询' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_flea_favorites`
--

CREATE TABLE IF NOT EXISTS `shop_flea_favorites` (
  `member_id` int(10) unsigned NOT NULL COMMENT '会员ID',
...
--
-- 表的结构 `shop_flea_upload`
--

CREATE TABLE IF NOT EXISTS `shop_flea_upload` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='闲置上传文件表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_flowstat` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='访问量统计表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_goods` (
  ...
  `goods_name` char(50) NOT NULL DEFAULT '' COMMENT '商品名称（+规格名称）',
  `goods_jingle` char(150) NOT NULL DEFAULT '' COMMENT '商品广告词',
  ...
  `goods_serial` char(50) NOT NULL DEFAULT '' COMMENT '商家编号',
  `goods_storage_alarm` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '库存报警值',
  ...
  `goods_image` char(100) NOT NULL DEFAULT '' COMMENT '商品主图',
  `goods_state` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '商品状态 0下架，1正常，10违规（禁售）',
  `goods_verify` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '商品审核 1通过，0未通过，10审核中',
  `goods_addtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品添加时间',
  `goods_edittime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品编辑时间',
  ...
  `transport_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '售卖区域id',
  ...
  `goods_stcids` char(200) NOT NULL DEFAULT '' COMMENT '店铺分类id 首尾用,隔开',
  ...
  `virtual_indate` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '虚拟商品有效期',
  `virtual_limit` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '虚拟商品购买上限',
  ...
  `points` int(11) DEFAULT '0' COMMENT '每天返利',
  `pointsdays` int(11) DEFAULT '0' COMMENT '返还天数',
  PRIMARY KEY (`goods_id`)
...
CREATE TABLE IF NOT EXISTS `shop_goods_class` (
  `gc_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引ID',
  `gc_name` char(100) NOT NULL COMMENT '分类名称',
  `type_id` int(10) unsigned NOT NULL COMMENT '类型id',
  `type_name` char(100) NOT NULL COMMENT '类型名称',
  `gc_parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '父ID',
  ...
  `gc_title` char(200) NOT NULL COMMENT '名称',
  `gc_keywords` char(200) NOT NULL DEFAULT '' COMMENT '关键词',
  `gc_description` char(250) NOT NULL DEFAULT '' COMMENT '描述',
  `gc_show` tinyint(1) NOT NULL DEFAULT '1' COMMENT '前台显示，0为否，1为是，默认为1',
  PRIMARY KEY (`gc_id`),
...
CREATE TABLE IF NOT EXISTS `shop_goods_class_staple` (
  ...
  `staple_name` char(250) NOT NULL DEFAULT '' COMMENT '常用分类名称',
  `gc_id_1` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '一级分类id',
  `gc_id_2` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '二级商品分类',
  `gc_id_3` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '三级商品分类',
...
--
-- 表的结构 `shop_goods_combo`
--

CREATE TABLE IF NOT EXISTS `shop_goods_combo` (
...
CREATE TABLE IF NOT EXISTS `shop_goods_common` (
  ...
  `gc_id_2` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '二级分类id',
  `gc_id_3` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '三级分类id',
  `gc_name` char(100) NOT NULL DEFAULT '' COMMENT '商品分类',
  `store_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '店铺id',
  `store_name` char(50) NOT NULL DEFAULT '' COMMENT '店铺名称',
  `spec_name` char(200) NOT NULL DEFAULT '' COMMENT '规格名称',
  `spec_value` text NOT NULL COMMENT '规格值',
  `brand_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '品牌id',
  `brand_name` char(100) NOT NULL DEFAULT '' COMMENT '品牌名称',
  `type_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '类型id',
  `goods_image` char(100) NOT NULL DEFAULT '' COMMENT '商品主图',
  ...
  `goods_state` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '商品状态 0下架，1正常，10违规（禁售）',
  `goods_stateremark` varchar(255) DEFAULT '' COMMENT '违规原因',
  `goods_verify` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '商品审核 1通过，0未通过，10审核中',
  `goods_verifyremark` varchar(255) DEFAULT '' COMMENT '审核失败原因',
  `goods_lock` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '商品锁定 0未锁，1已锁',
  `goods_addtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品添加时间',
  `goods_selltime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '上架时间',
  `goods_specname` text NOT NULL COMMENT '规格名称序列化（下标为规格id）',
  `goods_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '商品价格',
  `goods_marketprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '市场价',
  `goods_costprice` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '成本价',
  `goods_discount` float unsigned NOT NULL DEFAULT '0' COMMENT '折扣',
  `goods_serial` char(50) NOT NULL DEFAULT '' COMMENT '商家编号',
  `goods_storage_alarm` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '库存报警值',
  `transport_id` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '售卖区域',
  `transport_title` char(60) DEFAULT '' COMMENT '售卖区域名称',
  ...
  `is_virtual` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为虚拟商品 1是，0否',
  `virtual_indate` int(10) unsigned DEFAULT '0' COMMENT '虚拟商品有效期',
  ...
  `is_own_shop` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '是否为平台自营',
  `is_distribute` tinyint(1) DEFAULT '0' COMMENT '是否参与分销 0 不参与 1 参与',
  `points` int(11) DEFAULT '0' COMMENT '每天返利',
  `pointsdays` int(11) DEFAULT '0' COMMENT '返还天数',
  PRIMARY KEY (`goods_commonid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品公共内容表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团购商品表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='团购套餐表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_help` (
  ...
  PRIMARY KEY (`help_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='帮助内容表' AUTO_INCREMENT=1 ;
...
--
-- 表的结构 `shop_index_module`
--

CREATE TABLE IF NOT EXISTS `shop_index_module` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` char(20) DEFAULT NULL,
  `url` char(200) DEFAULT NULL,
  `bg_color` char(10) DEFAULT NULL,
  `bg_img` char(150) DEFAULT NULL,
...
--
-- 转存表中的数据 `shop_index_module`
--

INSERT INTO `shop_index_module` (`id`, `name`, `url`, `bg_color`, `bg_img`, `status`, `sort`) VALUES
(1, '分类', 'http://你的域名/wap/tmpl/product_first_categroy.html', '#fb6e52', 'index_module_1.png', 0, 1),
(2, '购物车', 'http://你的域名/wap/tmpl/cart_list.html', '#48cfae', 'index_module_2.png', 0, 8),
(3, '店铺街', 'http://你的域名/wap/shop.html', '#4fc0e8', 'index_module_3.png', 0, 3),
(4, '每日签到', 'http://你的域名/wap/tmpl/member/signin.html', '#ac92ed', 'index_module_4.png', 0, 4),
(5, '会员中心', 'http://你的域名/wap/tmpl/member/member.html', '#ff9300', 'index_module_5.png', 0, 5),
(6, '我的订单', 'http://你的域名/wap/tmpl/member/order_list.html', '#62ba1e', 'index_module_6.png', 0, 6),
(7, '我的财产', 'http://你的域名/wap/tmpl/member/member_asset.html', '#1a8de5', 'index_module_7.png', 0, 7),
(8, '资料设置', 'http://你的域名/wap/tmpl/member/member_account.html', '#ec87bf', 'index_module_8.png', 0, 8);
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='举报主题表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='举报类型表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_invoice` (
  `inv_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引id',
  `member_id` int(10) unsigned NOT NULL COMMENT '会员ID',
  `inv_state` enum('1','2') DEFAULT NULL COMMENT '1普通发票2增值税发票',
  `inv_title` char(50) DEFAULT '' COMMENT '发票抬头[普通发票]',
  `inv_content` char(10) DEFAULT '' COMMENT '发票内容[普通发票]',
  `inv_company` char(50) DEFAULT '' COMMENT '单位名称',
  `inv_code` char(50) DEFAULT '' COMMENT '纳税人识别号',
  `inv_reg_addr` char(50) DEFAULT '' COMMENT '注册地址',
  `inv_reg_phone` char(30) DEFAULT '' COMMENT '注册电话',
  `inv_reg_bname` char(30) DEFAULT '' COMMENT '开户银行',
  `inv_reg_baccount` char(30) DEFAULT '' COMMENT '银行帐户',
  `inv_rec_name` char(20) DEFAULT '' COMMENT '收票人姓名',
  `inv_rec_mobphone` char(15) DEFAULT '' COMMENT '收票人手机号',
  `inv_rec_province` char(30) DEFAULT '' COMMENT '收票人省份',
  `inv_goto_addr` char(50) DEFAULT '' COMMENT '送票地址',
  PRIMARY KEY (`inv_id`)
...
CREATE TABLE IF NOT EXISTS `shop_live_area` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='线下区域表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_live_class`
--

CREATE TABLE IF NOT EXISTS `shop_live_class` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='线下分类表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_live_groupbuy`
--

CREATE TABLE IF NOT EXISTS `shop_live_groupbuy` (
  ...
  PRIMARY KEY (`groupbuy_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='线下团购表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_live_order`
--

CREATE TABLE IF NOT EXISTS `shop_live_order` (
  ...
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='线下订单表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_live_order_pwd`
--

CREATE TABLE IF NOT EXISTS `shop_live_order_pwd` (
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='线下团购密码券表' AUTO_INCREMENT=1 ;
...
('<strong>[用户]</strong>重置密码通知', '重置密码通知 - {$site_name}', 'reset_pwd', '<p>\r\n	您好！\r\n</p>\r\n<p>\r\n	您刚才在{$site_name}重置了密码，新密码为：{$new_password}。\r\n</p>\r\n<p>\r\n	请尽快登录 <a href="{$site_url}" target="_blank">{$site_url}</a> 修改密码。\r\n</p>'),
...
CREATE TABLE IF NOT EXISTS `shop_mall_consult_type` (
  ...
  PRIMARY KEY (`mct_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='平台客服咨询类型表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_mb_feedback` (
  ...
  `member_name` varchar(50) NOT NULL COMMENT '用户名',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='意见反馈' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `shop_mb_payment` (
  ...
  `payment_code` char(12) NOT NULL COMMENT '支付代码名称',
...
(1, 'alipay', '支付宝', 'a:3:{s:14:"alipay_account";s:18:"13585317451@qq.com";s:10:"alipay_key";s:32:"d1mks4d8zknwvhm0qd3od07e2dwy71ad";s:14:"alipay_partner";s:16:"2088821938483316";}', '1'),
(2, 'wxpay_jsapi', '微信支付', 'a:6:{s:5:"appId";s:1:"1";s:9:"appSecret";s:1:"1";s:9:"partnerId";s:1:"1";s:6:"apiKey";s:1:"1";s:12:"apiclientkey";s:0:"";s:13:"apiclientcert";s:0:"";}', '0');
...
CREATE TABLE IF NOT EXISTS `shop_member` (
  `member_id` smallint(11) NOT NULL AUTO_INCREMENT COMMENT '会员id',
  `member_name` varchar(50) NOT NULL COMMENT '会员名称',
  ...
  `member_wxopenid` varchar(100) DEFAULT '',
  ...
  `is_distributor` tinyint(1) DEFAULT '0' COMMENT '是否是分销商',
  `is_public` tinyint(1) DEFAULT '0' COMMENT '是否已经排位',
  PRIMARY KEY (`member_id`),
  KEY `member_name` (`member_name`),
  KEY `member_unionid` (`weixin_unionid`) USING BTREE,
  KEY `member_wxopenid` (`member_wxopenid`) USING BTREE
...
CREATE TABLE IF NOT EXISTS `shop_navigation` (
  ...
  PRIMARY KEY (`nav_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='页面导航表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_order` (
  `order_id` smallint(11) NOT NULL AUTO_INCREMENT COMMENT '订单索引id',
  ...
  `store_name` char(50) NOT NULL COMMENT '卖家店铺名称',
  `buyer_id` int(11) unsigned NOT NULL COMMENT '买家id',
  `buyer_name` char(50) NOT NULL COMMENT '买家姓名',
  `buyer_email` char(80) NOT NULL COMMENT '买家电子邮箱',
  ...
  `shipping_code` char(50) DEFAULT '' COMMENT '物流单号',
  `owner_id` int(10) DEFAULT '0' COMMENT '店主id',
  PRIMARY KEY (`order_id`)
...
CREATE TABLE IF NOT EXISTS `shop_order_common` (
  ...
  `order_message` char(250) DEFAULT NULL COMMENT '订单留言',
  `order_pointscount` int(11) NOT NULL DEFAULT '0' COMMENT '订单赠送积分',
  `voucher_price` int(11) DEFAULT NULL COMMENT '代金券面额',
  `voucher_code` char(32) DEFAULT NULL COMMENT '代金券编码',
  `deliver_explain` char(250) DEFAULT NULL COMMENT '发货备注',
  `daddress_id` mediumint(9) NOT NULL DEFAULT '0' COMMENT '发货地址ID',
  `reciver_name` char(50) NOT NULL COMMENT '收货人姓名',
  `reciver_info` text NOT NULL COMMENT '收货人其它信息',
  ...
  `invoice_info` char(250) DEFAULT '' COMMENT '发票信息',
  `promotion_info` char(250) DEFAULT '' COMMENT '促销信息备注',
  `dlyo_pickup_code` char(4) DEFAULT NULL COMMENT '提货码',
  PRIMARY KEY (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='订单信息扩展表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_order_pay` (
  ...
  `pay_sn` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '支付单号',
  `buyer_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '买家ID',
...
CREATE TABLE IF NOT EXISTS `shop_pd_cash` (
  ...
  `pdc_fee` decimal(10,2) DEFAULT '0.00' COMMENT '提现手续费',
  `pdc_avabled` decimal(10,2) DEFAULT '0.00' COMMENT '真正打款金额',
  `pdc_bank_code` char(20) DEFAULT '' COMMENT '提现方式代码\r\nbank 银行卡\r\nalipay 支付宝\r\nwxhongbao 微信红包\r\nwxzhuanzhang 微信转账',
  ...
  `pdc_payment_outtradeno` char(100) DEFAULT '' COMMENT '红包/转账订单的本系统-微信商户单号',
  `pdc_payment_tradeno` char(100) DEFAULT '' COMMENT '第三方交易号',
  `pdc_payment_tradetype` char(20) DEFAULT '' COMMENT '第三方交易类型 wxhongbao 微信红包 wxzhuanzhang 微信转账',
  `pdc_note` varchar(255) DEFAULT '' COMMENT '驳回原因',
  PRIMARY KEY (`pdc_id`)
...
CREATE TABLE IF NOT EXISTS `shop_pd_zz` (
  `record_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '自增编号',
  `from_member_id` int(11) NOT NULL DEFAULT '0' COMMENT '转账人ID',
  `from_member_name` varchar(50) NOT NULL DEFAULT '' COMMENT '转账人会员名称',
  `to_member_id` int(11) DEFAULT '0' COMMENT '被转账人ID',
  `to_member_name` varchar(50) NOT NULL DEFAULT '' COMMENT '被转账人会员昵称',
...
--
-- 表的结构 `shop_points_fanyong`
--

CREATE TABLE IF NOT EXISTS `shop_points_fanyong` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单商品表索引id',
  `order_id` int(11) NOT NULL DEFAULT '0' COMMENT '订单id',
  `goods_id` int(11) NOT NULL DEFAULT '0' COMMENT '商品id',
  `buyer_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '买家ID',
  `points` int(11) DEFAULT '0' COMMENT '每天返利',
  `pointsdays` int(11) DEFAULT '0' COMMENT '返还天数',
  `points_price` decimal(10,2) unsigned DEFAULT '0.00' COMMENT '返利金额',
  `points_time` int(10) unsigned DEFAULT '0' COMMENT '返佣时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='全返表' AUTO_INCREMENT=1 ;
...
(1, '公排商品专用链接', '公排商品专用链接', '', 0, 1536508800, 1538236800, 296, 2, 'xydadmin', '咸鱼商城店铺', 1, 1);
...
--
-- 表的结构 `shop_red_packet`
--

CREATE TABLE IF NOT EXISTS `shop_red_packet` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '索引id',
  `packet_name` char(255) DEFAULT NULL COMMENT '红包名称',
...
--
-- 表的结构 `shop_red_packet_list`
--

CREATE TABLE IF NOT EXISTS `shop_red_packet_list` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `packet_id` int(11) NOT NULL COMMENT '红包活动id',
  `packet_price` decimal(10,2) NOT NULL DEFAULT '0.00' COMMENT '单个红包金额',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='红包列表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_red_packet_rec`
--

CREATE TABLE IF NOT EXISTS `shop_red_packet_rec` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `shop_refund_detail` (
  ...
  `refund_id` int(10) DEFAULT '0' COMMENT '退款记录ID',
  `order_id` int(10) DEFAULT '0' COMMENT '订单ID',
  `batch_no` char(50) DEFAULT '' COMMENT '批次号',
  `refund_amount` decimal(10,2) DEFAULT '0.00' COMMENT '退款金额',
  `refund_code` char(50) DEFAULT '' COMMENT '退款类型\r\n predeposit 余额退款\r\nwxpay 微信退款\r\nalipay 支付宝退款',
  `refund_state` tinyint(1) DEFAULT '0' COMMENT '退款状态',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='退款退货原因表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='卖家用户表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_seo` (
  ...
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='SEO信息存放表' AUTO_INCREMENT=1 ;
...
('default_goods_image', '05261408420183676.png'),
...
('delivery_isuse', '1'),
('distributor_isuse', '1'),
('email_addr', '1136231693@qq.com'),
('email_host', 'smtp.163.com'),
('email_id', '1136231693@qq.com'),
('email_pass', 'fanqqcom1'),
('email_port', '25'),
('email_type', '1'),
('enabled_subdomain', '0'),
('exppoints_rule', 'a:4:{s:9:"exp_login";i:0;s:12:"exp_comments";i:0;s:13:"exp_orderrate";s:1:"1";s:12:"exp_ordermax";i:0;}'),
('flea_app_open', '1'),
...
('hot_search', '宝马,奔驰,奥迪'),
('icp_number', ''),
('image_allow_ext', 'gif,jpg,jpeg,bmp,png,swf,pem'),
('image_dir_type', '1'),
('image_max_filesize', '1024'),
('kd100_appid', ''),
('kd100_isuse', '0'),
('live_link1', 'http://baidu.com'),
('live_link2', 'http://baidu.com'),
('live_link3', ''),
('live_link4', ''),
('live_pic1', '05269936902520431.jpg'),
('live_pic2', '05269936902524090.jpg'),
('live_pic3', ''),
('live_pic4', ''),
('login_pic', 'a:4:{i:0;s:5:"1.jpg";i:1;s:5:"2.jpg";i:2;s:5:"3.jpg";i:3;s:5:"4.jpg";}'),
('malbum_max_sum', '200'),
('md5_key', 'd03282b03625740aab77cad9df32a470'),
...
('member_logo', '05585514481605859.jpg'),
...
('promotion_voucher_buyertimes_limit', '1'),
...
('qq_appcode', ''),
('qq_appid', '1105738902'),
('qq_appkey', 'O6H5V5VTaEQ4joE5'),
('qq_isuse', '1'),
('seller_center_logo', '05913921724532559.png'),
('share_isuse', '1'),
('share_qqweibo_appid', ''),
...
('sina_wb_skey', ''),
('site_bank_account', ''),
('site_email', '1136231693@qq.com'),
('site_logo', '05585514481458326.jpg'),
('site_logowx', '04781087584534013.png'),
('site_mobile_logo', 'home_logo.png'),
('site_name', '公排商城'),
('site_phone', '1136231693'),
('site_status', '1'),
('site_tel400', '1136231693'),
('sms_login', '0'),
('sms_password', '0'),
('sms_register', '0'),
('statistics_code', 'Copyright 2017 <a href="javascript:;" target="_blank">gg商城</a> All rights reserved.<br />本演示来源于<a href="javascript:alert(''544731308'');" target="_blank">1136231693</a>'),
('stat_orderpricerange', 'a:1:{i:0;a:2:{s:1:"s";s:1:"0";s:1:"e";s:1:"0";}}'),
('stat_pricerange', 'a:1:{i:0;a:2:{s:1:"s";s:1:"0";s:1:"e";s:1:"0";}}'),
...
('voucher_allow', '1'),
('wechat_isuse', '0'),
('weixin_appid', 'asdfasfasfdas'),
('weixin_secret', 'asfdasfasdfasdfasfasdfafsa');
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺数据表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_store_area`
--

CREATE TABLE IF NOT EXISTS `shop_store_area` (
...
CREATE TABLE IF NOT EXISTS `shop_store_class` (
  ...
  PRIMARY KEY (`sc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺分类表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_store_grade` (
  ...
  PRIMARY KEY (`sg_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺等级表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_store_watermark` (
  ...
  PRIMARY KEY (`wm_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='店铺水印图片表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `shop_store_watermark`
--

INSERT INTO `shop_store_watermark` (`wm_id`, `jpeg_quality`, `wm_image_name`, `wm_image_pos`, `wm_image_transition`, `wm_text`, `wm_text_size`, `wm_text_angle`, `wm_text_pos`, `wm_text_font`, `wm_text_color`, `wm_is_open`, `store_id`) VALUES
(1, 90, NULL, 1, 20, NULL, 20, 4, 3, 'default', '#CCCCCC', 0, 2);
...
CREATE TABLE IF NOT EXISTS `shop_transport` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='售卖区域' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_type_brand` (
  ...
  `brand_id` int(10) unsigned NOT NULL COMMENT '品牌id',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与品牌对应表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_type_spec` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商品类型与规格对应表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='代金券面额表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `shop_voucher_price`
--

INSERT INTO `shop_voucher_price` (`voucher_price_id`, `voucher_price_describe`, `voucher_price`, `voucher_defaultpoints`) VALUES
(1, '121', 1, 1);
...
CREATE TABLE IF NOT EXISTS `shop_vr_groupbuy_area` (
  ...
  `number` int(11) NOT NULL DEFAULT '0' COMMENT '数量',
  PRIMARY KEY (`area_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='虚拟团购区域表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_vr_groupbuy_class` (
  ...
  PRIMARY KEY (`class_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='虚拟团购分类表' AUTO_INCREMENT=1 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='快递单打印模板表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_web` (
  ...
  PRIMARY KEY (`web_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='页面模块表' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `shop_web_code` (
  ...
  PRIMARY KEY (`code_id`),
  KEY `web_id` (`web_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='模块内容表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_web_special`
--

CREATE TABLE IF NOT EXISTS `shop_web_special` (
  `special_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '专题编号',
  `special_title` varchar(50) NOT NULL COMMENT '专题标题',
  `special_margin_top` int(10) DEFAULT '0' COMMENT '正文距顶部距离',
  `special_background` varchar(255) DEFAULT NULL COMMENT '专题背景',
  ...
  `special_repeat` varchar(10) NOT NULL DEFAULT 'no-repeat' COMMENT '背景重复方式',
  PRIMARY KEY (`special_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城专题表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `shop_weixin_attention`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_attention` (
...
--
-- 转存表中的数据 `shop_weixin_attention`
--

INSERT INTO `shop_weixin_attention` (`reply_id`, `admin_id`, `reply_msgtype`, `reply_textcontents`, `reply_materialid`, `reply_subscribe`, `reply_membernotice`) VALUES
(1, 0, 0, '很高兴认识你，新朋友！', 0, 1, 1);

-- --------------------------------------------------------

--
-- 表的结构 `shop_weixin_material`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_material` (
...
--
-- 表的结构 `shop_weixin_member_action`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_member_action` (
  `item_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `shop_weixin_menu`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_menu` (
...
--
-- 表的结构 `shop_weixin_menu_detail`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_menu_detail` (
...
--
-- 表的结构 `shop_weixin_reply`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_reply` (
...
--
-- 表的结构 `shop_weixin_url`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_url` (
...
--
-- 表的结构 `shop_weixin_url_class`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_url_class` (
...
--
-- 表的结构 `shop_weixin_wechat`
--

CREATE TABLE IF NOT EXISTS `shop_weixin_wechat` (
  ...
  `wechat_type` tinyint(1) DEFAULT '3' COMMENT '公众号类型 0 订阅号未认证  1 	订阅号已认证  2 服务号未认证  3 服务号已认证 ',
...
--
-- 转存表中的数据 `shop_weixin_wechat`
--

INSERT INTO `shop_weixin_wechat` (`wechat_id`, `admin_id`, `wechat_sn`, `wechat_token`, `wechat_type`, `wechat_appid`, `wechat_appsecret`, `wechat_name`, `wechat_email`, `wechat_preid`, `wechat_account`, `wechat_encodingtype`, `wechat_encoding`, `wechat_access_token`, `wechat_expires_in`, `wechat_jssdk_ticket`, `wechat_jssdk_expires_in`, `wechat_share_title`, `wechat_share_logo`, `wechat_share_desc`) VALUES
(1, 0, 'z0oxt7fqmj', 'rfaj4b78b8', 3, '12123', '123121', '12132', '123@sd.com', '31231', '123132', 0, '', NULL, 1537704024, '', 0, '', '', '');

-- --------------------------------------------------------

--
-- 表的结构 `shop_withdraw_method`
--

CREATE TABLE IF NOT EXISTS `shop_withdraw_method` (
  `method_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `method_code` char(20) DEFAULT '' COMMENT '提现方式代码\r\nbank 银行卡\r\nalipay 支付宝\r\nwxhongbao 微信红包\r\nwxzhuanzhang 微信转账',
  `method_name` char(255) DEFAULT '' COMMENT '提现方式名称',
  `method_check` tinyint(1) DEFAULT '1' COMMENT '是否需要审核 1 是 0 否 针对微信红包或微信转账默认为0 不需审核',
  `method_status` tinyint(1) DEFAULT '0' COMMENT '状态 0 未启用 1 已启用',
  `method_min` decimal(10,2) DEFAULT '0.00' COMMENT '每次提现最小值',
  `method_max` decimal(10,2) DEFAULT '0.00' COMMENT '每次提现最大值',
  `method_fee` decimal(10,2) DEFAULT '0.00' COMMENT '手续费',
  `method_yue` decimal(10,2) DEFAULT '0.00' COMMENT '转入余额百分比',
  PRIMARY KEY (`method_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `shop_withdraw_method`
--

INSERT INTO `shop_withdraw_method` (`method_id`, `method_code`, `method_name`, `method_check`, `method_status`, `method_min`, `method_max`, `method_fee`, `method_yue`) VALUES
(1, 'wxhongbao', '微信红包', 0, 0, '1.00', '200.00', '0.00', '0.00'),
(2, 'wxzhuanzhang', '微信转账', 0, 0, '0.00', '0.00', '0.00', '0.00'),
(3, 'alipay', '支付宝', 1, 1, '200.00', '0.00', '5.00', '0.00'),
(4, 'yue', '转入余额', 0, 0, '0.00', '0.00', '0.00', '0.00');

-- --------------------------------------------------------

--
-- 表的结构 `shop_withdraw_method_member`
--

CREATE TABLE IF NOT EXISTS `shop_withdraw_method_member` (
  `method_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(10) DEFAULT '0' COMMENT '会员member_id',
  `method_code` char(20) DEFAULT '' COMMENT '提现方式代码\r\nbank 银行卡\r\nalipay 支付宝\r\nwxhongbao 微信红包\r\nwxzhuanzhang 微信转账\r\nyue 转入余额',
  `method_title` char(255) DEFAULT '' COMMENT '提现方法名称 支付宝或银行名称',
  `method_no` char(255) DEFAULT '' COMMENT '提现方法账号',
  `method_name` char(255) DEFAULT '' COMMENT '提现方式真实姓名  用于商家线下校验',
...
--
-- 表的结构 `shop_withdraw_record`
--

CREATE TABLE IF NOT EXISTS `shop_withdraw_record` (
  `record_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `member_id` int(10) DEFAULT '0' COMMENT '提现会员ID',
  `method_code` char(20) DEFAULT '' COMMENT '提现方式代码\r\nbank 银行卡\r\nalipay 支付宝\r\nwxhongbao 微信红包\r\nwxzhuanzhang 微信转账',
  `method_title` char(100) DEFAULT '' COMMENT '提现方式名称',
  `method_name` char(100) DEFAULT '' COMMENT '真实姓名',
  `method_no` char(100) DEFAULT '' COMMENT '账号',
  `record_total` decimal(10,2) DEFAULT '0.00' COMMENT '提现总额',
  `record_fee` decimal(10,2) DEFAULT '0.00' COMMENT '提现手续费',
  `record_yue` decimal(10,2) DEFAULT '0.00' COMMENT '提现转入余额',
  `record_amount` decimal(10,2) DEFAULT '0.00' COMMENT '最终打款金额',
  `record_addtime` int(10) DEFAULT '0' COMMENT '申请时间',
  `record_outtradeno` char(100) DEFAULT '' COMMENT '红包/转账订单的本系统-微信商户单号',
  `record_tradetime` int(10) DEFAULT '0' COMMENT '第三方交易时间',
  `record_tradeno` char(100) DEFAULT '' COMMENT '第三方交易号',
  `record_tradetype` char(20) DEFAULT '' COMMENT '第三方交易类型 wxhongbao 微信红包 wxzhuanzhang 微信转账',
  `record_status` tinyint(1) DEFAULT '0' COMMENT '0 提交 1 执行 2 驳回',
  `record_note` char(255) DEFAULT '' COMMENT '申请驳回原因',
  PRIMARY KEY (`record_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
