$(function(){
    ...
    if($('input[name=sc_id]').val()!=''){
    	$.ajax({
    		url:ApiUrl+'/index.php?act=shop&op=index&key=4&page='+pagesize+'&curpage=1'+'&sc_id='+$('input[name=sc_id]').val(),
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:ApiUrl+'/index.php?act=shop&op=index&key=4&page='+pagesize+'&curpage=1'+'&keyword='+$('#keyword').val()+'&area_info='+area_info,
    		type:'get',
    		dataType:'json',
    		success:function(result){
    			$('input[name=hasmore]').val(result.hasmore);
    ...
    $('select[name=page_list]').change(function(){
    	...
    	if(sc_id>0){
    		var url = ApiUrl+'/index.php?act=shop&op=index&key='+key+'&order='+order+'&page='+page+'&curpage='+curpage+'&sc_id='+sc_id;
    	}else{
    		var url = ApiUrl+'/index.php?act=shop&op=index&key='+key+'&order='+order+'&page='+page+'&curpage='+curpage+'&keyword='+keyword;
    	}
	...
	$('.keyorder').click(function(){
		...
		if(sc_id>0){
			var url = ApiUrl+'/index.php?act=shop&op=index&key='+curkey+'&order='+curorder+'&page='+page+'&curpage=1&sc_id='+sc_id;
		}else{
			var url = ApiUrl+'/index.php?act=shop&op=index&key='+curkey+'&order='+curorder+'&page='+page+'&curpage=1&keyword='+keyword;
		}
