...
$(function() {
	$.ajax({
		type: "post",
		url:ApiUrl+"/index.php?act=pd_tixian&op=get_enabled_money",
		data: {
			key: key
		},
		dataType: "json",
    ...
    $("#list-address-valve").click(function() {
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=pd_tixian&op=method_list",
            data: {
                key: key
            },
            dataType: "json",
	...
	$.ajax({
		type: "post",
		url:ApiUrl+"/index.php?act=pd_tixian&op=withdraw_enabled",
		data: {
			key: key
		},
		dataType: "json",
    ...
    var _init = function(e) {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=pd_tixian&op=method_check",
            dataType: "json",
            data: {
                key: key,
                meid: e
    ...
    $("#add_address_form").find(".btn").click(function() {
        ...
        if (submit_flag) {
            ...
            $.ajax({
                type: "post",
                url: ApiUrl + "/index.php?act=pd_tixian&op=method_add",
                data: e,
                dataType: "json",
                success: function(a) {
                    if (!a.datas.error) {
	...
	$(".withdraw_btn").find("a").click(function() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?act=pd_tixian&op=withdraw_apply",
            data: {
				key:key,
            ...
            success: function(a) {
                if (a.datas.result) {
					$.sDialog({
                        ...
                        okFn: function() {
                           	window.location.href = WapSiteUrl + "/tmpl/member/pdcashlist.html"
                        },
                        cancelFn: function() {
                            window.location.href = WapSiteUrl + "/tmpl/member/pdcashlist.html"
                        }
