//document.write('<div style="margin-top:200px;">' + navigator.appVersion + '</div>');
$(function() {
	var e = getCookie('key');
	if (e) {
		delCookie('username');
	...
	$('.weibo').click(function() {
		location.href = RealApiUrl + '/index.php?act=sinalogin_mobile&op=index';
	});
	$('.qq').click(function() {
		location.href = RealApiUrl + '/index.php?act=qqlogin_mobile&op=index';
	});
	var ua = navigator.userAgent.toLowerCase();
	if (ua.indexOf('micromessenger') > -1) {
		//$('.wxshow').show(); //如果有微信登录插件功能，请把$前面的//去掉即可
