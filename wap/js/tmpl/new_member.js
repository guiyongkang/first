	...
	if (getQueryString("key") != "") {
		...
		$.ajax({
			...
			success: function(a) {
				...
				$("#order_ul").html(e);
				var e = '<li><a href="predepositlog_list.html"><i class="cc-06"></i><p>元</p></a></li>' + '<li><a href="rechargecardlog_list.html"><i class="cc-07"></i><p>充值卡</p></a></li>' + '<li><a href="voucher_pw_list.html"><i class="cc-08"></i><p>代金券</p></a></li>' + '<li><a href="redpacket_list.html"><i class="cc-09"></i><p>红包</p></a></li>' + '<li><a href="pointslog_list.html"><i class="cc-10"></i><p>元</p></a></li>';
				$("#asset_ul").html(e);
				return false
			}
		})
