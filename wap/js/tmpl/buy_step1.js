    ...
    var insertHtmlAddress = function(e, a) {
        ...
        if (!$.isEmptyObject(a.no_send_tpl_ids)) {
			...
			/*if (typeof document.addEventListener != 'undefined') {   
			    document.removeEventListener('click', ToBuyStep2, true);   
			} else {   
			    document.detachEvent('onclick', ToBuyStep2);   
			}*/
			$('#ToBuyStep2').unbind('click', ToBuyStep2);
			...
			/*if (typeof document.addEventListener != 'undefined') {   
			    document.addEventListener('click', ToBuyStep2, true);   
			} else {   
			    document.attachEvent('onclick', ToBuyStep2);   
			}*/
			$('#ToBuyStep2').bind('click', ToBuyStep2);
        }
    };
    ...
    var ToBuyStep2 = function() {
        ...
        $.ajax({
            ...
            success: function(e) {
				...
				var d = {
					pay_sn: e.datas.pay_sn
				};
				if(typeof socket.emit !== 'undefined'){
					socket.emit('checkout', d);
				}
