    ...
    if (a) {
        $.ajax({
            ...
            success: function(a) {
				...
				var e = '<li><a href="../distributor/dis_term.html"><i class="cc-12"></i><p>团队管理</p></a></li>' + '<li><a href="../distributor/dis_spread.html"><i class="cc-13"></i><p>推广二维码</p></a></li>' + '<li><a href="../distributor/dis_record.html"><i class="cc-14"></i><p>分销记录</p></a></li>' + '<li><a href="../distributor/dis_commission.html"><i class="cc-15"></i><p>佣金明细</p></a></li>' + '<li><a href="../distributor/withdraw.html"><i class="cc-16"></i><p>提现</p></a></li>';
