...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo APP_URL;?>">首页</a></span> <span class="arrow">></span> <span>商家入驻申请</span> </div>
<div class="main">
	<div class="sidebar">
		<div class="title">
			<h3>商家入驻申请</h3>
		...
		<div class="content">
			<ul>
				<?php
			if(!empty($output['phone_array']) && is_array($output['phone_array'])) {
			...
			?>
			 ...
			 ?>
				<li><?php echo '邮箱'.$lang['nc_colon'];?><?php echo $output['setting_config']['site_email'];?></li>
			</ul>
		</div>
	</div>
