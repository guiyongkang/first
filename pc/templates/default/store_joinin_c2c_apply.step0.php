...
<div class="store-joinin-apply"> 
	...
	<div id="apply_agreement" class="apply-agreement">
		...
		<div class="bottom"> <a id="btn_apply_agreement_c2c_next" href="javascript:;" class="btn">个人入驻</a> <a id="btn_apply_agreement_next" href="javascript:;" class="btn">企业入驻</a> </div>
	</div>
</div>
