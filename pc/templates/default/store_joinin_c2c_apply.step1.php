			...
			<tbody>
				...
				<tr>
					...
					<td><input name="business_licence_number_electronic" type="file" class="w200" />
						<img border="0" alt="手执身份证照范例" src="<?php echo APP_TEMPLATES_URL;?>/images/example.jpg" style="width:300px;height:210px"> <span class="block">请确保图片清晰，身份证上文字可辨（清晰照片也可使用）。</span></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
