...
<div class="content">
	...
	<dl show_id="<?php echo $val['type_id'];?>">
		<dt onclick="show_list('<?php echo $val['type_id'];?>');"> <i class="<?php echo $val['type_id']==$output['type_id'] ? 'show':'hide';?>"></i><?php echo $val['type_name'];?></dt>
		<dd style="display: <?php echo $val['type_id']==$output['type_id'] ? 'block':'none';?>;">
			<ul>
				...
				<li> <i class="<?php echo $v['help_id']==$output['help_id'] ? 'current':'';?>"></i>
