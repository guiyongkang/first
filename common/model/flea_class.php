...
class flea_class
{
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('flea_class', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('flea_class', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('flea_class', $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function setFleaIndexClass($param)
    {
        ...
        if (is_array($param)) {
            $tmp = array();
            if (!empty($param['fc_index_id1'])) {
                $tmp['fc_index_id1'] = $param['fc_index_id1'];
            }
            if (!empty($param['fc_index_id2'])) {
                $tmp['fc_index_id2'] = $param['fc_index_id2'];
            }
            if (!empty($param['fc_index_id3'])) {
                $tmp['fc_index_id3'] = $param['fc_index_id3'];
            }
            if (!empty($param['fc_index_id4'])) {
                $tmp['fc_index_id4'] = $param['fc_index_id4'];
            }
            if (!empty($param['fc_index_name1'])) {
                $tmp['fc_index_name1'] = $param['fc_index_name1'];
            }
            if (!empty($param['fc_index_name2'])) {
                $tmp['fc_index_name2'] = $param['fc_index_name2'];
            }
            if (!empty($param['fc_index_name3'])) {
                $tmp['fc_index_name3'] = $param['fc_index_name3'];
            }
            if (!empty($param['fc_index_name4'])) {
                $tmp['fc_index_name4'] = $param['fc_index_name4'];
            }
            $where = " fc_index_code = '" . $param['fc_index_code'] . "'";
            $result = db\mysqli::update('flea_class_index', $tmp, $where);
            return $result;
        } else {
            return false;
        }
