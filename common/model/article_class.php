...
class article_class
{
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('article_class', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('article_class', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('article_class', $where);
            return $result;
        } else {
            return false;
        }
