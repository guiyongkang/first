...
class flea_upload
{
    ...
    private function _condition($condition)
    {
        ...
        if (!empty($condition['upload_time_lt'])) {
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            $result = db\mysqli::insert('flea_upload', $param);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('flea_upload', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function updatebywhere($param, $conditionarr)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('flea_upload', $tmp, $condition_str);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('flea_upload', $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function dropUploadById($id)
    {
        ...
        $result = db\mysqli::delete('flea_upload', $condition_str);
        return $result;
    }
    /**
     * 删除图片信息，根据where
