...
class distributor extends core\model
{

    public function __construct() {
        parent::__construct('distributor_account');
    }
     ...
     * @return array
     */
    public function getInfoOne($table,$condition, $field = '*', $order = '') {
        return $this->table($table)->field($field)->where($condition)->order($order)->find();
    }
