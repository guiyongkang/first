...
class store_grade
{
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('store_grade', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('store_grade', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('store_grade', $where);
            return $result;
        } else {
            return false;
        }
    ...
    {
        $condition_str = $this->_condition($condition);
        $param = array('table' => 'store_grade,store', 'field' => 'store_grade.*,store.*', 'where' => $condition_str, 'join_type' => 'left join', 'join_on' => array('store_grade.sg_id = store.grade_id'));
