...
class activity
{
    ...
    public function getList($condition, $page = '')
    {
        ...
        $param['order'] = !empty($condition['order']) ? $condition['order'] : 'activity_id';
    ...
    {
        return db\mysqli::insert('activity', $input);
    }
    /**
     * 更新活动
     *
    ...
    {
        return db\mysqli::update('activity', $input, " activity_id='{$id}' ");
    }
    /**
     * 删除活动
     *
    ...
    {
        return db\mysqli::delete('activity', 'activity_id in(' . $id . ')');
    }
    /**
     * 根据id查询一条活动
     *
    ...
    {
        return db\mysqli::getRow(array('table' => 'activity', 'field' => 'activity_id', 'value' => $id));
    }
    /**
     * 根据条件
     *
