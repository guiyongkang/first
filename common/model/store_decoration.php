...
class store_decoration extends core\model
{
    //装修块布局数组
    ...
    public function getDecorationBackgroundStyle($decoration_setting)
    {
        ...
        if (!empty($decoration_setting['background_attachment'])) {
