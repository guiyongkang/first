...
class flea_area
{
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('flea_area', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('flea_area', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id, $deep = 1)
    {
        if (!empty($id)) {
            ...
            $result = db\mysqli::delete('flea_area', $where);
            return $result;
        } else {
            return false;
        }
