...
class groupbuy_price_range
{
    ...
    public function getList($condition = array(), $page = '')
    {
        ...
        $param['order'] = !empty($condition['order']) ? $condition['order'] : ' ' . self::PK . ' desc ';
    ...
    {
        return db\mysqli::insert(self::TABLE_NAME, $param);
    }
    /*
     * 更新
    ...
    public function update($update_array, $where_array)
    {
        ...
        return db\mysqli::update(self::TABLE_NAME, $update_array, $where);
    }
    /*
     * 删除
     * @param array $param
    ...
    public function drop($param)
    {
        ...
        return db\mysqli::delete(self::TABLE_NAME, $where);
    }
}