...
class store_watermark
{
    ...
    public function addStoreWM($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('store_watermark', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function updateStoreWM($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('store_watermark', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function delStoreWM($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('store_watermark', $where);
            return $result;
        } else {
            return false;
        }
