...
class sns_sharestore
{
    ...
    public function sharestoreAdd($param)
    {
        ...
        if (is_array($param)) {
            $result = db\mysqli::insert('sns_sharestore', $param);
            return $result;
        } else {
            return false;
        }
    ...
    public function editSharestore($param, $condition)
    {
        ...
        $result = db\mysqli::update('sns_sharestore', $param, $condition_str);
        return $result;
    }
    /**
     * 分享店铺记录列表
    ...
    public function getShareStoreList($condition, $page = '', $field = '*', $type = 'simple')
    {
        ...
        switch ($type) {
            case 'detail':
                ...
                $param['join_on'] = array('sns_sharestore.share_storeid=store.store_id');
                break;
            default:
                $param['table'] = 'sns_sharestore';
        }
    ...
    public function delSharestore($condition)
    {
        ...
        return db\mysqli::delete('sns_sharestore', $condition_str);
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
     *
