...
class inform_subject_type
{
    ...
    {
        return db\mysqli::insert('inform_subject_type', $param);
    }
    /*
     * 更新
    ...
    public function updateInformSubjectType($update_array, $where_array)
    {
        ...
        return db\mysqli::update('inform_subject_type', $update_array, $where);
    }
    /*
     * 删除
     * @param array $param
    ...
    public function dropInformSubjectType($param)
    {
        ...
        return db\mysqli::delete('inform_subject_type', $where);
    }
    /*
     *  获得举报类型列表
