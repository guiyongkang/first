...
class spec extends core\model
{
    ...
    public function specList($param, $page = '', $field = '*')
    {
        ...
        $list_spec = db\mysqli::select($array, $page);
        return $list_spec;
    }
    /**
     * 单条规格信息
    ...
    public function specValueAdd($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('spec_value', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function specValueOne($param, $field = '*')
    {
        ...
        $array['where'] = $condition_str;
        $array['field'] = $field;
        $list_spec = db\mysqli::select($array);
        return $list_spec['0'];
    }
    /**
     * 删除规格
    ...
    {
        $condition_str = '';
        if (!empty($condition_array['sp_id'])) {
        ...
        if (!empty($condition_array['in_sp_value_id'])) {
