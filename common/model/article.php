...
class article
{
    ...
    public function add($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::insert('article', $tmp);
            return $result;
        } else {
            return false;
        }
    ...
    public function update($param)
    {
        ...
        if (is_array($param)) {
            ...
            $result = db\mysqli::update('article', $tmp, $where);
            return $result;
        } else {
            return false;
        }
    ...
    public function del($id)
    {
        if (intval($id) > 0) {
            ...
            $result = db\mysqli::delete('article', $where);
            return $result;
        } else {
            return false;
        }
