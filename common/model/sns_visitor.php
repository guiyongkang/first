...
class sns_visitor
{
    ...
    public function visitorAdd($param)
    {
        ...
        $result = db\mysqli::insert('sns_visitor', $param);
        return $result;
    }
    /**
     * 访客列表
    ...
    public function visitorEdit($param, $condition)
    {
        ...
        //得到条件语句
        $condition_str = $this->getCondition($condition);
        $result = db\mysqli::update('sns_visitor', $param, $condition_str);
        return $result;
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
