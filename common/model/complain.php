...
class complain extends core\model
{
    ...
    {
        return db\mysqli::insert('complain', $param);
    }
    /*
     * 更新
    ...
    public function updateComplain($update_array, $where_array)
    {
        ...
        return db\mysqli::update('complain', $update_array, $where);
    }
    /*
     * 删除
     * @param array $param
    ...
    public function dropComplain($param)
    {
        ...
        return db\mysqli::delete('complain', $where);
    }
    /*
     *  获得投诉列表
     *  @param array $condition
    ...
    public function getComplainGoodsList($complain_list)
    {
        ...
        if (!empty($complain_list) && is_array($complain_list)) {
            foreach ($complain_list as $key => $value) {
                $goods_ids[] = $value['order_goods_id'];
                //订单商品表编号
            }
        }
        $condition = array();
    ...
    public function getCount($condition)
    {
        ...
        $count = db\mysqli::getCount('complain', $condition_str);
        return $count;
    }
}