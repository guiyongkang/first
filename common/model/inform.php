...
class inform extends core\model
{
    ...
    {
        return db\mysqli::insert('inform', $param);
    }
    /*
     * 更新
    ...
    public function updateInform($update_array, $where_array)
    {
        ...
        return db\mysqli::update('inform', $update_array, $where);
    }
    /*
     * 删除
     * @param array $param
    ...
    public function dropInform($param)
    {
        ...
        return db\mysqli::delete('inform', $where);
    }
    /*
     *  获得列表
     *  @param array $condition
    ...
    public function getCount($condition)
    {
        ...
        $count = db\mysqli::getCount('inform', $condition_str);
        return $count;
    }
}