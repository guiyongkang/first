...
class activity_detail
{
    ...
    {
        return db\mysqli::insert('activity_detail', $input);
    }
    /**
     * 更新
     *
    ...
    {
        return db\mysqli::update('activity_detail', $input, 'activity_detail_id in(' . $id . ')');
    }
    /**
     * 根据条件更新
     *
    ...
    {
        return db\mysqli::update('activity_detail', $input, $this->getCondition($condition));
    }
    /**
     * 删除
     *
    ...
    {
        return db\mysqli::delete('activity_detail', 'activity_detail_id in(' . $id . ')');
    }
    /**
     * 根据条件删除
     *
    ...
    {
        return db\mysqli::delete('activity_detail', $this->getCondition($condition));
    }
    /**
     * 根据条件查询活动内容信息
     *
    ...
    private function getCondition($condition)
    {
        ...
        if (!empty($condition['activity_detail_state'])) {
        ...
        if (!empty($condition_array['goods_show'])) {
