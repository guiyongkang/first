...
class sns_friend
{
    ...
    public function addFriend($param)
    {
        ...
        if (is_array($param)) {
            $result = db\mysqli::insert('sns_friend', $param);
            return $result;
        } else {
            return false;
        }
    ...
    public function listFriend($condition, $field = '*', $obj_page = '', $type = 'simple')
    {
        ...
        $friend_list = db\mysqli::select($param, $obj_page);
        return $friend_list;
    }
    /**
     * 获取好友详细
    ...
    public function countFriend($condition)
    {
        //得到条件语句
        $condition_str = $this->getCondition($condition);
        $count = db\mysqli::getCount('sns_friend', $condition_str);
        return $count;
    }
    /**
     * 更新好友信息
    ...
    public function editFriend($param, $condition)
    {
        ...
        //得到条件语句
        $condition_str = $this->getCondition($condition);
        $result = db\mysqli::update('sns_friend', $param, $condition_str);
        return $result;
    }
    /**
     * 删除关注
    ...
    public function delFriend($condition)
    {
        ...
        return db\mysqli::delete('sns_friend', $condition_str);
    }
    /**
     * 将条件数组组合为SQL语句的条件部分
     *
