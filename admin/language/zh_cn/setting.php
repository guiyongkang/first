...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:ＸＸＸ,开户行:中国银行XX分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 SAFE_CONST@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 SAFE_CONST@163.com';
$lang['smtp_user_pwd']           = 'SMTP 身份验证密码';
$lang['smtp_user_pwd_tip']       = 'SAFE_CONST@163.com邮件的密码，如 123456';
