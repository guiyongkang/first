		...
		<form class="tab-content" method="post" name="message_form" >
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="message_switch1" class="cb-enable <?php if($output['mmtpl_info']['mmt_message_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="message_content" rows="6" class="tarea"><?php echo $output['mmtpl_info']['mmt_message_content'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
				</tbody>
			</table>
		...
		<form class="tab-content" method="post" name="short_name" style="display:none;">
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="short_switch1" class="cb-enable <?php if($output['mmtpl_info']['mmt_short_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="short_content" rows="6" class="tarea"><?php echo $output['mmtpl_info']['mmt_short_content'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
				</tbody>
			</table>
		...
		<form class="tab-content" method="post" name="mail_form" style="display:none;">
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="mail_switch1" class="cb-enable <?php if($output['mmtpl_info']['mmt_mail_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="mail_subject" rows="6" class="tarea"><?php echo $output['mmtpl_info']['mmt_mail_subject'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
					<tr>
