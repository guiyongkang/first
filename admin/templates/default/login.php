...
<div class="login-layout">
	...
	<form method="post" id="form_login">
		...
		<input type="hidden" name="SiteUrl" id="SiteUrl" value="<?php echo APP_URL;?>" />
		...
		<div class="avatar"><img src="<?php if (cookie('admin_avatar') == '') {echo APP_TEMPLATES_URL. '/images/login/admin.png';} else { echo UPLOAD_SITE_URL . '/' . ATTACH_ADMIN_AVATAR . '/' . cookie('admin_avatar');}?>" alt=""></div>
