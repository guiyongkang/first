				...
				<td colspan="2" class="vatop"><div class="home-templates-board-layout style-<?php echo $output['web_array']['style_name'];?>">
						<div class="left">
							<dl id="left_tit">
								...
								<dd class="tit-txt" <?php if(isset($output['code_tit']['code_info']['type']) && $output['code_tit']['code_info']['type'] != 'txt'){ ?>style="display:none;"<?php } ?>>
									<div id="picture_floor" class="txt-type"> <span><?php echo isset($output['code_tit']['code_info']['floor']) ? $output['code_tit']['code_info']['floor'] : '';?></span>
										<h2><?php echo isset($output['code_tit']['code_info']['title']) ? $output['code_tit']['code_info']['title'] : '';?></h2>
									</div>
								</dd>
								<dd class="tit-pic" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_tit']['code_info']['type'] == 'txt')){ ?>style="display:none;"<?php } ?>>
									<div id="picture_tit" class="picture"> <img src="<?php echo UPLOAD_SITE_URL.'/'.(isset($output['code_tit']['code_info']['pic']) ? $output['code_tit']['code_info']['pic'] : '');?>"/> </div>
								</dd>
							</dl>
							<dl>
								<dt>
								...
								<dd class="category-list">
									<?php if (!empty($output['code_category_list']['code_info']['goods_class']) && is_array($output['code_category_list']['code_info']['goods_class'])) { ?>
									<ul>
							...
							<dl recommends_id="<?php echo $key;?>">
								...
								<dd class="act-hot-goods">
									<ul>
										...
										<li title="<?php echo $v['goods_name'];?>"> <a href="javascript:void(0);"><?php echo $v['goods_name'];?></a> </li>
										<?php } ?>
									</ul>
								</dd>
								<?php }else { ?>
								...
								<div>
									...
									<dl recommend_id="<?php echo $key;?>">
										<dt>
											...
											<a href="JavaScript:del_recommend(<?php echo $key;?>);"><i class="icon-remove-sign "></i><?php echo $lang['nc_del'];?></a> <a href="JavaScript:show_recommend_dialog(<?php echo $key;?>);"><i class="icon-shopping-cart"></i><?php echo '商品块';?></a> <a href="JavaScript:show_recommend_pic_dialog(<?php echo $key;?>);"><i class="icon-lightbulb"></i><?php echo '广告块';?></a> </dt>
										<dd>
											<?php if(!empty($val['goods_list']) && is_array($val['goods_list'])) { ?>
											<ul class="goods-list">
												<?php foreach($val['goods_list'] as $k => $v) { ?>
						...
						<div class="footer-banner">
							<dl id="banner_tit">
								<dt>
									...
									<a href="JavaScript:show_dialog('upload_banner');"><i class="icon-picture"></i><?php echo $lang['nc_edit'];?></a> </dt>
								<dd class="banner-pic">
...
<div id="upload_tit_dialog" style="display:none;">
	...
	<form id="upload_tit_form" name="upload_tit_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=upload_pic" target="upload_pic">
		...
		<input type="hidden" name="tit[pic]" value="<?php echo isset($output['code_tit']['code_info']['pic']) ? $output['code_tit']['code_info']['pic'] : '';?>">
		<input type="hidden" name="tit[url]" value="">
		<table class="table tb-type2">
			<tbody>
				<tr>
					<td colspan="2" class="required"><?php echo $lang['web_config_upload_type'].$lang['nc_colon'];?></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><label title="<?php echo $lang['web_config_upload_pic'];?>">
							<input type="radio" name="tit[type]" value="pic" onclick="upload_type('tit');" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_tit']['code_info']['type'] != 'txt')){ ?>checked="checked"<?php } ?>>
							<span><?php echo $lang['web_config_upload_pic'];?></span></label>
						<label title="<?php echo '文字类型';?>">
							<input type="radio" name="tit[type]" value="txt" onclick="upload_type('tit');" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_tit']['code_info']['type'] == 'txt')){ ?>checked="checked"<?php } ?>>
							<span><?php echo '文字类型';?></span></label></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
		</table>
		<table id="upload_tit_type_pic" class="table tb-type2" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_tit']['code_info']['type'] == 'txt')){ ?>style="display:none;"<?php } ?>>
			<tbody>
				<tr>
		...
		<table id="upload_tit_type_txt" class="table tb-type2" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_tit']['code_info']['type'] != 'txt')){ ?>style="display:none;"<?php } ?>>
			<tbody>
				<tr>
					<td colspan="2" class="required"><?php echo '楼层编号'.$lang['nc_colon'];?></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="tit[floor]" id="tit_floor" value="<?php echo isset($output['code_tit']['code_info']['floor']) ? $output['code_tit']['code_info']['floor'] : '';?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="tit[title]" id="tit_title" value="<?php echo $output['code_tit']['code_info']['title'];?>"></td>
	...
	<form id="category_list_form">
		...
		<div class="category-list category-list-edit">
			<dl>
				...
				<?php foreach($output['code_category_list']['code_info']['goods_class'] as $k => $v) { ?>
				<dd gc_id="<?php echo $v['gc_id'];?>" title="<?php echo $v['gc_name'];?>" ondblclick="del_goods_class(<?php echo $v['gc_id'];?>);"> <i onclick="del_goods_class(<?php echo $v['gc_id'];?>);"></i><?php echo $v['gc_name'];?>
...
<div id="upload_act_dialog" class="upload_act_dialog" style="display:none;">
	...
	<form id="upload_act_form" name="upload_act_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=upload_pic" target="upload_pic">
		...
		<table class="table tb-type2" id="upload_act_type_pic" <?php if(isset($output['code_tit']['code_info']['type']) && ($output['code_act']['code_info']['type'] == 'adv')) { ?>style="display:none;"<?php } ?>>
			<tbody>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input name="act[url]" value="<?php echo !empty($output['code_act']['code_info']['url']) ? $output['code_act']['code_info']['url']:APP_URL;?>" class="txt" type="text"></td>
			...
			<table class="tb-type1 noborder search">
				<tbody>
					<tr>
						...
						<td class="dialog-select-bar" id="recommend_gcategory"><input type="hidden" id="cate_id" name="cate_id" value="0" class="mls_id" />
					...
					<tr>
						...
						<td><input type="text" value="" name="recommend_goods_name" id="recommend_goods_name" class="txt">
							<a href="JavaScript:void(0);" onclick="get_recommend_goods();" class="btn-search " title="<?php echo $lang['nc_query'];?>"></a></td>
					</tr>
				</tbody>
			</table>
...
<div id="recommend_pic_dialog" style="display:none;">
	<form id="recommend_pic_form" name="recommend_pic_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=recommend_pic" target="upload_pic">
		...
		<table class="">
			<tr>
				<td id="add_recommend_pic"><?php if (!empty($output['code_recommend_list']['code_info']) && is_array($output['code_recommend_list']['code_info'])) { ?>
					<?php foreach ($output['code_recommend_list']['code_info'] as $key => $val) { ?>
					...
					<?php } ?>
					<?php } ?></td>
				<td><table class="table tb-type2">
						<tbody>
							<tr>
								<td><?php echo '文字标题'.$lang['nc_colon'];?></td>
							</tr>
							<tr class="noborder">
								<td class="vatop rowform"><input class="txt" type="text" name="pic_list[pic_name]" value=""></td>
							</tr>
							<tr>
								<td><?php echo '跳转链接'.$lang['nc_colon'];?></td>
							</tr>
							<tr class="noborder">
								<td class="vatop rowform"><input class="txt" type="text" name="pic_list[pic_url]" value="<?php echo APP_URL;?>"></td>
							</tr>
							<tr>
				...
				<tbody>
					<tr>
						...
						<td><input type="text" value="" name="recommend_brand_name" id="recommend_brand_name" class="txt">
							<a href="JavaScript:void(0);" onclick="get_recommend_brand();" class="btn-search " title="<?php echo $lang['nc_query'];?>"></a></td>
					</tr>
				</tbody>
			</table>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="hidden" name="slide_id" value="">
						<input class="txt" type="text" name="slide_pic[pic_name]" value=""></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label><?php echo $lang['web_config_upload_url'].$lang['nc_colon'];?></label></td>
			...
			<dd>
				...
				<ul class="dialog-goodslist-s1 goods-list">
					...
					<li id="select_recommends_<?php echo $key;?>_goods_<?php echo $k;?>">
						<div ondblclick="del_recommends_goods(<?php echo $v['goods_id'];?>);" class="goods-pic"> <span class="ac-ico" onclick="del_recommends_goods(<?php echo $v['goods_id'];?>);"></span> <span class="thumb size-72x72"><i></i><img select_goods_id="<?php echo $v['goods_id'];?>" title="<?php echo $v['goods_name'];?>" src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" onload="javascript:DrawImage(this,72,72);" /></span></div>
						<div class="goods-name"><a href="<?php echo APP_URL."/index.php?act=goods&goods_id=".$v['goods_id'];?>" target="_blank"><?php echo $v['goods_name'];?></a></div>
		...
		<div class="dialog-show-box">
			<table class="tb-type1 noborder search">
				<tbody>
					<tr>
						<th><label><?php echo $lang['web_config_recommend_gcategory'];?></label></th>
						<td class="dialog-select-bar" id="recommends_gcategory"><input type="hidden" id="cate_id" name="cate_id" value="0" class="mls_id" />
							<input type="hidden" id="cate_name" name="cate_name" value="" class="mls_names" />
							<select>
								<option value="0">-<?php echo $lang['nc_please_choose'];?>-</option>
								<?php if(!empty($output['goods_class']) && is_array($output['goods_class'])) { ?>
					...
					<tr>
						...
						<td><input type="text" value="" name="recommends_goods_name" id="recommends_goods_name" class="txt">
							<a href="JavaScript:void(0);" onclick="get_recommends_goods();" class="btn-search " title="<?php echo $lang['nc_query'];?>"></a></td>
					</tr>
				</tbody>
			</table>
	...
	<form id="upload_banner_form" name="upload_banner_form" enctype="multipart/form-data" method="post" action="index.php?act=web_api&op=upload_pic" target="upload_pic">
		...
		<table class="table tb-type2" id="upload_act_type_pic" <?php if($output['code_banner']['code_info']['type'] == 'adv') { ?>style="display:none;"<?php } ?>>
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="banner[title]" value="<?php echo $output['code_banner']['code_info']['title'];?>"></td>
					<td class="vatop tips"><?php echo '';?></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label><?php echo $lang['web_config_upload_url'].$lang['nc_colon'];?></label></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input name="banner[url]" value="<?php echo !empty($output['code_banner']['code_info']['url']) ? $output['code_banner']['code_info']['url']:APP_URL;?>" class="txt" type="text"></td>
					<td class="vatop tips"><?php echo $lang['web_config_upload_act_url'];?></td>
				</tr>
				<tr>
					<td colspan="2" class="required"><label><?php echo $lang['web_config_upload_act'].$lang['nc_colon'];?></label></td>
