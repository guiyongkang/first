			...
			<tr class="odd">
				<td>
				    <ul>
						...
						<li><?php echo '第一条属性记录不能删除，系统会根据第一条属性数据设置属性图片'?></li>
					</ul>
				</td>
			</tr>
		</tbody>
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="w96 align-center"><a href="index.php?act=spec&op=spec_edit&sp_id=<?php echo $val['sp_id'];?>"><?php echo $lang['nc_edit'];?></a>
						<?php if($val['sp_id'] != '1'){?>
						| <a onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=spec&op=spec_del&del_id=<?php echo $val['sp_id'];?>';}else{return false;}" href="javascript:void(0)"><?php echo $lang['nc_del'];?></a>
						<?php }?></td>
				</tr>
				<?php }?>
				<?php }else{ ?>
