		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input class="txt" type="text" name="store_name" id="store_name" value="<?php echo isset($_GET['store_name']) ? $_GET['store_name'] : '';?>" /></td>
					<th><label for="from_name"><?php echo $lang['admin_evaluate_frommembername'];?></label></th>
					<td><input class="txt" type="text" name="from_name" id="from_name" value="<?php echo isset($_GET['from_name']) ? $_GET['from_name'] : '';?>" /></td>
					<td><?php echo $lang['admin_evaluate_addtime'];?></td>
					<td><input class="txt date" type="text" name="stime" id="stime" value="<?php echo isset($_GET['stime']) ? $_GET['stime'] : '';?>" />
						~
						<input class="txt date" type="text" name="etime" id="etime" value="<?php echo isset($_GET['etime']) ? $_GET['etime'] : '';?>" /></td>
	...
	<table class="table tb-type2 evallist">
		...
		<tbody>
			...
			<tr class="hover">
				...
				<td class="align-center"> 描述相符
					<div class="raty" style="display:inline-block;" data-score="<?php echo $v['seval_desccredit'];?>"></div>
					服务态度
					<div class="raty" style="display:inline-block;" data-score="<?php echo $v['seval_servicecredit'];?>"></div>
					发货速度
					<div class="raty" style="display:inline-block;" data-score="<?php echo $v['seval_deliverycredit'];?>"></div></td>
				<td class="align-center"><?php echo date('Y-m-d',$v['seval_addtime']);?></td>
				<td class="align-center"><a nctype="btn_del" href="javascript:void(0)" data-seval-id="<?php echo $v['seval_id']; ?>"><?php echo $lang['nc_del']; ?></a></td>
			</tr>
			<?php }?>
			<?php }else{?>
			<tr class="no_data">
