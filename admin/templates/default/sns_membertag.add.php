		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder" style="background: none repeat scroll 0% 0% rgb(251, 251, 251);">
					<td class="vatop rowform"><textarea class="tarea" rows="6" name="membertag_desc" id="membertag_desc"></textarea></td>
	...
	$('#membertag_form').validate({
        ...
        messages : {
        	membertag_name : {
                ...
                maxlength : '<?php echo isset($lang['sns_member_tag_maxlength_error']) ? $lang['sns_member_tag_maxlength_error'] : '';?>'
            },
            membertag_sort : {
