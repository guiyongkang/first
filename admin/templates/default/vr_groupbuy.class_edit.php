	...
	<form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=vr_groupbuy&op=class_edit">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="class_name" id="class_name" class="txt" value="<?php echo $output['class']['class_name'];?>"></td>
				...
				<tr class="noborder">
					...
					<td class="vatop tips"><?php echo isset($lang['class_sort_explain']) ? $lang['class_sort_explain'] : '';?></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="2"><input type="hidden" name="class_id" value="<?php echo $output['class']['class_id'];?>">
						<a id="submit" href="javascript:void(0)" class="btn"><span><?php echo $lang['nc_submit'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
