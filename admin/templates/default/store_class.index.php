		...
		<table class="table tb-type2 nobdb">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="name"><span title="<?php echo $lang['store_class_name'];?>" required="1" fieldid="<?php echo $v['sc_id'];?>" ajax_branch='store_class_name' fieldname="sc_name" nc_type="inline_edit" class="node_name editable"><?php echo $v['sc_name'];?></span></td>
