...
<div class="page">
	...
	<table class="table tb-type2">
		...
		<tbody>
			...
			<tr>
				<td><div id="container_orderamount" class="w100pre close_float" style="height:400px"></div></td>
			</tr>
			<tr>
				<td></td>
			</tr>
			<tr>
				<td><div id="container_goodsnum" class="w100pre close_float" style="height:400px"></div></td>
			</tr>
			<?php } else {?>
			<tr>
				<td><div class="w100pre close_float align-center h36 mt10">查看行业价格分布情况前，请先设置价格区间。<a href="index.php?act=stat_general&op=setting" style="font-size:12px; font-weight:normal;">马上设置</a></div></td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
