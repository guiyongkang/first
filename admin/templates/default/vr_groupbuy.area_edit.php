	...
	<form id="add_form" method="post" action="index.php?act=vr_groupbuy&op=area_edit">
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name='first_letter'>
				...
				<?php if ($output['area']['parent_area_id']) { ?>
					...
					<label for="area_class">
				上级区域<?php echo $lang['nc_colon']; ?>
					</td>
				
					</tr>
				
				<tr class="noborder">
					<td class="vatop rowform"><?php echo $output['parent_area_name'];?>
						<input type='hidden' name='parent_area_id' value="<?php echo $output['area_id'];?>"></td>
				</tr>
				<?php } else { ?>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="hot1" class="cb-enable <?php if($output['area']['hot_city']=='1'){ echo 'selected';}?>"><span><?php echo $lang['open'];?></span></label>
						...
						<input id="hot0" name="is_hot"  value="0" type="radio" <?php if($output['area']['hot_city']=='0'){ echo 'checked';}?> ></td>
				</tr>
				<?php } ?>
			</tbody>
			<tfoot>
