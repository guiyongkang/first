...
<div class="page"> 
	...
	<form id="add_form" method="post" action="<?php echo urlAdmin('waybill', 'waybill_save');?>" enctype="multipart/form-data">
		<?php if(!empty($output['waybill_info'])) { ?>
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_name'] : '';?>" name="waybill_name" id="waybill_name" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><select name="waybill_express">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_width'] : '';?>" name="waybill_width" id="waybill_width" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_height'] : '';?>" name="waybill_height" id="waybill_height" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_top'] : '0';?>" name="waybill_top" id="waybill_top" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo !empty($output['waybill_info']) ? $output['waybill_info']['waybill_left'] : '0';?>" name="waybill_left" id="waybill_left" class="txt"></td>
