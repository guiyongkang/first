	...
	<form method="post" name="form_index" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[index][title]" name="SEO[index][title]" value="<?php echo $output['seo']['index']['title'];?>" class="w300" type="text"/></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[index][keywords]" name="SEO[index][keywords]" value="<?php echo $output['seo']['index']['keywords'];?>" class="w300" type="text" maxlength="200" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[index][description]" name="SEO[index][description]" value="<?php echo $output['seo']['index']['description'];?>" class="w300" type="text" maxlength="200"/></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_group" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[group][title]" name="SEO[group][title]" value="<?php echo $output['seo']['group']['title'];?>" class="w300" type="text"/></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[group][keywords]" name="SEO[group][keywords]" value="<?php echo $output['seo']['group']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[group][description]" name="SEO[group][description]" value="<?php echo $output['seo']['group']['description'];?>" class="w300" type="text" /></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[group_content][title]" name="SEO[group_content][title]" value="<?php echo $output['seo']['group_content']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[group_content][keywords]" name="SEO[group_content][keywords]" value="<?php echo $output['seo']['group_content']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[group_content][description]" name="SEO[group_content][description]" value="<?php echo $output['seo']['group_content']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_brand" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[brand][title]" name="SEO[brand][title]" value="<?php echo $output['seo']['brand']['title'];?>" class="w300" type="text"/></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[brand][keywords]" name="SEO[brand][keywords]" value="<?php echo $output['seo']['brand']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[brand][description]" name="SEO[brand][description]" value="<?php echo $output['seo']['brand']['description'];?>" class="w300" type="text" /></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[brand_list][title]" name="SEO[brand_list][title]" value="<?php echo $output['seo']['brand_list']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[brand_list][keywords]" name="SEO[brand_list][keywords]" value="<?php echo $output['seo']['brand_list']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[brand_list][description]" name="SEO[brand_list][description]" value="<?php echo $output['seo']['brand_list']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_point" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[point][title]" name="SEO[point][title]" value="<?php echo $output['seo']['point']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[point][keywords]" name="SEO[point][keywords]" value="<?php echo $output['seo']['point']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[point][description]" name="SEO[point][description]" value="<?php echo $output['seo']['point']['description'];?>" class="w300" type="text" /></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[point_content][title]" name="SEO[point_content][title]" value="<?php echo $output['seo']['point_content']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[point_content][title]" name="SEO[point_content][keywords]" value="<?php echo $output['seo']['point_content']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[point_content][title]" name="SEO[point_content][description]" value="<?php echo $output['seo']['point_content']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_article" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[article][title]" name="SEO[article][title]" value="<?php echo $output['seo']['article']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[article][keywords]" name="SEO[article][keywords]" value="<?php echo $output['seo']['article']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[article][description]" name="SEO[article][description]" value="<?php echo $output['seo']['article']['description'];?>" class="w300" type="text" /></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[article_content][title]" name="SEO[article_content][title]" value="<?php echo $output['seo']['article_content']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[article_content][keywords]" name="SEO[article_content][keywords]" value="<?php echo $output['seo']['article_content']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[article_content][description]" name="SEO[article_content][description]" value="<?php echo $output['seo']['article_content']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_shop" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[shop][title]" name="SEO[shop][title]" value="<?php echo $output['seo']['shop']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[shop][keywords]" name="SEO[shop][keywords]" value="<?php echo $output['seo']['shop']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[shop][description]" name="SEO[shop][description]" value="<?php echo $output['seo']['shop']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_product" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[product][title]" name="SEO[product][title]" value="<?php echo $output['seo']['product']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[product][keywords]" name="SEO[product][keywords]" value="<?php echo $output['seo']['product']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[product][desciption]" name="SEO[product][description]" value="<?php echo $output['seo']['product']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_category" action="index.php?act=setting&op=seo_category">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96"><?php echo $lang['seo_set_category'];?></td>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="cate_title" name="cate_title" value="" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="cate_keywords" name="cate_keywords" value="" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="cate_description" name="cate_description" value="" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
	...
	<form method="post" name="form_sns" action="index.php?act=setting&op=seo_update">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="w96">title</td>
					<td><input id="SEO[sns][title]" name="SEO[sns][title]" value="<?php echo $output['seo']['sns']['title'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">keywords</td>
					<td><input id="SEO[sns][keywords]" name="SEO[sns][keywords]" value="<?php echo $output['seo']['sns']['keywords'];?>" class="w300" type="text" /></td>
				</tr>
				<tr class="noborder">
					<td class="w96">description</td>
					<td><input id="SEO[sns][desciption]" name="SEO[sns][description]" value="<?php echo $output['seo']['sns']['description'];?>" class="w300" type="text" /></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
