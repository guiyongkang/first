	...
	<form id="grade_form" method="post">
		...
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr>
					<td colspan="2" class="required"><label> <?php echo $lang['allow_upload_album_num'];?>:</label></td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo $output['grade_array']['sg_album_limit'];?>" id="sg_album_limit" name="sg_album_limit" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['zero_said_no_limit'];?></td>
				</tr>
