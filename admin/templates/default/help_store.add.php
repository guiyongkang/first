	...
	<form id="post_form" method="post" name="form1">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr>
					<td colspan="2" class="required"><label class="validation" for="help_sort"><?php echo $lang['nc_sort'];?>:</label></td>
				</tr>
				<tr class="noborder">
				...
				<tr>
					<td colspan="2"><ul id="thumbnails" class="thumblists">
							...
							<li id="pic_<?php echo $val['upload_id'];?>" class="picture" >
								...
								<div class="size-64x64"><span class="thumb"><i></i> <img src="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_ARTICLE.'/'.$val['file_name'];?>" onload="javascript:DrawImage(this,64,64);"/></span></div>
