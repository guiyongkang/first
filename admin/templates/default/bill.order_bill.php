		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><select name="query_month" class="querySelect">
	...
	<table class="table tb-type2 nobdb">
		...
		<tbody>
			...
			<tr class="hover">
				...
				<td class="align-center"><?php echo str_replace(array('0','1','2','3','4'),array('未出账','已出账','店铺已确认','平台已审核','结算完成'),$order['ob_state']);?></td>
				<td class="align-center"><?php echo $order['ob_store_name'].'<br/>id:'.$order['ob_store_id'];?></td>
				<td class="align-center"><a href="index.php?act=bill&op=show_store_month_order&bill_id=<?php echo $order['ob_no'];?>"><?php echo $lang['nc_view'];?></a></td>
			</tr>
			<?php }?>
			<?php }else{?>
			<tr class="no_data">
