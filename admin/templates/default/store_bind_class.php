...
<div class="page">
	...
	<table class="table tb-type2">
      ...
      <tr class="hover edit">
				...
				<td class="w60 align-center"><a nctype="btn_del_store_bind_class"
					href="javascript:;" data-bid="<?php echo $value['bid'];?>">删除</a></td>
			</tr>
      <?php } ?>
      <?php }else { ?>
      <tr class="no_data">
	...
	<table class="table tb-type2">
		...
		<tbody>
			...
			<tr class="noborder">
				<td colspan="2" id="gcategory" class="vatop rowform">
			...
			<tr class="noborder">
				<td class="vatop rowform">
				    <form id="add_form" action="<?php echo urlAdmin('store', 'store_bind_class_add');?>" method="post">
