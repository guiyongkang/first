		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['bundling_name']) ? $_GET['bundling_name'] : '';?>" name="bundling_name" id="bundling_name" class="txt" style="width:100px;"></td>
		...
		<table class="table tb-type2">
			...
			<tbody id="treet1">
				...
				<tr class="hover">
					...
					<td class="align-center"><?php echo $output['state_array'][$val['bl_state']];?></td>
					<td class="nowrap align-center"><?php echo $lang['nc_view'];?> <a href="<?php echo urlAdmin('promotion_bundling', 'del_bundling', array('bl_id' => $val['bl_id']));?>"><?php echo $lang['nc_del'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
