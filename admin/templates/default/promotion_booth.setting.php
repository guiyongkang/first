	...
	<form id="add_form" method="post" action="<?php echo urlAdmin('promotion_booth', 'booth_setting');?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_booth_price" name="promotion_booth_price" value="<?php echo $output['setting']['promotion_booth_price'];?>" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_booth_goods_sum" name="promotion_booth_goods_sum" value="<?php echo $output['setting']['promotion_booth_goods_sum'];?>" class="txt"></td>
