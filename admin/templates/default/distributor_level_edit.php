    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
			...
			<input type='text' name='thumb' id='thumb' value="<?php echo $output['level_info']['level_thumb'] ? UPLOAD_SITE_URL.$output['level_info']['level_thumb'] : '';?>" class='type-file-text' />
        ...
        <tr class="noborder">
          <td class="required" colspan="2">成为该级别分销商条件</td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          ...
          <table style="width:300px; margin-top:10px; border:1px #dfdfdf solid">
                ...
                <tr>
                	<td style="width:60px; border-right:1px #dfdfdf solid; text-align:right; padding-right:20px;"><?php echo $lang['nc_distributor_title'][$i];?>级</td>
        ...
        <?php }?>
        <?php if($output['level_info']['level_default']==0){?>
        <tr class="noborder">
          <td class="required" colspan="2">分销商升级至该级别条件</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" colspan="2">
          <select name="updatetype" style="width:150px;">
            <option value="3"<?php echo $output['level_info']['level_update_type']==3 ? ' selected' : '';?>>购买指定商品</option>
          </select>
          ...
          <div id="updatetype_3" style="padding:12px 0px;">
          	<div class="products_option">
               ...
               <div class="select_items">
                 ...
                 <button type="button" class="button_add">=></button>
                 <select size='10' class="select_product1" multiple style="width:300px; height:100px; display:block; float:left">
                 	<?php if($output['level_info']['level_update_type']==3){?>
                        <?php if(!empty($output['goods_list_update'])){?>
						<?php foreach($output['goods_list_update'] as $v_r){?>
                        <option value="<?php echo $v_r['goods_commonid'];?>"><?php echo $v_r['goods_name'];?></option>
                        <?php }?>
                        <?php }?>
                        <?php }?>
