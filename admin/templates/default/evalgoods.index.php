...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li style="display:none;"><a href="index.php?act=evaluate&op=evalstore_list" ><span><?php echo $lang['admin_evalstore_list'];?></span></a></li>
			</ul>
		</div>
	</div>
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input class="txt" type="text" name="goods_name" id="goods_name" value="<?php echo isset($_GET['goods_name']) ? $_GET['goods_name'] : '';?>" /></td>
	...
	<table class="table tb-type2">
		...
		<tbody>
			...
			<tr class="hover">
				<td><a href="javascript:;"><?php echo $v['geval_goodsname'];?></a></td>
				<td class="evaluation"><div>商品评分：<span class="raty" data-score="<?php echo $v['geval_scores'];?>"></span>
