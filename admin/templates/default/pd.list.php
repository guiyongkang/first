...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a href="index.php?act=predeposit&op=predeposit_add"><span>调节积分</span></a></li>
			</ul>
		</div>
	</div>
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><?php echo isset($lang['admin_predeposit_membername']) ? $lang['admin_predeposit_membername'] : '';?> </th>
					...
					<td><input type="text" id="query_start_date" name="query_start_date" class="txt date" value="<?php echo isset($_GET['query_start_date']) ? $_GET['query_start_date'] : '';?>" >
						<label>~</label>
						<input type="text" id="query_end_date" name="query_end_date" class="txt date" value="<?php echo isset($_GET['query_start_date']) ? $_GET['query_start_date'] : '';?>" ></td>
					<td><select id="paystate_search" name="paystate_search">
							<option value=""><?php echo $lang['admin_predeposit_paystate']; ?></option>
							<option value="0" <?php if(isset($_GET['paystate_search']) && $_GET['paystate_search'] == '0' ) { ?>selected="selected"<?php } ?>>未支付</option>
							<option value="1" <?php if(isset($_GET['paystate_search']) && $_GET['paystate_search'] == '1' ) { ?>selected="selected"<?php } ?>>已支付</option>
						</select>
	...
	<table class="table tb-type2">
		<thead>
			<tr class="thead">
				...
				<th class="align-center"><?php echo $lang['admin_predeposit_recharge_price']; ?></th>
		...
		<tbody>
			...
			<tr class="hover">
				...
				<td class="nowarp align-center"><?php if (intval($v['pdr_payment_time'])) {?>
				...
				<td class="w90 align-center"><?php if (!intval($v['pdr_payment_state'])){?>
					...
					<?php } ?>
					<a href="index.php?act=predeposit&op=recharge_info&id=<?php echo $v['pdr_id']; ?>" class="edit"><?php echo $lang['nc_view']; ?></a></td>
			</tr>
			<?php } ?>
			<?php }else { ?>
			<tr class="no_data">
