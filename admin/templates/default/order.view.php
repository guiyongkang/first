...
<div class="page">
	<table class="table tb-type2 order">
		<tbody>
			...
			<tr>
				<td colspan="2"><ul>
						<li> <strong><?php echo $lang['order_number'];?>:</strong><?php echo $output['order_info']['order_sn'];?> ( 支付单号 <?php echo $lang['nc_colon'];?> <?php echo $output['order_info']['pay_sn'];?> ) </li>
			...
			<tr>
				<td><ul>
						...
						<?php }?>
						<?php if(isset($output['order_info']['shipping_time']) && intval($output['order_info']['shipping_time'])){?>
			...
			<tr>
				<td><table class="table tb-type2 goods ">
						<tbody>
							...
							<tr>
								<td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><img src="<?php echo thumb($goods, 60);?>" /></span></div></td>
								<td class="w50pre"><p><?php echo $goods['goods_name'];?></p>
									<p><?php echo orderGoodsType($goods['goods_type']);?></p></td>
			...
			<tr>
				<td><?php if(!empty($output['order_info']['extend_order_common']['promotion_info'])){ ?>
			...
			<tr>
				<td><?php echo $val['log_role']; ?> <?php echo $val['log_user']; ?>&emsp;<?php echo $lang['order_show_at'];?>&emsp;<?php echo date("Y-m-d H:i:s",$val['log_time']); ?>&emsp;<?php echo $val['log_msg']; ?></td>
			</tr>
			<?php } ?>
			<?php } ?>
		</tbody>
