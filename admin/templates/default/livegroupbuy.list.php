      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w60 picture">
          	...
          	<a target="_blank" href="<?php echo APP_URL."/index.php?act=show_live_groupbuy&op=groupbuy_detail&groupbuy_id=".$val['groupbuy_id'];?>"><img src="<?php echo lgthumb($val['groupbuy_pic'], 'small');?>" style=" max-width: 56px; max-height: 56px;"/></a></span></div>
          </td>
          <td class="group">
            <p><a target="_blank" href="<?php echo APP_URL."/index.php?act=show_live_groupbuy&op=groupbuy_detail&groupbuy_id=".$val['groupbuy_id'];?>"><?php echo $val['groupbuy_name'];?></a></p>
            <p class="store">店铺名称:<?php echo $val['store_name'];?></p>
          </td>
