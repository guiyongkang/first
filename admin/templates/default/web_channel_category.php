...
<dl select_class_id="<?php echo $output['gc_parent']['gc_id'];?>">
	<dt ondblclick="del_gc_parent(<?php echo $output['gc_parent']['gc_id'];?>);"> <span select_id="<?php echo $output['gc_parent']['gc_id'];?>" class="pic"> </span>
		...
		<a class="ncap-btn-mini upload-pic" title="上传分类图片" href="javascript:void(0);"> <i id="form_<?php echo $output['gc_parent']['gc_id'];?>" class="fa fa-upload"></i></a> <a class="ncap-btn-mini del" title="删除该分类块" onclick="del_gc_parent(<?php echo $output['gc_parent']['gc_id'];?>);" href="javascript:void(0);"><i class="fa fa-trash"></i></a> </dt>
	<dd>
