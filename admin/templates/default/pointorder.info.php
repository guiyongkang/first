			...
			<tr>
				<td><table class="table tb-type2 goods ">
						<tbody>
							...
							<tr>
								<td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="javascript:;" class="order_info_pic"> <img src="<?php echo $v['point_goodsimage_small'];?>" onload="javascript:DrawImage(this,56,56);" /></a></span></div></td>
								<td class="w50pre"><a href="javascript:;"><?php echo $v['point_goodsname'];?></a></td>
