	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base">
				...
				<li><a href="index.php?act=bill&op=show_statis"><span>商家账单列表</span></a></li>
			</ul>
		</div>
	</div>
	...
	<table class="table tb-type2 nobdb">
		...
		<tbody>
			...
			<tr class="hover">
				...
				<td class="align-center"><a href="index.php?act=bill&op=show_statis&os_month=<?php echo $bill['os_month'];?>"><?php echo $lang['nc_view'];?></a></td>
			</tr>
			<?php }?>
			<?php }else{?>
			<tr class="no_data">
