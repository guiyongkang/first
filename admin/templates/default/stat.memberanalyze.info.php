<div style="text-align:right;">
	...
	<a class="btns" href="javascript:void(0);" nc_type="export_btn" data-param='{"type":"<?php echo $output['stat_field'];?>"}'><span>导出Excel</span></a> </div>
<table class="table tb-type2 nobdb">
	...
	<tfoot class="tfoot">
		<tr>
			<td colspan="3"><div class="pagination"><?php echo $output['show_page'];?></div></td>
		</tr>
	</tfoot>
	<?php } ?>
</table>
