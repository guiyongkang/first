		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input class="txt" type="text" name="input_inform_goods_name" id="input_inform_goods_name" value="<?php echo isset($_GET['input_inform_goods_name']) ? $_GET['input_inform_goods_name'] : '';?>"></td>
					<th><label for="input_inform_type"><?php echo $lang['inform_type'];?></label></th>
					<td colspan="2"><input class="txt" type="text" name="input_inform_type" id="input_inform_type" value="<?php echo isset($_GET['input_inform_type']) ? $_GET['input_inform_type'] : '';?>"  style=" width:100px;">
						<label for="input_inform_member_name"><?php echo $lang['inform_member_name'];?></label>
						<input class="txt" type="text" name="input_inform_member_name" id="input_inform_member_name" value="<?php echo isset($_GET['input_inform_member_name']) ? $_GET['input_inform_member_name'] : '';?>" style=" width:100px;"></td>
				</tr>
				<tr>
					<th><label for="input_inform_subject"><?php echo $lang['inform_subject'];?></label></th>
					<td><input class="txt" type="text" name="input_inform_subject" id="input_inform_subject" value="<?php echo isset($_GET['input_inform_subject']) ? $_GET['input_inform_subject'] : '';?>"></td>
					<th><label for="time_from"><?php echo $lang['inform_datetime'];?></label></th>
					<td><input id="time_from" class="txt date" type="text" name="input_inform_datetime_start" value="<?php echo isset($_GET['input_inform_datetime_start']) ? $_GET['input_inform_datetime_start'] : '';?>">
						<label for="time_to">~</label>
						<input id="time_to" class="txt date" type="text" name="input_inform_datetime_end" value="<?php echo isset($_GET['input_inform_datetime_end']) ? $_GET['input_inform_datetime_end'] : '';?>"></td>
	...
	<form method='post' id="list_form" action="index.php?act=voucher_price&op=voucher_price_drop">
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="line hover">
					<td><?php echo $v['inform_goods_name'];?></td>
