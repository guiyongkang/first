	...
	<form id="web_form" method="post" name="form1">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform" style=" height:48px;"><input type="hidden" value="<?php echo $output['web_array']['style_name']?>" name="style_name" id="style_name">
				...
				<tr>
					<td colspan="2" class="required"><label class="validation"><?php echo $lang['nc_sort'];?>:</label></td>
				</tr>
				<tr class="noborder">
