...
<div class="page">
			...
			<table class="tb-type1 noborder search left">
				<tbody>
					<tr>
						...
						<td> 会员名称
							<input type="text" name="membername" value="<?php echo isset($output['search_arr']['membername']) ? $output['search_arr']['membername'] : '';?>"/></td>
	...
	<div class="w100pre close_float" style="text-align:right;"> <a class="btns" href="javascript:void(0);" id="export_btn"><span>导出Excel</span></a> </div>
