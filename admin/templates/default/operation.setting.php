				...
				<td class="" colspan="2"><table class="table tb-type2 nomargin">
						...
						<tbody>
							...
							<tr class="hover" style="display:none;">
								<td>邀请注册</td>
								<td><input id="points_comments" name="points_invite" value="<?php echo $output['list_setting']['points_invite'];?>" class="txt" type="text" style="width:60px;">
									邀请非会员注册时给邀请人的积分数</td>
							</tr>
							<tr class="hover" style="display:none;">
								<td>返利比例</td>
								<td><input id="points_comments" name="points_rebate" value="<?php echo $output['list_setting']['points_rebate'];?>" class="txt" type="text" style="width:35px;">
									% &nbsp;&nbsp;&nbsp;被邀请会员购买商品时给邀请人返的积分数(例如设为5%，被邀请人购买100元商品，返给邀请人5积分)</td>
							</tr>
						</tbody>
					</table>
