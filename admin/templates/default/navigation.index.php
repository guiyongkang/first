			...
			<tbody>
				<tr>
					...
					<td><select name="search_nav_location">
							...
							<option value="0" <?php if(isset($output['search_nav_location']) && $output['search_nav_location'] == '0'){ ?>selected="selected"<?php } ?>><?php echo $lang['navigation_index_top'];?></option>
							<option value="1" <?php if(isset($output['search_nav_location']) && $output['search_nav_location'] == '1'){ ?>selected="selected"<?php } ?>><?php echo $lang['navigation_index_center'];?></option>
							<option value="2" <?php if(isset($output['search_nav_location']) && $output['search_nav_location'] == '2'){ ?>selected="selected"<?php } ?>><?php echo $lang['navigation_index_bottom'];?></option>
						</select></td>
					<td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
						<?php if(!empty($output['search_nav_title']) or !empty($output['search_nav_location'])){?>
