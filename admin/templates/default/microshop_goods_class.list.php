    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit <?php echo 'class_id'.$val['class_id'];?>" style="display:none;">
          ...
          <td class="name"><img src="<?php echo APP_TEMPLATES_URL;?>/images/tv-item1.gif"> <span nc_type="class_name" column_id="<?php echo $val1['class_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable "><?php echo $val1['class_name'];?></span></td>
          <td></td>
