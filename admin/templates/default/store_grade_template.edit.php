...
<div class="page">
	...
	<form method="post">
		...
		<ul style="margin: 5px; width: 100%;">
			...
			<li style="float: left; text-align: center; margin: 5px;"> <a target="_blank" href="<?php echo APP_URL;?>/templates/<?php echo TPL_SHOP_NAME;?>/store/style/<?php echo $v;?>/screenshot.jpg"><img width="160" height="120" src="<?php echo APP_URL;?>/templates/<?php echo TPL_SHOP_NAME;?>/store/style/<?php echo $v;?>/images/preview.jpg" style="border: 1px solid #ccc;"></a><br>
				<?php if ($v == 'default'){?>
