...
<table class="table tb-type2 order mtw">
	...
	<tbody>
		<tr id="close_complain">
			<td><form method='post' id="verify_form" action="index.php?act=complain&op=complain_verify">
	...
	<form method='post' id="close_form" action="index.php?act=complain&op=complain_close">
		...
		<tr class="complain_dialog">
			<td><p> 注：选中下表中订单商品可退款，可退款金额为0的商品不能进行操作。</p>
		...
		<tr class="complain_dialog">
			<td><a id="btn_handle_submit" class="btn" href="javascript:void(0)"><span><?php echo $lang['nc_submit'];?></span></a> <a id="btn_close_cancel" class="btn" href="javascript:void(0)"><span><?php echo $lang['nc_cancel'];?></span></a></td>
		</tr>
	</form>
		</tbody>
