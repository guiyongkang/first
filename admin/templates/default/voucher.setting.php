	...
	<form id="add_form" method="post" action="index.php?act=voucher&op=setting">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder" style="display:none;">
					<td class="vatop rowform"><input type="text" id="promotion_voucher_price" name="promotion_voucher_price" value="<?php echo $output['setting']['promotion_voucher_price'];?>" class="txt"></td>
				...
				<tr class="noborder" style="display:none;">
					<td class="vatop rowform"><input type="text" id="promotion_voucher_storetimes_limit" name="promotion_voucher_storetimes_limit" value="<?php echo $output['setting']['promotion_voucher_storetimes_limit'];?>" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_voucher_buyertimes_limit" name="promotion_voucher_buyertimes_limit" value="<?php echo $output['setting']['promotion_voucher_buyertimes_limit'];?>" class="txt"></td>
