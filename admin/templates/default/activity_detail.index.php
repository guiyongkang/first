		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" name="searchstore" id="searchstore" class="txt" value='<?php echo isset($_GET['searchstore']) ? $_GET['searchstore'] : '';?>'></td>
					<th><label for="searchtitle"><?php echo $lang['activity_detail_index_goods_name']; ?></label></th>
					<td><input type="text" name="searchgoods" id="searchgoods" class="txt" value='<?php echo isset($_GET['searchgoods']) ? $_GET['searchgoods'] : '';?>'></td>
					<td><select name="searchstate">
							<option value="0" <?php if (empty($_GET['searchstate'])){echo 'selected=selected';}?>><?php echo $lang['activity_detail_index_auditstate']; ?></option>
							<option value="1" <?php if (isset($_GET['searchstate']) && $_GET['searchstate'] == 1){echo 'selected=selected';}?>><?php echo $lang['activity_detail_index_to_audit']; ?></option>
							<option value="2" <?php if (isset($_GET['searchstate']) && $_GET['searchstate'] == 2){echo 'selected=selected';}?>><?php echo $lang['activity_detail_index_passed']; ?></option>
							<option value="3" <?php if (isset($_GET['searchstate']) && $_GET['searchstate'] == 3){echo 'selected=selected';}?>><?php echo $lang['activity_detail_index_unpassed']; ?></option>
						</select></td>
		...
		<table class="table tb-type2">
			...
			<tbody id="treet1">
				...
				<tr class="hover">
					...
					<td class="align-center"><?php switch($v['activity_detail_state']){
					...
					<td class="w150 align-center"><?php if($v['activity_detail_state']!='1'){?>
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td colspan="16" id="batchAction"><label for="checkall_1"><?php echo $lang['nc_select_all']; ?></label>
						&nbsp;&nbsp; <a href="JavaScript:void(0);" class="btn" onclick="javascript:submit_form('pass');"><span><?php echo $lang['activity_detail_index_pass'];?></span></a> <a href="JavaScript:void(0);" class="btn" onclick="javascript:submit_form('refuse');"><span><?php echo $lang['activity_detail_index_refuse'];?></span></a> <a href="JavaScript:void(0);" class="btn" onclick="javascript:submit_form('del');"><span><?php echo $lang['nc_del'];?></span></a>
