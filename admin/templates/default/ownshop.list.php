...
<div class="page">
			...
			<tbody>
				<tr>
					...
					<td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
						<?php if (!empty($output['store_name'])) { ?>
	...
	<table class="table tb-type2" id="prompt">
		<tbody>
			...
			<tr>
				<td><ul>
						<li>平台在此处统一管理店铺，可以新增、编辑、删除平台店铺</li>
						<li>可以设置未绑定全部商品类目的店铺的经营类目</li>
						<li>已经发布商品的店铺不能被删除</li>
						<li>删除平台店铺将会同时删除店铺的相关图片以及相关商家中心账户，请谨慎操作！</li>
					</ul></td>
			</tr>
		</tbody>
	</table>
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="">
					...
					<td class="align-center w200"><a href="index.php?act=ownshop&op=edit&id=<?php echo $v['store_id']; ?>">编辑</a>
