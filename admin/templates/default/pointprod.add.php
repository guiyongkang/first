	...
	<form id="pointprod_form" method="post" enctype="multipart/form-data" >
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="noborder">
					<th rowspan="6" class="picture"><div class="size-200x200"><span class="thumb size-200x200"><i></i><img src="<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['default_goods_image']; ?>" onload="javascript:DrawImage(this,200,200);" nc_type="goods_image" /></span></div>
					</th>
			...
			<tbody name="limittime_div">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="starttime" id="starttime" class="txt date" style="width:100px;" value="<?php echo @date('Y-m-d',time()); ?>"/>
			...
			<tbody>
				...
				<tr>
					<td colspan="3"><?php showEditor('pgoods_body',isset($output['goods']['goods_body']) ? $output['goods']['goods_body'] : '','600px','400px','visibility:hidden;','false',isset($output['editor_multimedia']) ? $output['editor_multimedia'] : '');?></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td colspan="3"><ul id="thumbnails" class="thumblists">
							<?php if(!empty($output['file_upload']) && is_array($output['file_upload'])){?>
