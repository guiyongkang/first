		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input class="txt" type="text" name="input_complain_accuser" id="input_complain_accuser" value="<?php echo isset($_GET['input_complain_accuser']) ? $_GET['input_complain_accuser'] : '';?>"></td>
					<th><label for="input_complain_subject_content"><?php echo $lang['complain_subject_content'];?></label></th>
					<td colspan="2"><input class="txt2" type="text" name="input_complain_subject_content" id="input_complain_subject_content" value="<?php echo isset($_GET['input_complain_subject_content']) ? $_GET['input_complain_subject_content'] : '';?>"></td>
				</tr>
				<tr>
					<th><label for="input_complain_accused"><?php echo $lang['complain_accused'];?></label></th>
					<td><input class="txt" type="text" name="input_complain_accused" id="input_complain_accused" value="<?php echo isset($_GET['input_complain_accused']) ? $_GET['input_complain_accused'] : '';?>"></td>
					<th><label for="time_from"><?php echo $lang['complain_datetime'];?></label></th>
					<td><input id="time_from" class="txt date" type="text" name="input_complain_datetime_start" value="<?php echo isset($_GET['input_complain_datetime_start']) ? $_GET['input_complain_datetime_start'] : '';?>">
						<label for="time_to">~</label>
						<input id="time_to" class="txt date" type="text" name="input_complain_datetime_end" value="<?php echo isset($_GET['input_complain_datetime_end']) ? $_GET['input_complain_datetime_end'] : '';?>"></td>
