	...
	<form id="user_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"  colspan="2"><span id="region" class="w400">
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="isbuy_1" class="cb-enable <?php if($output['member_array']['is_buy'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['member_edit_allow'];?></span></label>
				...
				<tr class="noborder" style="display:none;">
					<td class="vatop rowform onoff"><label for="allowtalk_1" class="cb-enable <?php if($output['member_array']['is_allowtalk'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['member_edit_allow'];?></span></label>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="memberstate_1" class="cb-enable <?php if($output['member_array']['member_state'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['member_edit_allow'];?></span></label>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="membermobilebind_1" class="cb-enable <?php if($output['member_array']['member_mobile_bind'] == '1'){ ?>selected<?php } ?>" ><span>已验证</span></label>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="memberemailbind_1" class="cb-enable <?php if($output['member_array']['member_email_bind'] == '1'){ ?>selected<?php } ?>" ><span>已验证</span></label>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php echo $lang['member_index_points']?>&nbsp;<strong class="red"><?php echo $output['member_array']['member_points']; ?></strong>&nbsp;<?php echo isset($lang['points_unit']) ? $lang['points_unit'] : ''; ?></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform">经验值&nbsp;<strong class="red"><?php echo $output['member_array']['member_exppoints']; ?></strong>&nbsp;<?php echo isset($lang['points_unit']) ? $lang['points_unit'] : ''; ?></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
