		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['store_domain']) ? $_GET['store_domain'] : '';?>" name="store_domain" id="store_domain" class="txt"></td>
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="w150 align-center"><a href="index.php?act=domain&op=store_domain_edit&store_id=<?php echo $v['store_id']?>"><?php echo $lang['nc_edit'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
