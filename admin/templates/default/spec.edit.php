	...
	<form id="spec_form" method="post" enctype="multipart/form-data">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform" id="gcategory"><input type="hidden" value="<?php echo $output['sp_list']['class_id'];?>" class="mls_id" name="class_id" />
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php if ($output['sp_list']['sp_id'] != 1) {?>
						<input type="text" class="txt" name="s_sort" id="s_sort" value="<?php echo $output['sp_list']['sp_sort'];?>" />
						<?php } else {echo $output['sp_list']['sp_sort'];}?></td>
