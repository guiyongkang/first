			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="site_status1" class="cb-enable <?php if($output['list_setting']['delivery_isuse'] == '1'){ ?>selected<?php } ?>" ><span>开启</span></label>
						...
						<input id="site_status0" name="delivery_isuse" <?php if($output['list_setting']['delivery_isuse'] == '0'){ ?>checked="checked"<?php } ?> value="<?php echo isset($output['dlyp_info']['dlyp_state']) ? $output['dlyp_info']['dlyp_state'] : '';?>" type="radio"></td>
