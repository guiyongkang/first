		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['xianshi_name']) ? $_GET['xianshi_name'] : '';?>" name="xianshi_name" id="xianshi_name" class="txt" style="width:100px;"></td>
		...
		<table class="table tb-type2">
			...
			<tbody id="treet1">
				...
				<tr class="hover">
					...
					<td class="align-left"><span><?php echo $val['store_name'];?></span>
						<?php if (isset($output['flippedOwnShopIds'][$val['store_id']])) { ?>
							<span class="ownshop" style="display:none;">[自营]</span>
							<?php } ?></td>
					...
					<td class="nowrap align-center"><a href="index.php?act=promotion_xianshi&op=xianshi_detail&xianshi_id=<?php echo $val['xianshi_id'];?>"><?php echo $lang['nc_detail'];?></a>
						<?php if($val['editable']) { ?>
						<a nctype="btn_cancel" data-xianshi-id="<?php echo $val['xianshi_id'];?>" href="javascript:;"><?php echo $lang['nc_cancel'];?></a>
						<?php } ?>
						<a nctype="btn_del" data-xianshi-id="<?php echo $val['xianshi_id'];?>" href="javascript:;"><?php echo $lang['nc_del'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
