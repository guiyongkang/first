...
<div class="page">
	...
	<form method="get" name="formSearch" id="formSearch">
		...
		<input type="hidden" name="op" value="dislists">
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
                    ...
                    <td class="w48 picture"><div class="size-44x44"><?php if($v['inviter_id']>0){?><span class="thumb size-44x44"><i></i><img src="<?php echo $v['inviter_avatar'];?>" width="44" /></span><?php }?></div></td>
					<td class="border-right"><?php if($v['inviter_id']==0){?>总店<?php }else{?><?php echo $v['inviter_name'];?><?php }?></td>
					...
					<td class="align-center"><a href="index.php?act=distributor_list&op=childlists&aid=<?php echo $v['member_id'];?>">下属</a></td>
				</tr>
