	...
	<form id="type_form" method="post">
		<table id="prompt" class="table tb-type2">
			<tbody>
				...
				<tr class="odd">
					<td><ul>
							<li style="display:none;"><?php echo $lang['type_add_prompts_one'];?></li>
							<li><?php echo $lang['type_add_prompts_two'];?></li>
							<li style="display:none;"><?php echo $lang['type_add_prompts_three'];?></li>
							<li style="display:none;"><?php echo $lang['type_add_prompts_four'];?></li>
						</ul></td>
				</tr>
			</tbody>
		</table>
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform" id="gcategory"><input type="hidden" value="<?php echo $output['type_info']['class_id'];?>" class="mls_id" name="class_id" />
				...
				<thead class="thead">
					<tr class="space">
						<th class="required" colspan="15"><label style=" float: left; margin-right: 10px;"><?php echo $lang['type_add_related_spec'].$lang['nc_colon'];?></label>
							...
							<?php echo $lang['nc_quickly_targeted'];?> </th>
					</tr>
					<tr>
							...
							<td colspan="15"><h6 class="clear" id="spec_h6_<?php echo $k;?>"><?php echo $val['name'];?></h6>
								...
								<ul class="nofloat">
									...
									<li class="left w33pre h36">
										...
										<?php echo (isset($v['sp_name']) ? $v['sp_name'] : '') . (isset($v['sp_value']) ? $v['sp_value'] : '');?> </li>
									<?php }?>
								</ul>
								<?php }?></td>
						</tr>
		...
		<table class="table tb-type2" style="display:none;">
			<thead class="thead">
				<tr class="space">
