	...
	<form id="pointprod_form" method="post" enctype="multipart/form-data" >
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="noborder">
					<th rowspan="6" class="picture"><div class="size-200x200"><span class="thumb size-200x200"><i></i><img src="<?php echo $output['prod_info']['pgoods_image'];?>" onerror="this.src='<?php echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.$output['setting_config']['default_goods_image'];?>'" onload="javascript:DrawImage(this,200,200);" nc_type="goods_image" /></span></div>
					</th>
			...
			<tbody>
				...
				<tr>
					<td colspan="10"><?php showEditor('pgoods_body',$output['prod_info']['pgoods_body'],'600px','400px','visibility:hidden;','false',isset($output['editor_multimedia']) ? $output['editor_multimedia'] : '');?></td>
				</tr>
				<tr>
