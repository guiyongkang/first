      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w48"><input type="checkbox" name="check_area_id[]" value="<?php echo $v['area_id'];?>" class="checkitem">
            ...
            <img fieldid="<?php echo $v['area_id'];?>" status="open" nc_type="flex" src="<?php echo APP_TEMPLATES_URL;?>/images/tv-expandable.gif">
            <?php }else{ ?>
            <img fieldid="<?php echo $v['area_id'];?>" status="close" nc_type="flex" src="<?php echo APP_TEMPLATES_URL;?>/images/tv-item.gif">
            <?php } ?>
		  </td>
          <td class="w48 sort">
