        ...
        <table class="table tb-type2">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act=home&member_id='.$value['comment_member_id'];?>" target="_blank">
                            <?php echo $value['member_name'];?>
                        </a>
                    </td>
                    <td><?php echo $output['channel_array'][$value['comment_type']]['name'];?></td>
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act='.$output['channel_array'][$value['comment_type']]['key'].'&op=detail&'.$output['channel_array'][$value['comment_type']]['key'].'_id='.$value['comment_object_id'];?>" target="_blank">
