		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['store_name']) ? $_GET['store_name'] : '';?>" name="store_name" id="store_name" class="txt"></td>
					<th><label><?php echo $lang['store_name'];?>ID</label></th>
					<td><input type="text" value="<?php echo isset($_GET['store_id']) ? $_GET['store_id'] : '';?>" name="store_id" id="store_id" class="txt"></td>
					<th>申请状态</th>
					<td><select name="re_state">
							<option value=""><?php echo $lang['nc_please_choose'];?>...</option>
							<option <?php if (isset($_GET['re_state']) && $_GET['re_state'] == '0') echo 'selected';?> value="0">待付款</option>
							<option <?php if (isset($_GET['re_state']) && $_GET['re_state'] == '1') echo 'selected';?> value="1">待审核</option>
							<option <?php if (isset($_GET['re_state']) && $_GET['re_state'] == '2') echo 'selected';?> value="2">已审核</option>
						</select></td>
	...
	<form method="post" id="store_form" name="store_form">
		...
		<table class="table tb-type2">
			...
			<tfoot>
				<tr class="tfoot">
					<td></td>
					<td colspan="15"><?php if(!empty($output['reopen_list']) && is_array($output['reopen_list'])){ ?>
