		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover">
					...
					<td class="w96 align-center"><a href="index.php?act=voucher&op=priceedit&priceid=<?php echo $v['voucher_price_id'];?>"><?php echo $lang['nc_edit'];?></a> <a href="JavaScript:void(0);" onclick="submit_delete('<?php echo $v['voucher_price_id'];?>')"><?php echo $lang['nc_del'];?></a></td>
					<?php } ?>
					<?php }else { ?>
				<tr class="no_data">
