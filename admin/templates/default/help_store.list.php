			...
			<tbody>
				<tr>
					...
					<td><select name="type_id" id="type_id">
							...
							<option <?php if($val['type_id'] == (isset($_GET['type_id']) ? $_GET['type_id'] : 0)){?>selected<?php }?> value="<?php echo $val['type_id'];?>"><?php echo $val['type_name'];?></option>
							<?php } ?>
							<?php } ?>
						</select></td>
	...
	<table class="table tb-type2 nobdb">
		...
		<tbody>
			...
			<tr class="hover">
				...
				<td class="w150 align-center"><a href="index.php?act=help_store&op=edit_help&help_id=<?php echo $val['help_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>')) window.location = 'index.php?act=help_store&op=del_help&help_id=<?php echo $val['help_id'];?>';"><?php echo $lang['nc_del'];?></a></td>
			</tr>
			<?php } ?>
			<?php }else { ?>
			<tr class="no_data">
