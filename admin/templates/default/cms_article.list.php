    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w60 align-center yes-onoff"><a href="JavaScript:void(0);" class=" <?php echo $val['article_commend_flag']? 'enabled':'disabled'?>" ajax_branch='article_commend'  nc_type="inline_edit" fieldname="article_commend_flag" fieldid="<?php echo $val['article_id']?>" fieldvalue="<?php echo $val['article_commend_flag']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="w60 align-center yes-onoff"><a href="JavaScript:void(0);" class=" <?php echo $val['article_commend_image_flag']? 'enabled':'disabled'?>" ajax_branch='article_commend_image'  nc_type="inline_edit" fieldname="article_commend_image_flag" fieldid="<?php echo $val['article_id']?>" fieldvalue="<?php echo $val['article_commend_image_flag']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="w60 align-center yes-onoff"><a href="JavaScript:void(0);" class=" <?php echo $val['article_comment_flag']? 'enabled':'disabled'?>" ajax_branch='article_comment'  nc_type="inline_edit" fieldname="article_comment_flag" fieldid="<?php echo $val['article_id']?>" fieldvalue="<?php echo $val['article_comment_flag']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="w60 align-center yes-onoff"><a href="JavaScript:void(0);" class=" <?php echo $val['article_attitude_flag']? 'enabled':'disabled'?>" ajax_branch='article_attitude'  nc_type="inline_edit" fieldname="article_attitude_flag" fieldid="<?php echo $val['article_id']?>" fieldvalue="<?php echo $val['article_attitude_flag']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a></td>
          <td class="w60 align-center"><?php echo $output['article_state_list'][$val['article_state']]['text'];?></td>
          <td class="w108 align-center">
              <a href="<?php echo APP_URL.'/index.php?act=article&op=article_detail&article_id='.$val['article_id'];?>" target="_blank"><?php echo $lang['cms_text_see'];?></a>
