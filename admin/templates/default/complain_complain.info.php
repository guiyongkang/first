	...
	<tbody>
		...
		<tr class="noborder">
			<td><table class="table tb-type2 goods ">
					...
					<tr>
						<td width="65" align="center" valign="middle"><a style="text-decoration:none;" href="javascript:;"> <img width="50" src="<?php echo cthumb($complain_goods['goods_image'], 60,$output['order_info']['store_id']);?>" /> </a></td>
						<td class="intro"><p><a href="javascript:;"><?php echo $complain_goods['goods_name'];?> </a></p>
	...
	<tbody>
		...
		<tr class="noborder">
			<td><table class="table tb-type2 goods ">
					...
					<tr>
						<td width="65" align="center" valign="middle"><a style="text-decoration:none;" href="javascript:;"> <img width="50" src="<?php echo thumb($val,60);?>" /> </a></td>
						<td class="intro"><p><a href="javascript:;"><?php echo $val['goods_name'];?> </a></p>
