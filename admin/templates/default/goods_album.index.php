			...
			<tbody>
				<tr>
					...
					<td><a href="javascript:document.formSearch.submit();" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
						...
						<a class="btns" href="javascript:;"><span><?php echo $output['store_name'];?></span></a>
						<?php }?></td>
				</tr>
			</tbody>
		</table>
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td><?php if($v['aclass_cover'] != ''){ ?>
						<img src="<?php echo cthumb($v['aclass_cover'], 60, $v['store_id']);?>" onload="javascript:DrawImage(this,70,70);">
						<?php }else{?>
						<img src="<?php echo APP_URL.'/templates/'.TPL_NAME.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,70,70);">
						<?php }?></td>
					<td class="name"><?php echo $v['aclass_name'];?></td>
					<td class="class"><a href="javascript:;" ><?php echo $v['store_name'];?></td>
					<td><?php echo isset($output['pic_count'][$v['aclass_id']]) ? $output['pic_count'][$v['aclass_id']] : 0;?></td>
					<td class="align-center"><a href="index.php?act=goods_album&op=pic_list&aclass_id=<?php echo $v['aclass_id'];?>"><?php echo $lang['g_album_pic_one'];?></a>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=goods_album&op=aclass_del&aclass_id=<?php echo $v['aclass_id'];?>';}else{return false;}"><?php echo $lang['nc_del'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
