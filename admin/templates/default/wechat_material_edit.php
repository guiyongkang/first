...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['material_edit'];?></h3>
    </div>
  </div>
  	...
  	<div id="material">
        <div class="m_lefter multi">
          ...
          <div class="<?php echo $key==0 ? 'first' : 'list';?>" id="multi_msg_<?php echo $key;?>">
            ...
            <div class="control"><a href="#mod"><img src="/admin/resource/weixin/mod.gif" /></a></div>
          ...
          <div class="list" style="display:none">
            ...
            <div class="control"> <a href="#mod"><img src="/admin/resource/weixin/mod.gif" /></a> <a href="#del"><img src="/admin/resource/weixin/del.gif" /></a> </div>
          ...
          <?php }?>
          <div class="add"><a href="#add"><img src="/admin/resource/weixin/add.gif" align="absmiddle" /> <?php echo $lang['material_item_add'];?></a></div>
        </div>
        <div class="m_righter">
          <div class="mod_form">
            <div class="jt"><img src="/admin/resource/weixin/jt.gif" /></div>
            <div class="m_form"> <span class="fc_red">*</span> <?php echo $lang['material_item_title'];?><br />
              ...
              <div class="control_upload">
                <span class="type-file-show" style="margin-right:40px;">
                	<img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png">
                    <div class="type-file-preview" style="display: none;"><img id="view_img"<?php echo !empty($output['material']['items']) ? ' src="'.UPLOAD_SITE_URL.$output['material']['items'][0]['ImgPath'].'"' : ''; ?>></div>
                </span>
                ...
                <input type="file" id="_pic" name="_pic" class="type-file-file" size="30" hidefocus="true" />
                </span>
...
$(function(){
	...
	function ajaxFileUpload(){
		...
		(
			{
				url:'index.php?act=common&op=pic_upload&form_submit=ok&uploadpath=weixin/material',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
