...
<div class="page">
	...
	<form method="get" name="formSearch">
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th><label for="searchtitle"><?php echo isset($lang['activity_index_title']) ? $lang['activity_index_title'] : ''; ?></label></th>
					<td><input type="text" name="searchtitle" id="searchtitle" class="txt" value='<?php echo isset($_GET['searchtitle']) ? $_GET['searchtitle'] : '';?>'></td>
					<td><select name="searchstate">
							<option value="0" <?php if (empty($_GET['searchstate'])){echo 'selected=selected';}?>><?php echo $lang['activity_openstate']; ?></option>
							<option value="2" <?php if (isset($_GET['searchstate']) && $_GET['searchstate'] == 2){echo 'selected=selected';}?>><?php echo $lang['activity_openstate_open']; ?></option>
							<option value="1" <?php if (isset($_GET['searchstate']) && $_GET['searchstate'] == 1){echo 'selected=selected';}?>><?php echo $lang['activity_openstate_close']; ?></option>
						</select></td>
					<th colspan="1"><label for="searchstartdate"><?php echo $lang['activity_index_periodofvalidity']; ?></label></th>
					<td><input type="text" name="searchstartdate" id="searchstartdate" class="txt date" readonly='' value='<?php echo isset($_GET['searchstartdate']) ? $_GET['searchstartdate'] : '';?>'>
						~
						<input type="text" name="searchenddate" id="searchenddate" class="txt date" readonly='' value='<?php echo isset($_GET['searchenddate']) ? $_GET['searchenddate'] : '';?>'></td>
		...
		<table class="table tb-type2">
          ...
          <td class="nowarp align-center"><?php
				...
				?></td> -->
					...
					<td class="align-center"><a href="index.php?act=activity&op=edit&activity_id=<?php echo $v['activity_id'];?>"><?php echo $lang['nc_edit'];?></a>&nbsp;|&nbsp;
						...
						<?php }?>
						<a href="index.php?act=activity&op=detail&id=<?php echo $v['activity_id'];?>"><?php echo $lang['activity_index_deal_apply'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
