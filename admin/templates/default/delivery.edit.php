	...
	<form id="delivery_form" method="post" action="<?php echo urlAdmin('delivery', 'save_edit');?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="dmobile" value="<?php echo $output['dlyp_info']['dlyp_mobile'];?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="dtelephony" value="<?php echo $output['dlyp_info']['dlyp_telephony'];?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="daddressname" value="<?php echo $output['dlyp_info']['dlyp_address_name'];?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input class="txt" type="text" name="daddress" value="<?php echo $output['dlyp_info']['dlyp_address'];?>"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder" style="display: none;" nctype="fail_reason">
					<td class="vatop rowform" nctype="fail_reason"><textarea id="fail_reason" class="tarea" rows="6" name="fail_reason"></textarea></td>
				</tr>
				<?php }?>
			</tbody>
			<tfoot>
