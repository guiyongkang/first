...
<div class="page">
	...
	<table class="table tb-type2 nobdb">
		...
		<tbody>
			...
			<tr class="hover">
				<td><?php echo substr($order['os_month'],0,4).'-'.substr($order['os_month'],4);?></td>
				...
				<td class="align-center"><a href="index.php?act=bill&op=show_month&month=<?php echo $order['os_month'];?>"><?php echo $lang['nc_view'];?></a></td>
			</tr>
			<?php }?>
			<?php }else{?>
			<tr class="no_data">
