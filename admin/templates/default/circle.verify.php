      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center yes-onoff">
            <a href="JavaScript:void(0);" class=" disabled" fieldvalue="0" fieldid="<?php echo $v['circle_id'];?>" ajax_branch="status" fieldname="circle_status" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
          </td>
