      ...
      <tbody>
        ...
        <tr class="hover edit member">
          ...
          <td class="align-center yes-onoff">
            <a href="JavaScript:void(0);" class="<?php echo $val['is_recommend']? 'enabled':'disabled'?>" ajax_branch='recommend' nc_type="inline_edit" fieldname="is_recommend" fieldid="<?php echo $val['member_id'].'|'.$val['circle_id'];?>" fieldvalue="<?php echo $val['is_recommend'];?>" title="<?php echo $val['is_recommend'] ? L('nc_yes') : L('nc_no');?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
          </td>
          <td class="w72"><a href="javascript:void(0);" onclick="delmember('<?php echo $val['member_id']?>|<?php echo $val['circle_id'];?>')"><?php echo $lang['nc_del'];?></a> | <a href="<?php echo APP_URL;?>/index.php?act=sns_circle&mid=<?php echo $val['member_id'];?>" target="_blank"><?php echo $lang['nc_view'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
