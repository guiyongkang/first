...
<div class="page">
	...
	<form id="add_form" method="post" action="index.php?act=groupbuy&op=class_save">
		<input name="class_id" type="hidden" value="<?php echo isset($output['class_info']['class_id']) ? $output['class_info']['class_id'] : 0;?>" />
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo isset($output['class_info']['class_name']) ? $output['class_info']['class_name'] : '';?>" name="input_class_name" id="input_class_name" class="txt"></td>
				</tr>
				<tr>
