...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		...
		<div class="w100pre" style="width: 100%;">
			<table class="tb-type1 noborder search left">
				<tbody>
					<tr>
						<td><input type="hidden" name="stat_type" id="stat_type" value="ordernum" />
							<input type="hidden" name="exporttype" id="exporttype" value="" /></td>
						...
						<td>店铺名称
							<input class="txt-long" type="text" name="store_name" id="store_name" value="<?php echo isset($_GET['store_name']) ? $_GET['store_name'] : '';?>" /></td>
	...
	<div class="stat-info"> <span>总销售额：<strong><?php echo ($t = $output['statcount_arr']['orderamount'])?$t:'0.00'; ?></strong>元</span><span>总订单量：<strong><?php echo intval($output['statcount_arr']['ordernum']); ?></strong></span> </div>
