	...
	<table class="tb-type1 noborder search">
		<tbody>
			<tr>
				...
				<td><a href="javascript:void(0);" id="ncsubmit" class="btn-search " title="<?php echo $lang['nc_query'];?>">&nbsp;</a></a> <a class="btns" href="index.php?<?php echo $_SERVER['QUERY_STRING'];?>&op=export_refund_order"><span><?php echo $lang['nc_exposrt'];?>导出退单明细</span></a></td>
			</tr>
		</tbody>
	</table>
</form>
<table class="table tb-type2 nobdb">
	...
	<tbody>
		...
		<tr class="hover">
			...
			<td class="align-center"><?php echo $refund_info['buyer_name'];?>
				</rd>
			<td><?php if ($refund_info['refund_type'] == 1) {?>
				<a href="index.php?act=refund&op=view&refund_id=<?php echo $refund_info['refund_id'];?>"><?php echo $lang['nc_view'];?></a>
				<?php } else {?>
				<a href="index.php?act=returned&op=view&return_id=<?php echo $refund_info['refund_id'];?>"><?php echo $lang['nc_view'];?></a>
				<?php } ?></td>
		</tr>
		<?php }?>
		<?php }else{?>
