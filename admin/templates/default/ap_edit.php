...
<div class="page">
	...
	<form id="link_form" enctype="multipart/form-data" method="post" name="form1">
		...
		<table class="table tb-type2 nobdb">
				 ...
				 switch ($v['ap_class']){
				 	case '0':
						...
						"<tbody id='adv_pic'>
							...
							<tr class='noborder'>
								<td class='vatop rowform'><span class='type-file-show'><img class='show_image' src='".APP_TEMPLATES_URL."/images/preview.png'>
				 	...
				 	case '3':
						...
						"<tbody >
							...
							<tr class='noborder'>
								<td class='vatop rowform'>
								<span class='type-file-show'><img class='show_image' src='".APP_TEMPLATES_URL."/images/preview.png'>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="15"><a href="JavaScript:void(0);" class="btn" id="submitBtn" onclick="document.form1.submit()"><span><?php echo $lang['adv_change'];?></span></a></td>
				</tr>
			</tfoot>
		</table>
	</form>
