...
<div class="page">
	...
	<form method='post' id="form_goods" action="index.php?act=distributor&op=delgoods">
		...
		<table class="table tb-type2">
			<thead>
				<tr class="thead">
                    ...
                    <th class="w108 align-center">是否设置佣金</th>
			...
			<tbody>
				...
				<tr class="hover edit">
                    ...
                    <td class="align-center"><?php echo empty($output['dis_good'][$v['goods_commonid']]) ? '<span style="background:#D9534F; color:#FFF; padding:2px 30px; border-radius:5px;">未设置</span>' : '<span style="background:#5CB85C; color:#FFF; padding:5px 30px; border-radius:5px;">已设置</span>';?></td>
					<td class="align-center"><a href="index.php?act=distributor&op=editgoods&gid=<?php echo $v['goods_commonid'];?>">设置</a>&nbsp;|&nbsp;<a href="index.php?act=distributor&op=delgoods&gid=<?php echo $v['goods_commonid'];?>">删除</a></td>
				</tr>
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" nctype="delete_batch"><span>删除</span></a>
...
$(function(){
    ...
    // 违规下架批量处理
    $('a[nctype="delete_batch"]').click(function(){
       	$('#form_goods').submit();
    });
