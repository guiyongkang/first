	...
	<form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=promotion_xianshi&op=xianshi_setting_save">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_xianshi_price" name="promotion_xianshi_price" value="<?php echo $output['setting']['promotion_xianshi_price'];?>" class="txt"></td>
