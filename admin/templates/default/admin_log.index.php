		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input class="txt" name="admin_name" value="<?php echo isset($_GET['admin_name']) ? $_GET['admin_name'] : '';?>" type="text"></td>
					<th><?php echo $lang['admin_log_dotime'];?></th>
					<td><input class="txt date" type="text" value="<?php echo isset($_GET['time_from']) ? $_GET['time_from'] : '';?>" id="time_from" name="time_from">
						<label for="time_to">~</label>
						<input class="txt date" type="text" value="<?php echo isset($_GET['time_to']) ? $_GET['time_to'] : '';?>" id="time_to" name="time_to"/></td>
	...
	<form method="post" id='form_list' action="index.php?act=admin_log&op=list_del">
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover">
					<td class="w24"><input name="del_id[]" type="checkbox" class="checkitem" value="<?php echo $v['id']; ?>"></td>
			...
			<tfoot>
				...
				<tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						&nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_list').submit();}"><span><?php echo $lang['nc_del'];?></span></a> <?php echo $lang['nc_del'];?>
						...
						<?php echo $lang['nc_record'];?> <a class="btn" href="javascript:void(0);" id="ncdelete"><span><?php echo $lang['nc_del'];?></span></a>
