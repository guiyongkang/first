	...
	<form id="goods_class_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" name="name" id="name" maxlength="20" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" name="url" id="url" maxlength="200" class="txt"></td>
					<td class="vatop tips"></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="" name="bg_color" id="bg_color" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="0" name="sort" id="sort" class="txt"></td>
				...
				<tr class="noborder" style="background: rgb(255, 255, 255) none repeat scroll 0% 0%;">
					<td class="vatop rowform onoff"><label for="state1" class="cb-enable selected"><span>开启</span></label>
						<label for="state0" class="cb-disable "><span>关闭</span></label>
						<input id="state1" name="state" checked="checked" value="1" type="radio">
						<input id="state0" name="state" value="0" type="radio">
					</td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
