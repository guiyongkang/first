			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><span class="type-file-show"> <img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png" />
						<div class="type-file-preview"><img src="<?php if(is_file(BASE_UPLOAD_PATH.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_banner'])){echo UPLOAD_SITE_URL."/".ATTACH_ACTIVITY."/".$output['activity']['activity_banner'];}else{echo APP_URL."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,500,500);"></div>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="activity_state1" class="cb-enable <?php echo $output['activity']['activity_state'] == 1?'selected':'';?>" ><span><?php echo $lang['activity_openstate_open'];?></span></label>
