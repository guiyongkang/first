...
background: #EFFAFE url(<?php echo APP_TEMPLATES_URL;
...
<div class="index_block goods-list">
	...
	<div class="title">
		<?php if($item_edit_flag) { ?>
		<h5>标题：</h5>
		<input id="home1_title" type="text" class="txt w200" name="item_data[title]" value="<?=isset($item_data['title']) ? $item_data['title'] : '';?>">
		<?php } else { ?>
		<span><?=isset($item_data['title']) ? $item_data['title'] : '';?></span>
		<?php } ?>
	</div>
