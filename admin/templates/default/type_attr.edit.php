			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="attr_show1" class="cb-enable <?php if($output['attr_info']['attr_show'] == '1'){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
						...
						<input id="attr_show0" name="attr_show" <?php if($output['attr_info']['attr_show'] == '0'){?>checked="checked"<?php }?> value="0" type="radio" /></td>
				</tr>
			</tbody>
		</table>
		<table class="table tb-type2 ">
			<thead class="thead">
				<tr class="space">
					<th colspan="15"><?php echo isset($lang['spec_add_spec_add']) ? $lang['spec_add_spec_add'] : '';?></th>
				</tr>
				<tr class="noborder">
