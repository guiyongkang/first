...
<link href="<?php echo APP_URL.DS;?>templates/cms_special.css" rel="stylesheet" type="text/css"/>
<style type="text/css">
.dialog_content {
	overflow: hidden;
...
<div class="page">
  ...
  <div id="dialog_module_tag_edit" style="display:none;">
    ...
    <ul class="article-tag-list">
      ...
      <li nctype="btn_tag_select" data-tag-id="<?php echo $value['tag_id'];?>"><a href="<?php echo APP_URL;?>/index.php?act=article&op=article_tag_search&tag_id=<?php echo $value['tag_id'];?>" ><?php echo $value['tag_name'];?></a><i></i></li>
      <?php } ?>
      <?php } ?>
    </ul>
