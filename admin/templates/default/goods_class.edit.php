			...
			<tbody>
				...
				<tr class="noborder" style="display:none;">
					<td class="vatop rowform">
					    <span class="type-file-show"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png">
						<div class="type-file-preview"><img src="<?php echo isset($output['class_array']['pic']) ? $output['class_array']['pic'] : APP_TEMPLATES_URL . '/images/preview.png';?>"></div>
						</span>
				...
				<tr class="noborder">
					<td class="vatop rowform"><label>
							<input type="checkbox" name="gc_virtual" id="gc_virtual" value="1" <?php if ($output['class_array']['gc_virtual'] == 1) {?>checked<?php }?>>
							允许</label></td>
