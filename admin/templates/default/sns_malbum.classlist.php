		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['class_name']) ? $_GET['class_name'] : '';?>" name="class_name" id="class_name" class="txt"></td>
					<th><label for="user_name"><?php echo $lang['snsalbum_member_name'];?></label></th>
					<td><input type="text" value="<?php echo isset($_GET['user_name']) ? $_GET['user_name'] : '';?>" name="user_name" id="user_name" class="txt"></td>
	...
	<form method='post' id="form_goods">
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					<td></td>
					<td class="w60 picture"><div class="size-44x44"><span class="thumb size-44x44"><i></i><img src="<?php if($v['ac_cover'] != ''){echo UPLOAD_SITE_URL.DS.ATTACH_MALBUM.DS.$v['member_id'].DS.$v['ac_cover'];}else{echo APP_URL.'/templates/'.TPL_NAME.'/images/member/default_image.png';}?>" onerror="this.src='<?php echo APP_URL.'/templates/'.TPL_NAME.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,44,44);"/></span></div></td>
			...
			<tfoot>
				<tr class="tfoot">
					<td colspan="16"><div class="pagination"><?php echo $output['showpage'];?> </div></td>
				</tr>
			</tfoot>
		</table>
	</form>
