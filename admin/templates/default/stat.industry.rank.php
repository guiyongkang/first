...
<div class="page">
	...
	<table class="table tb-type2">
		...
		<tbody>
			<tr>
				<td><div id="container_goods" class="w100pre close_float" style="height:400px"></div></td>
			</tr>
		</tbody>
	</table>
	<table class="table tb-type2 nobdb">
		...
		<tbody id="datatable">
			...
			<tr class="hover">
				...
				<td class="alignleft"><?php echo $v['goods_name'];?></td>
	...
	<table class="table tb-type2">
		...
		<tbody>
			<tr>
				<td><div id="container_store" class="w100pre close_float" style="height:400px"></div></td>
			</tr>
		</tbody>
	</table>
	<table class="table tb-type2 nobdb">
