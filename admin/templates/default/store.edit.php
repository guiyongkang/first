		...
		<form id="store_form" method="post">
			...
			<table class="table tb-type2">
				...
				<tbody>
					...
					<tr style="display:none;">
						<td width="70%"><div class="onoff" style="float:left;margin-right:10px;">
							...
							<div class="onoff" style="float:left;margin-right:10px;">
								...
								<!--保证金--> 
								&nbsp;
								<input type="text" value="<?php echo $output['store_array']['store_baozhrmb'];?>" id="store_tq" name="store_baozhrmb" class="txt"  style="width: 50px;color:red;font-weight:900;">
								元 </div></td>
					</tr>
					<tr style="display:none;">
					...
					<tr style="display:none;">
						<td><div class="onoff" style="float:left;margin-right:10px;">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
				...
				<tbody>
					...
					<tr>
						...
						<th>员工总数：</th>
						<td><input type="text" class="txt w72" name="company_employee_count" value="<?php echo $output['joinin_detail']['company_employee_count'];?>">
							&nbsp;人</td>
						<th>注册资金：</th>
						<td><input type="text" class="txt w72" name="company_registered_capital" value="<?php echo $output['joinin_detail']['company_registered_capital'];?>">
							&nbsp;万元 </td>
					</tr>
					<tr>
						<th>联系人姓名：</th>
			...
			<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
				...
				<tbody>
					<tr>
						...
						<td><input type="text" class="txt" name="business_licence_number" value="<?php echo $output['joinin_detail']['business_licence_number'];?>"></td>
					</tr>
					<tr>
						<th>营业执照所在地：</th>
					...
					<tr>
						<th>营业执照有效期：</th>
						<td><input type="text" class="txt" name="business_licence_start" id="business_licence_start" value="<?php echo $output['joinin_detail']['business_licence_start'];?>">
							-
							<input type="text" class="txt" name="business_licence_end" id="business_licence_end" value="<?php echo $output['joinin_detail']['business_licence_end'];?>"></td>
					</tr>
					<tr>
						<th>法定经营范围：</th>
					...
					<tr>
						<th>营业执照<br />
							电子版：</th>
						<td colspan="20"><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['business_licence_number_electronic']);?>" alt="" /> </a>
							<input class="w200" type="file" name="business_licence_number_electronic"></td>
					</tr>
				</tbody>
			</table>
			<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
			...
			<table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
				...
				<tbody>
					...
					<tr>
						<th>税务登记证号<br />
							电子版：</th>
						<td><a nctype="nyroModal"  href="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certificate_electronic']);?>"> <img src="<?php echo getStoreJoininImageUrl($output['joinin_detail']['tax_registration_certificate_electronic']);?>" alt="" /> </a>
							<input type="file" name="tax_registration_certificate_electronic"></td>
					</tr>
				</tbody>
			</table>
