...
<div class="page">
	...
	<form id="add_form" method="post" action="index.php?act=voucher&op=<?php echo $output['menu_key']; ?>">
		...
		<input type="hidden" name="priceid" value="<?php echo isset($output['info']['voucher_price_id']) ? $output['info']['voucher_price_id'] : 0;?>"/>
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="voucher_price" name="voucher_price" class="txt" value="<?php echo isset($output['info']['voucher_price']) ? $output['info']['voucher_price'] : 0;?>"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea name="voucher_price_describe" rows="6" class="tarea" id="voucher_price_describe"><?php echo isset($output['info']['voucher_price_describe']) ? $output['info']['voucher_price_describe'] : '';?></textarea></td>
					<td class="vatop tips"></td>
				</tr>
				<tr class="noborder">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="voucher_points" name="voucher_points" class="txt" value="<?php echo isset($output['info']['voucher_defaultpoints']) && $output['info']['voucher_defaultpoints'] >0?$output['info']['voucher_defaultpoints']:0;?>"></td>
