...
<div class="page">
	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		...
		<div class="w100pre" style="width: 100%;">
			<table class="tb-type1 noborder search left">
				<tbody>
					<tr>
						<td colspan='7'><select name="search_type" id="search_type" class="querySelect">
							...
							</span> <span id="searchtype_week" style="display:none;">
							...
							</span> <span id="searchtype_month" style="display:none;">
					...
					<tr>
						<td>商品名称
							<input class="txt-long" type="text" name="goods_name" value="<?php echo isset($_GET['goods_name']) ? $_GET['goods_name'] : '';?>" /></td>
						<td>店铺名称
							<input class="txt-long" type="text" name="store_name" value="<?php echo isset($_GET['store_name']) ? $_GET['store_name'] : '';?>" /></td>
						<td>分类</td>
						...
						<td><div id="ajax_brand" class="ncsc-brand-select">
								<div class="selection">
									<input name="b_name" id="b_name" value="<?php echo isset($_REQUEST['b_name']) ? $_REQUEST['b_name'] : '';?>" type="text" class="text w180" readonly="readonly" />
									<input type="hidden" name="b_id" id="b_id" value="<?php echo isset($_REQUEST['b_id']) ? $_REQUEST['b_id'] : 0;?>" />
								</div>
	...
	<table class="table tb-type2 nobdb">
		...
		<tbody id="datatable">
			...
			<tr class="hover">
				<td class="align-left"><?php echo $v['goods_name']; ?></td>
