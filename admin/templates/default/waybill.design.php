...
<link
	href="<?php echo APP_TEMPLATES_URL;?>/css/font/font-awesome/css/font-awesome.min.css"
	rel="stylesheet" />
<!--[if IE 7]>
  <link rel="stylesheet" href="<?php echo APP_TEMPLATES_URL;?>/css/font/font-awesome/css/font-awesome-ie7.min.css">
<![endif]-->
<style>
#dialog_item_edit .dialog_content{
	padding:10px;
}
#dialog_item_edit .dialog_content dl{
	overflow:hidden;
	margin:5px 0;
}
#dialog_item_edit .dialog_content dl dt{
	float:left;
}
#dialog_item_edit .dialog_content dl dd{
	float:left;
}
.waybill-item-list {
}
.waybill-item-list li {
	width: 20%;
	margin: 0 0 10px 0;
}
.waybill-item-list .check, .waybill-item-list .label, .waybill-item-list i {
...
<div class="page"> 
	...
	<table class="table tb-type2">
		<tbody>
			...
			<tr class="noborder">
				<td class="vatop rowform"><form id="design_form"
						action="<?php echo urlAdmin('waybill', 'waybill_design_save');?>"
						method="post">
						...
						<ul id="waybill_item_list" class="waybill-item-list">
							...
							<li>
								<input id="check_<?php echo $key;?>" class="check"
								...
								<i nctype="btn_item_edit" data-item-name="<?php echo $key;?>"
								title="微调" class="icon-edit"></i>
								<input
			...
			<tr class="noborder">
				<td><div class="waybill_area">
						<div class="waybill_back"> <img
								src="<?php echo $output['waybill_info']['waybill_image_url'];?>"
								alt=""> </div>
						<div class="waybill_design">
							...
							<?php if(isset($waybill_data['check'])) { ?>
...
<div id="dialog_item_edit" style="display: none;">
	...
	<a id="btn_dialog_submit" href="javascript:;">确认</a> <a
		id="btn_dialog_cancel" href="javascript:;">取消</a> </div>
