...
<link href="<?php echo APP_TEMPLATES_URL;?>/css/skin_1.css" rel="stylesheet" type="text/css" id="cssfile"/>
...
$(function(){
    var $li =$("#skin li");
		...
		$("#cssfile").attr("href","<?php echo APP_TEMPLATES_URL;?>/css/"+ (this.id) +".css");
        $.cookie( "MyCssSkin" ,  this.id , { path: '/', expires: 10 });

        $('iframe').contents().find('#cssfile2').attr("href","<?php echo APP_TEMPLATES_URL;?>/css/"+ (this.id) +".css");
    });

    var cookie_skin = $.cookie( "MyCssSkin");
    if (cookie_skin) {
		$("#"+cookie_skin).addClass("selected").siblings().removeClass("selected");
		$("#cssfile").attr("href","<?php echo APP_TEMPLATES_URL;?>/css/"+ cookie_skin +".css");
...
<table style="width: 100%;" id="frametable" height="100%" width="100%" cellpadding="0" cellspacing="0">
	<tbody>
			...
			<td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
					...
					<div class="toolbar">
						<ul id="skin" class="skin">
							<span><?php echo $lang['nc_skin_peeler'];?></span>
						...
						<div class="toolmenu"><span class="bar-btn"></span>
							<ul class="bar-list">
								...
								<li><a href="<?php echo APP_URL;?>" id="iframe_refresh"><?php echo $lang['nc_refresh'];?><?php echo $lang['nc_admincp']; ?></a></li>
								<li><a href="<?php echo APP_URL;?>" title="<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title'];?>" rel="sidebar" onclick="addFavorite('<?php echo APP_URL;?>', '<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title'];?>');return false;"><?php echo $lang['nc_favorite']; ?><?php echo $lang['nc_admincp']; ?></a></li>
							</ul>
						</div>
					</div>
				</div>
		...
		<tr>
			<td class="menutd" valign="top" width="161"><div id="mainMenu" class="main-menu"> <?php echo $output['left_nav'];?> </div>
