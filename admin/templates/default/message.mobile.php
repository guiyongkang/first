	...
	<form method="post" id="form_email" name="settingForm">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php if($output['list_setting']['mobile_host_type']==1){ ?>
						<label>
							<input type="radio" name="mobile_host_type" value="1" checked="checked" />
							短信宝 </label>
						<input type="radio" name="mobile_host_type" value="2" />
						云片网络
						</label>
						<?php }else{ ?>
						<input type="radio" name="mobile_host_type" value="1" />
						短信宝
						</label>
				...
				<tr class="noborder">
					...
					<td class="vatop tips"><label class="field_notice"> 可选填写<a href="http://api.smsbao.com/" target="_blank">短信宝</a>或 <a href="http://www.yunpian.com/" target="_blank">云片短信</a></label></td>
				</tr>
				<tr>
				...
				<tr class="noborder">
					...
					<td class="vatop tips"><label class="field_notice">如： 10086</label></td>
				</tr>
				<tr>
					<td colspan="2" class="required">备注信息:</td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform"><textarea id="statistics_code" class="tarea" rows="6" name="mobile_memo"><?php echo $output['list_setting']['mobile_memo'];?></textarea></td>
