    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit member">
          ...
          <td class="w48 picture"><?php if(isset($val['affix'])){?><span class="thumb size-44x44"><a href="<?php echo APP_URL;?>/index.php?act=theme&op=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank"><img width="44" height="44"  src="<?php echo $val['affix'];?>" /></a></span><?php }?></td>
          <td class="">
            <p><strong><a href="<?php echo APP_URL;?>/index.php?act=theme&op=theme_detail&c_id=<?php echo $val['circle_id'];?>&t_id=<?php echo $val['theme_id'];?>" target="_blank"><?php echo $val['theme_name'];?></a></strong></p>
            <p class="smallfont"><?php echo $lang['circle_belong_to_circle'];?><a target="_blank" href="<?php echo APP_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>"><?php echo $val['circle_name'];?></a></p>
          </td>
          ...
          <td class="align-center yes-onoff w96">
            <a href="JavaScript:void(0);" class=" <?php echo $val['is_recommend']? 'enabled':'disabled'?>" ajax_branch='recommend' nc_type="inline_edit" fieldname="is_recommend" fieldid="<?php echo $val['theme_id']?>" fieldvalue="<?php echo $val['is_recommend'];?>" title="<?php echo $val['is_recommend'] ? $lang['nc_yes'] : $lang['nc_no'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
          </td>
