  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_CIRCLE.'/'.$output['list'][1]['pic']);?>"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"></a>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_CIRCLE.'/'.$output['list'][2]['pic']);?>"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"></a>
            </span><span class="type-file-box">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_CIRCLE.'/'.$output['list'][3]['pic']);?>"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"></a>
            </span><span class="type-file-box">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.(ATTACH_CIRCLE.'/'.$output['list'][4]['pic']);?>"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"></a>
            </span><span class="type-file-box">
