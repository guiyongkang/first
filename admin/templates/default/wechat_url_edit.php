      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform" colspan="2">
           <input id="name" name="name" value="<?php echo $output['url_info']['url_name']?>" class="txt" type="text">
          </td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform" colspan="2">
           <input id="urllink" name="urllink" value="<?php echo $output['url_info']['url_link']?>" class="txt" type="text">
          </td>
        </tr>
      </tbody>
      <tfoot>
