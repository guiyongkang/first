...
$(function(){
	...
	<?php }elseif ($output['info']['pic_type'] == 1){?>
		$('#UpFileBox').find('tr').eq(0).find('td').eq(0).find('span').after('<span class="type-file-show"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"><div class="type-file-preview"><img src="<?php echo $output['info']['content']['body'][0]['title'];?>" onload="javascript:DrawImage(this,300,300);"></div></span><input type="hidden" name="opic[]" value="<?php echo $output['info']['content']['body'][0]['title'];?>">');
		$('#UpFileBox').find('input[name="urlup[]"]').eq(0).val('<?php echo $output['info']['content']['body'][0]['url'];?>');
		<?php for ($i=1;$i<count($output['info']['content']['body']);$i++){?>
			$('#addUpFile').click();
			$('#UpFileBox').find('tr').eq(<?php echo $i;?>).find('td').eq(0).find('span').after('<span class="type-file-show"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"><div class="type-file-preview"><img src="<?php echo $output['info']['content']['body'][$i]['title'];?>" onload="javascript:DrawImage(this,300,300);"></div></span><input type="hidden" name="opic[]" value="<?php echo $output['info']['content']['body'][$i]['title'];?>">');
	...
	<?php }elseif ($output['info']['pic_type'] == 2){?>
		...
		$('#RemoteBox').find('input[name="pic[]"]').eq(0).after('<span class="type-file-show"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"><div class="type-file-preview"><img src="<?php echo $output['info']['content']['body'][0]['title'];?>" onload="javascript:DrawImage(this,300,300);"></div></span>');
		<?php for ($i=1;$i<count($output['info']['content']['body']);$i++){?>
			$('#addRemote').click();
			...
			$('#RemoteBox').find('input[name="pic[]"]').eq(<?php echo $i;?>).after('<span class="type-file-show"><img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"><div class="type-file-preview"><img src="<?php echo $output['info']['content']['body'][$i]['title'];?>" onload="javascript:DrawImage(this,300,300);"></div></span>');
		<?php }?>
	<?php }?>
	// 显示隐藏预览图 start
