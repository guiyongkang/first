...
<div class="page">
	...
	<div class="stat-info"> <span>下单量： <strong><?php echo intval($output['statcount']['ordernum']);?></strong> </span><span>下单商品数： <strong><?php echo intval($output['statcount']['goodsnum']);?></strong> </span><span>下单金额： <strong><?php echo ncPriceFormat($output['statcount']['orderamount']);?></strong> 元 </span></div>
