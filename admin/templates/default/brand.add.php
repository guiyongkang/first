	...
	<form id="brand_form" method="post">
		...
		<table class="table tb-type2 nobdb">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input id="show_type_0" type="radio" checked="checked" value="0" style="margin-bottom:6px;" name="show_type" />
						<label for="show_type_0">图片</label>
						<input id="show_type_1" type="radio" value="1" style="margin-bottom:6px;" name="show_type" />
						<label for="show_type_1">文字</label></td>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="brand_recommend1" class="cb-enable"><span><?php echo $lang['nc_yes'];?></span></label>
						...
						<input id="brand_recommend1" name="brand_recommend" <?php if(isset($output['brand_array']['brand_recommend']) && $output['brand_array']['brand_recommend'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
						<input id="brand_recommend0" name="brand_recommend" <?php if(isset($output['brand_array']['brand_recommend']) && $output['brand_array']['brand_recommend'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
