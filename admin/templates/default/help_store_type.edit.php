	...
	<form id="post_form" method="post" name="form1" action="index.php?act=help_store&op=edit_type&type_id=<?php echo $output['type']['type_id']; ?>">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr>
					<td colspan="2" class="required"><label class="validation" for="type_sort"><?php echo $lang['nc_sort'];?>:</label></td>
				</tr>
				<tr class="noborder">
				...
				<tr>
					<td colspan="2" class="required"><?php echo $lang['nc_display'];?>: </td>
				</tr>
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="show1" class="cb-enable <?php if($output['type']['help_show'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
