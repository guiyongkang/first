		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" name="pordersn" id="pordersn" class="txt" value='<?php echo isset($_GET['pordersn']) ? $_GET['pordersn'] : '';?>'></td>
					<th><label for="pbuyname"><?php echo $lang['admin_pointorder_membername']; ?></label></th>
					<td><input type="text" name="pbuyname" id="pbuyname" class="txt" value='<?php echo isset($_GET['pbuyname']) ? $_GET['pbuyname'] : '';?>'></td>
					<td><select name="porderstate">
							<option value="" <?php if (empty($_GET['porderstate'])){echo 'selected=selected';}?>><?php echo $lang['admin_pointorder_orderstate']; ?></option>
							<?php foreach ($output['pointorderstate_arr'] as $k=>$v){ ?>
							<option value="<?php echo $k;?>" <?php if (isset($_GET['porderstate']) && $_GET['porderstate'] == $k){echo 'selected=selected';}?>><?php echo $v[1]; ?></option>
							<?php } ?>
						</select></td>
