	...
	<table class="table tb-type2">
		<thead class="thead">
			...
			<tr>
				...
				<th class="w84"><?php echo $lang['memory_set_cls'];?></th>
				<br>
				<th></th>
			</tr>
		</thead>
		<tbody>
			<tr>
				...
				<td><?php echo $output['setting_config']['cache']['type'] == 'memcache' ? 'YES': 'NO';?></td>
				<td><?php if (extension_loaded('memcache') && $output['setting_config']['cache']['type'] == 'memcache'){?>
					<a href="index.php?act=perform&op=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a>
					<?php }else{ echo '--';}?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo $output['setting_config']['cache']['type'] == 'eaccelerator' ? 'YES': 'NO';?></td>
				<td>--</td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo $output['setting_config']['cache']['type'] == 'apc' ? 'YES': 'NO';?></td>
				<td><?php if (function_exists('apc_cache_info') && $output['setting_config']['cache']['type'] == 'apc'){?>
					<a href="index.php?act=perform&op=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a>
					<?php }else{ echo '--';}?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo $output['setting_config']['cache']['type'] == 'xcache' ? 'YES': 'NO';?></td>
				<td><?php if (function_exists('xcache_info') && $output['setting_config']['cache']['type'] == 'xcache'){?>
					<a href="index.php?act=perform&op=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a>
					<?php }else{ echo '--';}?></td>
				<td></td>
			</tr>
			<tr>
				...
				<td><?php echo $output['setting_config']['cache']['type'] == 'redis' ? 'YES': 'NO';?></td>
				<td><?php if (extension_loaded('redis') && $output['setting_config']['cache']['type'] == 'redis'){?>
					<a href="index.php?act=perform&op=perform&type=clear"><?php echo $lang['memory_set_cls'];?></a>
					<?php }else{ echo '--';}?></td>
				<td></td>
			</tr>
