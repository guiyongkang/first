...
<div class="page">
	...
	<form id="add_form" method="post" action="index.php?act=groupbuy&op=price_save">
		<input name="range_id" type="hidden" value="<?php echo isset($output['price_info']['range_id']) ? $output['price_info']['range_id'] : 0;?>" />
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo isset($output['price_info']['range_name']) ? $output['price_info']['range_name'] : '';?>" name="range_name" id="range_name" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo isset($output['price_info']['range_start']) ? $output['price_info']['range_start'] : '';?>" name="range_start" id="range_start" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" value="<?php echo isset($output['price_info']['range_end']) ? $output['price_info']['range_end'] : '';?>" name="range_end" id="range_end" class="txt"></td>
					<td class="vatop tips"><?php echo $lang['price_range_price_tip'];?></td>
				</tr>
			</tbody>
			<tfoot>
