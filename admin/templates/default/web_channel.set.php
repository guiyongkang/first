		...
		<div class="ncap-form-default">
			<dl class="row">
				...
				<dd class="opt">
					...
					<span class="err"></span>
					<p class="notic"> 仅限一级和二级分类，绑定后前台头部菜单里的原商品链接将会变为频道链接，一个分类只能绑定一个频道（以最新提交为准）。<br/>
						选择分类后，频道顶部切换焦点大图右侧会自动调用该分类下的团购和限时折扣促销商品，团购的商品优先，无数据时不显示。<br/>
					</p>
				</dd>
			</dl>
			<dl class="row">
			...
			<dl class="row ncap-channel-floor">
				...
				<dd class="opt">
					<ul id="floor_list">
						...
						<li>
							<div class="layout-name">模块：<?php echo $v['web_name'];?></div>
			...
			<dl class="row  ncap-channel-floor-list">
				...
				<dd class="opt">
					<div class="c-search"><span class="mr5">模块查找</span>
						<input id="floor_name" name="floor_name" value="" class="w230" placeholder="请输入已建立的模块的名称作为关键字" type="text">
