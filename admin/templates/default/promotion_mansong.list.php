		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['mansong_name']) ? $_GET['mansong_name'] : '';?>" name="mansong_name" id="mansong_name" class="txt" style="width:100px;"></td>
		...
		<table class="table tb-type2">
			...
			<tbody id="treet1">
				...
				<tr class="hover">
					...
					<td class="nowrap align-center"><!-- 详细按钮 --> 
						...
						<?php } ?>
						<a nctype="btn_del" data-mansong-id="<?php echo $val['mansong_id'];?>" href="javascript:;"><?php echo $lang['nc_del'];?></a></td>
				</tr>
				<?php } ?>
				<?php }else { ?>
				<tr class="no_data">
