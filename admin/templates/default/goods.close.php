			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="align-center"><p><?php echo $output['state'][$v['goods_state']];?></p>
						...
						<?php }?></td>
					<td class="w48 align-center"><a href="javascript:void(0);" nctype="del_batch" uri="<?php echo urlAdmin('goods', 'goods_del', array('goods_id' => $v['goods_commonid']));?>"><?php echo $lang['nc_del'];?></a></td>
				</tr>
