...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			<h3><?php echo isset($lang['bill_manage']) ? $lang['bill_manage'] : '';?>结算管理</h3>
			<ul class="tab-base">
	...
	<table class="table tb-type2 noborder search">
		<tbody>
			<tr>
				<td>店铺 - <?php echo $output['bill_info']['ob_store_name'];?>（ID：<?php echo $output['bill_info']['ob_store_id'];?>） <?php echo $output['bill_info']['os_month'];?> 期 结算单&emsp;
			...
			<tr>
				<td><?php echo isset($lang['order_time_from']) ? $lang['order_time_from'] : '';?>结算单号<?php echo $lang['nc_colon'];?><?php echo $output['bill_info']['ob_no'];?></td>
			</tr>
			<tr>
				<td>起止日期<?php echo $lang['nc_colon'];?><?php echo date('Y-m-d',$output['bill_info']['ob_start_date']);?> &nbsp;至&nbsp; <?php echo date('Y-m-d',$output['bill_info']['ob_end_date']);?></td>
			</tr>
			<tr>
				<td>出账日期<?php echo $lang['nc_colon'];?><?php echo date('Y-m-d',$output['bill_info']['ob_create_date']);?></td>
			</tr>
			<tr>
				<td>平台应付金额：<?php echo $output['bill_info']['ob_result_totals'];?> = <?php echo $output['bill_info']['ob_order_totals'];?> (订单金额) - <?php echo $output['bill_info']['ob_order_return_totals'];?> (退单金额) - <?php echo $output['bill_info']['ob_store_cost_totals'];?> (店铺促销费用)</td>
			</tr>
			<tr>
				<td>结算状态：<?php echo billState($output['bill_info']['ob_state']);?>
