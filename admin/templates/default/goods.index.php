		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<a href="javascript:void(0);" onclick="goods_lockup(<?php echo $v['goods_commonid'];?>);">违规下架</a>
					<a href="<?php echo urlAdmin('goods', 'goodsr_set', array('commonid' => $v['goods_commonid']));?>"><span>设置全返</span></a>
