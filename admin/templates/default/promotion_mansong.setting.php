	...
	<form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=promotion_mansong&op=mansong_setting_save">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_mansong_price" name="promotion_mansong_price" value="<?php echo $output['setting']['promotion_mansong_price'];?>" class="txt"></td>
