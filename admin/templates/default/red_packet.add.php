			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="start_time"
						name="start_time" class="txt date" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="end_time"
						name="end_time" class="txt date" /></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="packet_number"
						name="packet_number" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="packet_amount"
						name="packet_amount" class="txt"></td>
          ...
          <td class="vatop tips">自红包领取后指定时间内有效，1为领取当天有效<span style="color:red;">(与“红包指定有效期”只能二选一)</span></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="win_rate"
						name="win_rate" class="txt" value="100"></td>
				</tr>
				<!--tr class="noborder">
