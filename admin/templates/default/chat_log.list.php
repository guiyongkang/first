	...
	<form method="get" action="index.php" name="formSearch" id="formSearch">
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					<th>发送人</th>
					<td><input type="text" class="text" name="f_name" value="<?php echo isset($_GET['f_name']) ? trim($_GET['f_name']) : ''; ?>" /></td>
					<th>回复人</th>
					<td><input type="text" class="text" name="t_name" value="<?php echo isset($_GET['t_name']) ? trim($_GET['t_name']) : ''; ?>" /></td>
	...
	<div class="chat-log">
		<ul class="chat-log-list">
			...
			<li class="from_log"><span class="avatar"><img src="<?php echo getMemberAvatarForID($val['f_id']);?>"/></span>
				...
				<dl>
					<dt class="store_log"><?php echo $output['f_member']['store_name']; ?>客服：<?php echo $output['f_member']['seller_name']; ?> <span>(会员ID：<?php echo $val['f_name']; ?>)</span> </dt>
			...
			<li class="to_log"><span class="avatar"><img src="<?php echo getMemberAvatarForID($val['f_id']);?>"/></span>
				...
				<dl>
					<dt class="store_log"><?php echo $output['t_member']['store_name']; ?>客服：<?php echo $output['t_member']['seller_name']; ?> <span>(会员ID：<?php echo $val['f_name']; ?>)</span> </dt>
					<dd class="time"><?php echo date("Y-m-d H:i:s",$val['add_time']);?></dd>
					<dd class="content"><?php echo parsesmiles($val['t_msg']);?></dd>
				</dl>
				<?php } else { ?>
