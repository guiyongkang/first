...
<div class="page">
	...
	<table class="table tb-type2 nobdb">
		<tbody>
			...
			<tr class="noborder">
				<td class="vatop rowform"><?php if (date('His',$output['info']['pdr_payment_time']) == 0) {?>
		...
		<tfoot id="submit-holder">
			<tr class="tfoot">
				<td colspan="2"><a class="btn" href="index.php?act=predeposit&op=recharge_edit&id=<?php echo $output['info']['pdr_id']; ?>"><span><?php echo  $lang['admin_predeposit_payed'];?></span></a></td>
			</tr>
		</tfoot>
		<?php } ?>
	</table>
