	...
	<form id="link_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" name="ap_name" id="ap_name" class="txt"></td>
			...
			<tbody id="default_pic">
				...
				<tr class="noborder">
					<td class="vatop rowform type-file-box"><input type="file" name="default_pic" id="change_default_pic" size="30" hidefocus="true" nc_type="change_default_pic"></td>
			...
			<tbody id="default_word">
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="default_word" value="" name="default_word" class="txt"></td>
