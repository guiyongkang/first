	...
	<form method="post" enctype="multipart/form-data" name="form1">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php if(!empty($output['pic'][$i])){ ?>
						<span class="type-file-show" id="show<?php echo $i;?>"><a class="nyroModal" rel="gal" href="<?php echo UPLOAD_SITE_URL.'/'.ATTACH_COMMON.'/'.$output['pic'][$i];?>"> <img class="show_image" src="<?php echo APP_TEMPLATES_URL;?>/images/preview.png"></a> </span>
						<?php } ?>
