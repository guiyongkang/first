...
function checkmember(){
	...
	$.getJSON("index.php?act=points&op=checkmember", {'name':membername}, function(data){
	        ...
	        {
		        $("#tr_memberinfo").show();
				var msg= "<?php echo isset($lang['admin_points_member_tip']) ? $lang['admin_points_member_tip'] : ''; ?> "+ data.name + "<?php echo isset($lang['admin_points_member_tip_2']) ? $lang['admin_points_member_tip_2'] : ''; ?>" + data.points;
