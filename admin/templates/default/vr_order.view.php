...
<div class="page">
	<table class="table tb-type2 order">
		...
		<tr>
			<td colspan="2"><ul>
					<li> <strong><?php echo $lang['order_number'];?>:</strong><?php echo $output['order_info']['order_sn'];?> </li>
					<li><strong><?php echo $lang['order_state'];?>:</strong><?php echo $output['order_info']['state_desc'];?></li>
					<li><strong><?php echo $lang['order_total_price'];?>:</strong><span class="red_common"><?php echo $lang['currency'].$output['order_info']['order_amount'];?> </span> </li>
		...
		<tr>
			<td><table class="table tb-type2 goods ">
					<tbody>
						...
						<tr>
							<td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><img src="<?php echo thumb($output['order_info'], 60);?>" /></span></div></td>
							<td class="w50pre"><p><?php echo $output['order_info']['goods_name'];?></p>
								<p>
		...
		<tr>
			...
			<table class="table tb-type2 goods">
				...
				<?php } else { ?>
				<tr>
					<td colspan="20" class="align-center">未生成电子兑换码</td>
				</tr>
				<?php } ?>
					</tbody>
