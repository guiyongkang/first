		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($_GET['search_uname']) ? $_GET['search_uname'] : '';?>" name="search_uname" id="search_uname" class="txt"></td>
					<th><label for="search_content"><?php echo $lang['admin_snstrace_content'];?></label></th>
					<td><input type="text" value="<?php echo isset($_GET['search_content']) ? $_GET['search_content'] : '';?>" name="search_content" id="search_content" class="txt"></td>
					<th><label><?php echo $lang['admin_snstrace_state'];?></label></th>
					<td><select name="search_state">
							<option value=''><?php echo $lang['nc_please_choose'];?>...</option>
							<option value="0" <?php echo isset($_GET['search_state']) && $_GET['search_state'] == '0'?'selected':''; ?>><?php echo $lang['admin_snstrace_stateshow'];?></option>
							<option value="1" <?php echo isset($_GET['search_state']) && $_GET['search_state'] == '1'?'selected':''; ?>><?php echo $lang['admin_snstrace_statehide'];?></option>
						</select></td>
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="fd-list"><!-- 动态列表start -->
						...
						<li>
							<div class="fd-aside"> <span class="thumb size60"><a href="<?php echo APP_URL.DS;?>index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"> <img src="<?php echo getMemberAvatarForID($v['trace_memberid']);?>" onload="javascript:DrawImage(this,60,60);"> </a> </span> </div>
							<dl class="fd-wrap">
								<dt>
									<h3><a href="<?php echo APP_URL.DS;?>index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"><?php echo $v['trace_membername'];?></a><?php echo $lang['nc_colon'];?></h3>
