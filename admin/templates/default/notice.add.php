	...
	<form id="notice_form" method="POST">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li>
								<label>
									<input type="radio" checked="" value="1" name="send_type">
									<?php echo $lang['notice_index_spec_member'];?></label>
							</li>
							<li>
								<label>
									<input type="radio" value="2" name="send_type" />
									<?php echo $lang['notice_index_all_member'];?></label>
							</li>
						</ul></td>
			...
			<tbody id="user_list">
				...
				<tr class="noborder">
					<td class="vatop rowform"><textarea id="user_name" name="user_name" rows="6" class="tarea" ><?php echo base64_decode(str_replace(' ','+',isset($_GET['member_name']) ? $_GET['member_name'] : '')); ?></textarea></td>
