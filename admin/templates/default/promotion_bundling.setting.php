	...
	<form id="add_form" method="post" action="index.php?act=promotion_bundling&op=bundling_setting">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_bundling_price" name="promotion_bundling_price" value="<?php echo $output['setting']['promotion_bundling_price'];?>" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_bundling_sum" name="promotion_bundling_sum" value="<?php echo $output['setting']['promotion_bundling_sum'];?>" class="txt"></td>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input type="text" id="promotion_bundling_goods_sum" name="promotion_bundling_goods_sum" value="<?php echo $output['setting']['promotion_bundling_goods_sum'];?>" class="txt"></td>
