        ...
        <table class="table tb-type2">
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act=store&op=detail&store_id='.$value['microshop_store_id'];?>" target="_blank">
                            <?php echo $value['store_name'];?>
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act=home&member_id='.$value['member_id'];?>" target="_blank">
                    ...
                    <td class="yes-onoff">
                        <a href="JavaScript:void(0);" class=" <?php echo $value['microshop_commend']? 'enabled':'disabled'?>" ajax_branch='store_commend'  nc_type="inline_edit" fieldname="microshop_commend" fieldid="<?php echo $value['store_id']?>" fieldvalue="<?php echo $value['microshop_commend']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
                    </td>
