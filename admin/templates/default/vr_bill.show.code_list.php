...
<div style="text-align:right;"> <a class="btns" href="index.php?act=vr_bill&op=show_bill&ob_no=<?php echo $_GET['ob_no'];?>&query_type=<?php echo $_GET['query_type'];?>&op=export_order" target="_blank"> <span>导出CSV</span> </a> </div>
<table class="table tb-type2 nobdb">
	...
	<tbody>
		...
		<tr class="hover">
			...
			<td class="align-center"><?php if ($_GET['query_type'] == 'timeout') { ?>
			...
			<td><a href="index.php?act=vr_order&op=show_order&order_id=<?php echo $code_info['order_id'];?>"><?php echo $lang['nc_view'];?></a></td>
		</tr>
		<?php }?>
		<?php }else{?>
		<tr class="no_data">
