	...
	<form id="add_form" method="post" action="index.php?act=voucher&op=templateedit">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php if ($output['t_info']['voucher_t_customimg']){?>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php foreach ($output['templatestate_arr'] as $k=>$v){?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label title="<?php echo $lang['nc_yes'];?>" class="cb-enable <?php if($output['t_info']['voucher_t_recommend'] == '1'){ ?>selected<?php } ?>" for="recommend1"><span><?php echo $lang['nc_yes'];?></span></label>
