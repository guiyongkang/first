	...
	<form id="link_form" enctype="multipart/form-data" method="post">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php echo isset($output['goods_class'][$output['link_array']['gc_id']]['gc_name']) ? $output['goods_class'][$output['link_array']['gc_id']]['gc_name'] : '';?></td>
...
$(document).ready(function(){
	$('#link_form').validate({
        ...
        messages : {
            ...
            link_url  : {
                required : '<?php echo isset($lang['link_add_url_null']) ? $lang['link_add_url_null'] : '';?>',
                url      : '<?php echo isset($lang['link_add_url_wrong']) ? $lang['link_add_url_wrong'] : '';?>'
            },
            link_sort  : {
