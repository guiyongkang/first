            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        ...
                        <a href="<?php echo APP_URL.DS.'index.php?act=goods&op=detail&goods_id='.$value['commend_id'];?>" style="background:url(<?php echo $image_url;?>) no-repeat center center; width:60px; height:60px; float:left; margin-right:5px;" target="_blank">
                    ...
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act=goods&op=detail&goods_id='.$value['commend_id'];?>" target="_blank">
                            <?php echo $value['commend_id'];?>
                        </a>
                    </td>
                    <td>
                        <a href="<?php echo APP_URL.DS.'index.php?act=home&member_id='.$value['commend_member_id'];?>" target="_blank">
                    ...
                    <td class="yes-onoff">
                        <a href="JavaScript:void(0);" class=" <?php echo $value['microshop_commend']? 'enabled':'disabled'?>" ajax_branch='goods_commend'  nc_type="inline_edit" fieldname="microshop_commend" fieldid="<?php echo $value['commend_id']?>" fieldvalue="<?php echo $value['microshop_commend']?'1':'0'?>" title="<?php echo $lang['editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
                    </td>
