...
<link href="<?php echo APP_TEMPLATES_URL?>/css/index.css" rel="stylesheet" type="text/css">
<style type="text/css">
.type-file-box-shop input[type="text"] {
	border: 0px;
}
	...
	<form id="goods_class_form" name="goodsClassForm" enctype="multipart/form-data" method="post">
		...
		<div class="ncap-form-default">
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" maxlength="20" value="<?php echo isset($output['nav_info']['cn_alias']) ? $output['nav_info']['cn_alias'] : '';?>" name="cn_alias" id="cn_alias" class="input-txt">
					<span class="err"></span>
			...
			<dl class="row">
				...
				<dd class="opt">
					...
					<label title="分类导航广告图1-跳转链接" for="cn_adv1_link" class="ml5"><i class="fa fa-link"></i>
						<input type="text" value="<?php echo isset($output['nav_info']['cn_adv1_link']) ? $output['nav_info']['cn_adv1_link'] : '';?>" name="cn_adv1_link" id="cn_adv1_link" class="input-txt ml5">
					</label>
			...
			<dl class="row">
				...
				<dd class="opt">
					...
					<label for="cn_adv2_link" title="分类导航广告图2-跳转链接" class="ml5"><i class="fa fa-link"></i>
						<input type="text" value="<?php echo isset($output['nav_info']['cn_adv2_link']) ? $output['nav_info']['cn_adv2_link'] : '';?>" name="cn_adv2_link" id="cn_adv2_link" class="input-txt ml5">
					</label>
					<p class="notic">广告图片将展示在推荐品牌下方，请使用宽度190像素，高度150像素的jpg/gif/png格式图片作为分类导航广告上传，<br/>
						如需跳转请在后方添加以http://开头的链接地址。</p>
				</dd>
...
<script type="text/javascript" src="<?php echo RESOURCE_SITE_URL;?>/js/jquery.mousewheel.js"></script> 
<script type="text/javascript" src="<?php echo APP_URL;?>/resource/js/jquery.nyroModal.js"></script> 
<script>
$(function(){
//自动加载滚动条
