	...
	<form id="add_form" method="post" action="index.php?act=vr_groupbuy&op=area_add">
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><?php echo $output['area_name']; ?>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="hot1" class="cb-enable" ><span><?php echo $lang['open'];?></span></label>
						<label for="hot0" class="cb-disable selected" ><span><?php echo $lang['close'];?></span></label>
						<input id="hot1" name="is_hot"  value="1" type="radio">
						<input id="hot0" name="is_hot"  checked="checked" value="0" type="radio"></td>
				</tr>
				<?php } ?>
			</tbody>
			<tfoot>
