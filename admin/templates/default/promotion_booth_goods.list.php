		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="align-center"><p><a href="javascript:;"><?php echo $lang['nc_view'];?></a></p>
						<p><a href="javascript:void(0);" onclick="ajaxget('<?php echo urlAdmin('promotion_booth', 'del_goods', array('goods_id' => $v['goods_id']));?>');">删除</a></p></td>
				</tr>
				<?php } ?>
				<?php } else { ?>
				<tr class="no_data">
			...
			<tfoot>
				<tr class="tfoot">
					...
					<td colspan="16"><label for="checkallBottom"><?php echo $lang['nc_select_all']; ?></label>
						...
						<div class="pagination"> <?php echo isset($output['page']) ? $output['page'] : '';?> </div></td>
				</tr>
			</tfoot>
		</table>
	</form>
