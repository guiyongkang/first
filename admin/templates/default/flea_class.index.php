      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="align-center power-onoff"><?php if($v['gc_index_show'] == 0){ ?>
            <a href="JavaScript:void(0);" class="tooltip disabled" fieldvalue="0" fieldid="<?php echo $v['gc_id'];?>" ajax_branch="goods_class_index_show" fieldname="gc_index_show" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php }else{ ?>
            <a href="JavaScript:void(0);" class="tooltip enabled" fieldvalue="1" fieldid="<?php echo $v['gc_id'];?>" ajax_branch="goods_class_index_show" fieldname="gc_index_show" nc_type="inline_edit"  title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
            <?php } ?></td>
