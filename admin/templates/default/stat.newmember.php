	...
	<table class="table tb-type2 nobdb">
		...
		<tbody id="datatable">
			...
			<tr class="hover">
				...
				<td class="align-center"><a href="index.php?act=stat_member&op=showmember&type=newbyday&t=<?php echo $v['seartime'];?>">查看</a></td>
			</tr>
			<?php } ?>
			<tr class="hover">
				...
				<td class="align-center"><a href="index.php?act=stat_member&op=showmember&type=newbyday&t=<?php echo $output['count_arr']['seartime'];?>">查看</a></td>
			</tr>
			<?php } else { ?>
			<tr class="no_data">
