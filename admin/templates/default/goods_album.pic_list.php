					...
					<td colspan="20"><ul class="thumblists">
							...
							<li class="picture">
								<div class="size-64x64"> <span class="thumb"> <i></i>
									...
									<?php }else{?>
									<img height="64" src="<?php echo APP_URL.'/templates/'.TPL_NAME.'/images/member/default_image.png';?>" max-height='70px' max-width="70px">
									<?php }?>
									</span> </div>
								<p> <span>
									<input class="checkitem" type="checkbox" name="delbox[]" value="<?php echo $v['apic_id'];?>">
									</span><span><a href="javascript:void(0);" nc_type="delete" nc_key="<?php echo $v['apic_id'].'|'.$v['apic_cover'];?>"><?php echo $lang['nc_del'];?></a></span> </p>
							</li>
							<?php } ?>
						</ul></td>
				</tr>
