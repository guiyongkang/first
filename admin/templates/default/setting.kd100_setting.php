	...
	<form method="post" name="settingForm">
		...
		<table class="table tb-type2">
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform"><input id="kd100_appid" name="kd100_appid" value="<?php echo $output['list_setting']['kd100_appid'];?>" class="txt" type="text"></td>
					<td class="vatop tips"><a style="color:#ffffff; font-weight:bold;" target="_blank" href="http://www.kuaidi100.com/openapi/applyapi.shtml"><?php echo '快递100物流查询密钥申请'; ?></a></td>
				</tr>
			</tbody>
			<tfoot>
				<tr class="tfoot">
