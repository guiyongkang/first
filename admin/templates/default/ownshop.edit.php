...
<div class="page">
	...
	<table class="table tb-type2" id="prompt">
		<tbody>
			...
			<tr>
				<td><ul>
						<li>可以修改店铺的店铺名称以及店铺状态是否为开启状态</li>
						<li>可以修改店铺的店主商家中心登录账号</li>
						<li>已绑定所有类目的店，如果将“绑定所有类目”设置为“否”，则会下架其所有商品，请谨慎操作！</li>
					</ul></td>
			</tr>
		</tbody>
	</table>
	<form id="store_form" method="post">
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff"><label for="bind_all_gc1" class="cb-enable <?php if ($output['store_array']['bind_all_gc'] == '1'){ ?>selected<?php } ?>" ><span>是</span></label>
						...
						<input id="bind_all_gc0" name="bind_all_gc" <?php if($output['store_array']['bind_all_gc'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
			...
			<tbody>
				...
				<tr class="noborder">
					<td class="vatop rowform onoff">
						...
						<input id="store_state1" name="store_state" <?php if($output['store_array']['store_state'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
						<input id="store_state0" name="store_state" <?php if($output['store_array']['store_state'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio">
					</td>
					<td class="vatop tips"></td>
				</tr>
			</tbody>
