...
<div class="page">
	<form action="index.php?act=common&op=pic_cut" id="form_cut" method="post">
		...
		<input type="hidden" id="url" name="url" value="<?php echo isset($_GET['url']) ? $_GET['url'] : '';?>" />
		<input type="hidden" id="filename" name="filename" value="<?php echo isset($_GET['filename']) ? $_GET['filename'] : '';?>" />
