			...
			<tbody id="treet1">
				...
				<tr class="hover edit">
					<td><?php if($v['ac_code'] == ''){ ?>
						...
						<img src="<?php echo APP_TEMPLATES_URL;?>/images/tv-expandable.gif" fieldid="<?php echo $v['ac_id'];?>" status="open" nc_type="flex">
						<?php }else{ ?>
						<img fieldid="<?php echo $v['ac_id'];?>" status="close" nc_type="flex" src="<?php echo APP_TEMPLATES_URL;?>/images/tv-item.gif">
						<?php } ?></td>
