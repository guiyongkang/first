				...
				<tr class="noborder">
					<td class="vatop rowform"><ul class="nofloat">
							<li class="left w100pre"><span class="radio">
								<input type="radio" <?php if(isset($output['navigation_array']['nav_type']) && $output['navigation_array']['nav_type'] == '0'){ ?>checked="checked"<?php } ?> value="0" name="nav_type" id="diy" onclick="showType('diy');">
								<label for="diy"><?php echo $lang['navigation_add_custom'];?></label>
								</span></li>
							<li class="left w100pre"><span class="radio">
								<input type="radio" <?php if(isset($output['navigation_array']['nav_type']) && $output['navigation_array']['nav_type'] == '1'){ ?>checked="checked"<?php } ?> value="1" name="nav_type" id="goods_class" onclick="showType('goods_class');">
								...
								<select name="goods_class_id" id="goods_class_id" style="display: none;">
									...
									<option <?php if(isset($output['navigation_array']['item_id']) && ($output['navigation_array']['item_id'] == $v['gc_id'])){ ?>selected="selected"<?php } ?> value="<?php echo $v['gc_id'];?>"><?php echo $v['gc_name'];?></option>
									<?php } ?>
									<?php } ?>
								</select>
							</li>
							<li class="left w100pre"><span class="radio">
								<input type="radio" <?php if(isset($output['navigation_array']['nav_type']) && $output['navigation_array']['nav_type'] == '2'){ ?>checked="checked"<?php } ?> value="2" name="nav_type" id="article_class" onclick="showType('article_class');">
								...
								<select name="article_class_id" id="article_class_id" style="display: none;">
									...
									<option <?php if(isset($output['navigation_array']['item_id']) && ($output['navigation_array']['item_id'] == $v['ac_id'])){ ?>selected="selected"<?php } ?> value="<?php echo $v['ac_id'];?>"><?php echo $v['ac_name'];?></option>
									<?php } ?>
									<?php } ?>
								</select>
							</li>
							<li class="left w100pre"><span class="radio">
								<input type="radio" <?php if(isset($output['navigation_array']['nav_type']) && ($output['navigation_array']['nav_type'] == '3')){ ?>checked="checked"<?php } ?> value="3" name="nav_type" id="activity" onclick="showType('activity');">
								...
								<select name="activity_id" id="activity_id" style="display: none;">
									...
									<option <?php if(isset($output['navigation_array']['item_id']) && ($output['navigation_array']['item_id'] == $v['activity_id'])){ ?>selected="selected"<?php } ?> value="<?php echo $v['activity_id'];?>"><?php echo $v['activity_title'];?></option>
									<?php } ?>
									<?php } ?>
								</select>
							</li>
