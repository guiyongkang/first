...
*margin-top:expression(22-this.height/2)/*IE6,7*/;
}
.waybill-img-size {
	color: #777;
	line-height: 20px;
		...
		<table class="table tb-type2">
			...
			<tbody id="treet1">
				...
				<tr class="hover">
					...
					<td><div class="waybill-img-thumb"><a class="nyroModal" rel="gal" href="<?php echo $value['waybill_image_url'];?>"><img src="<?php echo $value['waybill_image_url'];?>"></a></div>
