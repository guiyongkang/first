...
<div class="page">
	...
	<form method="get" name="formSearch" id="formSearch">
		...
		<input type="hidden" name="op" value="publists">
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
                    ...
                    <th><label>竖向级数</label></th>
					<td>
                    	<input type="text" value="<?php echo isset($output['search']['miny']) ? $output['search']['miny'] : '';?>" name="miny" class="txt" style="width:60px; text-align:center" /> ~ <input type="text" value="<?php echo isset($output['search']['maxy']) ? $output['search']['maxy'] : '';?>" name="maxy" class="txt" style="width:60px; text-align:center" />
                    </td>
                    <th><label>横向位置</label></th>
					<td>
                    	<input type="text" value="<?php echo isset($output['search']['minx']) ? $output['search']['minx'] : '';?>" name="minx" class="txt" style="width:60px; text-align:center" /> ~ <input type="text" value="<?php echo isset($output['search']['maxx']) ? $output['search']['maxx'] : '';?>" name="maxx" class="txt" style="width:60px; text-align:center" />
                    </td>
