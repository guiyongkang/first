		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<th><?php echo $lang['admin_points_addtime']; ?></th>
					<td><input type="text" id="stime" name="stime" class="txt date" value="<?php echo isset($_GET['stime']) ? $_GET['stime'] : '';?>" >
						<label>~</label>
						<input type="text" id="etime" name="etime" class="txt date" value="<?php echo isset($_GET['etime']) ? $_GET['etime'] : '';?>" ></td>
					<td><select name="stage">
							<option value="" <?php if (empty($_GET['stage'])){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage']; ?></option>
							<option value="regist" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'regist'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_regist']; ?></option>
							<option value="login" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'login'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_login']; ?></option>
							<option value="comments" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'comments'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_comments']; ?></option>
							<option value="order" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'order'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_order']; ?></option>
							<option value="system" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'system'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_system']; ?></option>
							<option value="pointorder" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'pointorder'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_pointorder']; ?></option>
							<option value="app" <?php if (isset($_GET['stage']) && $_GET['stage'] == 'app'){echo 'selected=selected';}?>><?php echo $lang['admin_points_stage_app']; ?></option>
						</select></td>
				</tr>
				<tr>
					<th><label><?php echo $lang['admin_points_adminname']; ?></label></th>
					<td><input type="text" name="aname" class="txt" value='<?php echo isset($_GET['aname']) ? $_GET['aname'] : '';?>'></td>
					<th><?php echo $lang['admin_points_pointsdesc']; ?></th>
					<td><input type="text" id="description" name="description" class="txt2" value="<?php echo isset($_GET['description']) ? $_GET['description'] : '';?>" ></td>
