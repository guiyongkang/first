<table class="table tb-type2 order mtw">
	...
	<tbody>
		<tr>
			<td class="progress"><span id="state_new" class="text"><?php echo $lang['complain_state_new'];?></span> <span class="next-step"></span> <span id="state_appeal" class="text"><?php echo $lang['complain_state_appeal'];?></span> <span class="next-step"></span> <span id="state_talk" class="text"><?php echo $lang['complain_state_talk'];?></span> <span class="next-step"> </span> <span id="state_handle" class="text"><?php echo $lang['complain_state_handle'];?></span> <span class="next-step"></span> <span id="state_finish" class="text"><?php echo $lang['complain_state_finish'];?></span></td>
		</tr>
	</tbody>
</table>
<table class="table tb-type2 order">
	...
	<tbody>
		<tr class="noborder">
			<td><ul>
					<li><strong><?php echo $lang['order_shop_name'];?>:</strong><?php echo $output['order_info']['store_name'];?></li>
					<li><strong><?php echo $lang['order_state'];?>:</strong><b><?php echo $output['order_info']['order_state_text'];?></b></li>
					<li><strong>订单号:</strong><a href="index.php?act=order&op=show_order&order_id=<?php echo $output['order_info']['order_id'];?>" target="_blank"> <?php echo $output['order_info']['order_sn'];?></a> </li>
