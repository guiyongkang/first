...
<div class="page">
  ...
  <input type="hidden" name="tid" value="<?php echo $output['team_info']['team_id'];?>" />
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          ...
          <input id="name" name="name" value="<?php echo $output['team_info']['team_name'];?>" class="txt" type="text">
          </td>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          直推人数需达到 <input id="invitenum" name="invitenum" value="<?php echo $output['team_info']['team_invitenum'];?>" class="txt" type="text" style="width:80px"> 人
          </td>
          <td class="vatop tips">&nbsp;</td>
        </tr>
      </tbody>
