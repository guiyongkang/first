...
<div class="page">
	...
	<form id="store_class_form" method="post">
		...
		<input type="hidden" name="sc_parent_id" value="<?php echo isset($output['class_array']['sc_parent_id']) ? $output['class_array']['sc_parent_id'] : 0;?>" />
		<table class="table tb-type2">
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="validation" class="sc_name">
						<?php echo $lang['store_class_name'];?>:
						</label></td>
				</tr>
				<tr class="noborder">
