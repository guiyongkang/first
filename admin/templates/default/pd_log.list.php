	...
	<form method="get" name="formSearch" id="formSearch">
		...
		<table class="tb-type1 noborder search">
			<tbody>
				...
				<tr>
					<th><label><?php echo $lang['admin_predeposit_adminname'];?></label></th>
	...
	<table class="table tb-type2">
		<thead>
			<tr class="thead">
				...
				<th><?php echo $lang['admin_predeposit_pricetype_available'];?></th>
				<th><?php echo $lang['admin_predeposit_pricetype_freeze'];?></th>
