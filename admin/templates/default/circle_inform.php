    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="tl">
            <p><b><?php echo $lang['circle_inform_url'].$lang['nc_colon'];?></b><a href="<?php echo APP_URL.DS.$val['url'];?>" target="_blank"><?php echo $val['title'];?></a></p>
            <p><b><?php echo $lang['circle_inform_content'].$lang['nc_colon'];?></b><?php echo $val['inform_content'];?></p>
          </td>
          <td><a href="<?php echo APP_URL;?>/index.php?act=group&c_id=<?php echo $val['circle_id'];?>" target="_blank"><?php echo $val['circle_name'];?></a></td>
          <td>
