		...
		<form class="tab-content" method="post" name="message_form" >
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="message_switch1" class="cb-enable <?php if($output['smtpl_info']['smt_message_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="message_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_message_forced'] == 1){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="message_content" rows="6" class="tarea"><?php echo $output['smtpl_info']['smt_message_content'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
				</tbody>
			</table>
			<div class="margintop"> <a href="JavaScript:void(0);" onclick="document.message_form.submit();" class="btn"><span><?php echo $lang['nc_submit'];?></span></a> </div>
		</form>
		<!-- 站内信 E --> 
		<!-- 短消息 S -->
		<form class="tab-content" method="post" name="short_name" style="display:none;">
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="short_switch1" class="cb-enable <?php if($output['smtpl_info']['smt_short_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="short_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_short_forced'] == 1){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="short_content" rows="6" class="tarea"><?php echo $output['smtpl_info']['smt_short_content'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
				</tbody>
			</table>
			<div class="margintop"> <a href="JavaScript:void(0);" onclick="document.short_name.submit();" class="btn"><span><?php echo $lang['nc_submit'];?></span></a> </div>
		</form>
		<!-- 短消息 E --> 
		<!-- 邮件 S -->
		<form class="tab-content" method="post" name="mail_form" style="display:none;">
			...
			<table class="table tb-type2">
				<tbody>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="mail_switch1" class="cb-enable <?php if($output['smtpl_info']['smt_mail_switch'] == 1){?>selected<?php }?>"><span><?php echo $lang['open'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform onoff"><label for="mail_forced1" class="cb-enable <?php if($output['smtpl_info']['smt_mail_forced'] == 1){?>selected<?php }?>"><span><?php echo $lang['nc_yes'];?></span></label>
					...
					<tr class="noborder">
						<td class="vatop rowform"><textarea name="mail_subject" rows="6" class="tarea"><?php echo $output['smtpl_info']['smt_mail_subject'];?></textarea></td>
						<td class="vatop tips"></td>
					</tr>
					<tr>
			...
			<div class="margintop"> <a href="JavaScript:void(0);" onclick="document.mail_form.submit();" class="btn"><span><?php echo $lang['nc_submit'];?></span></a> </div>
		</form>
		<!-- 邮件 E --> 
	</div>
</div>
