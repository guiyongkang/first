...
<div class="page">
	...
	<form method="post" enctype="multipart/form-data" name="form_add" id="form_add">
		...
		<table class="table tb-type2">
			...
			<tbody>
				<tr class="noborder">
					<td colspan="2" class="required"><label class="switch-tab-title">
				...
				<tr class="noborder tabswitch-target">
					<td class="vatop rowform"> 总数：
						<input type="text" class="txt" name="total" style="width:40px;" />
						前缀：
						<input type="text" class="txt" name="prefix" style="width:130px;" /></td>
				...
				<tr class="noborder tabswitch-target" style="display:none;">
					<td class="vatop rowform"><textarea name="manual" style="width:300px;height:150px;"></textarea></td>
