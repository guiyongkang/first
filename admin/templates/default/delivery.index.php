...
<div class="page">
	<div class="fixed-bar">
		<div class="item-title">
			<h3>物流自提服务站管理</h3>
			<ul class="tab-base">
				<li><a href="<?php echo urlAdmin('delivery', 'index');?>" <?php if (isset($output['sign']) && $output['sign'] != 'verify') {?>class="current"<?php }?>><span><?php echo $lang['nc_manage'];?></span></a></li>
				<li><a href="<?php echo urlAdmin('delivery', 'index', array('sign' => 'verify'));?>" <?php if (isset($output['sign']) && $output['sign'] == 'verify') {?>class="current"<?php }?>><span>等待审核</span></a></li>
		...
		<table class="tb-type1 noborder search">
			<tbody>
				<tr>
					...
					<td><input type="text" value="<?php echo isset($output['search_name']) ? $output['search_name'] : '';?>" name="search_name" id="search_name" class="txt"></td>
		...
		<table class="table tb-type2">
			...
			<tbody>
				...
				<tr class="hover">
					...
					<td><p><?php echo $v['dlyp_address_name'];?></p>
						<p><?php echo $v['dlyp_area_info'];?>&nbsp;&nbsp;<?php echo $v['dlyp_address'];?></p></td>
