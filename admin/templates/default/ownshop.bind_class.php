			...
			<tfoot>
				<tr class="tfoot">
					...
					　　<label for="checkallBottom">全选</label>
						<a class="btn" onclick="if(confirm('您确定要删除该店铺等级吗？')){$('#form_bd').submit();}" href="JavaScript:void(0);"> <span>删除</span> </a>
						<?php if(!empty($output['store_bind_class_list']) && is_array($output['store_bind_class_list'])){ ?>
	...
	<table class="table tb-type2" >
		...
		<tbody>
			...
			<tr class="noborder">
				...
				　　<form id="add_form" action="<?php echo urlAdmin('ownshop', 'bind_class_add');?>" method="post">
