		...
		<tbody>
			...
			<tr>
				<td><ul>
						...
						<li style="display:none;"><?php echo $lang['brand_index_help3'];?></li>
					</ul></td>
			</tr>
		</tbody>
	</table>
			...
			<tbody>
				...
				<tr class="hover edit">
					...
					<td class="align-center yes-onoff"><?php if($v['brand_recommend'] == '0'){ ?>
						<a href="JavaScript:void(0);" class=" disabled" ajax_branch='brand_recommend' nc_type="inline_edit" fieldname="brand_recommend" fieldid="<?php echo $v['brand_id']?>" fieldvalue="0" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
						<?php }else{ ?>
						<a href="JavaScript:void(0);" class=" enabled" ajax_branch='brand_recommend' nc_type="inline_edit" fieldname="brand_recommend" fieldid="<?php echo $v['brand_id']?>" fieldvalue="1"  title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo APP_TEMPLATES_URL;?>/images/transparent.gif"></a>
						<?php } ?></td>
