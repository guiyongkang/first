            ...
            <tbody>
              ...
              <tr>
                <td class="w60 picture">
					<div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo APP_URL;?>/index.php?act=show_live_groupbuy&op=groupbuy_detail&groupbuy_id=<?php echo $output['live_order']['groupbuy_id'];?>" target="_blank"><img src="<?php echo lgthumb($output['live_order']['groupbuy_pic'], 'small');?>" style=" max-width: 56px; max-height: 56px;" /> </a></span></div>
				</td>
                <td class="w50pre">
					<p><a href="<?php echo APP_URL;?>/index.php?act=show_live_groupbuy&op=groupbuy_detail&groupbuy_id=<?php echo $output['live_order']['groupbuy_id'];?>" target="_blank"><?php echo $output['live_order']['item_name'];?></a></p>
				</td>
