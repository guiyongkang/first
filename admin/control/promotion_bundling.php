...
class promotion_bundling extends SystemControl
{
    public function __construct()
    {
        parent::__construct();
        //读取语言包
        core\language::read('promotion_bundling');
        //检查审核功能是否开启
    ...
    public function bundling_quotaOp()
    {
        ...
        core\tpl::output('show_page', $page);
        // 状态数组
        $state_array = array(0 => core\language::get('bundling_state_0'), 1 => core\language::get('bundling_state_1'));
        core\tpl::output('state_array', $state_array);
        core\tpl::output('list', $bundling_quota_list);
        core\tpl::showpage('promotion_bundling_quota.list');
    }
    /**
     * 活动管理
     */
    public function bundling_listOp()
    {
        ...
        core\tpl::showpage('promotion_bundling.list');
    }
    /**
     * 设置
     */
    public function bundling_settingOp()
    {
        ...
        if (chksubmit()) {
            ...
            $obj_validate->validateparam = array(array("input" => $_POST["promotion_bundling_price"], "require" => "true", 'validator' => 'Number', "message" => core\language::get('bundling_price_error')), array("input" => $_POST["promotion_bundling_sum"], "require" => "true", 'validator' => 'Number', "message" => core\language::get('bundling_sum_error')), array("input" => $_POST["promotion_bundling_goods_sum"], "require" => "true", 'validator' => 'Number', "message" => core\language::get('bundling_goods_sum_error')));
            ...
            if ($return) {
                $this->log(lang('nc_set,nc_promotion_bundling'));
        ...
        core\tpl::showpage('promotion_bundling.setting');
    }
    /**
     * 删除套餐活动
     */
