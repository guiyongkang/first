...
class offpay_area extends SystemControl
{
    ...
    public function indexOp()
    {
        ...
        if (!defined('DEFAULT_PLATFORM_STORE_ID')) {
            error('请系统管理员配置完自营店铺后再设置货到付款', 'index.php?act=dashboard&op=aboutus');
        }
        ...
        core\tpl::output('province_array', $area_array);
        ...
        core\tpl::output('province_checked_array', $province_array);
        core\tpl::showpage('offpay_area.index');
    }
}