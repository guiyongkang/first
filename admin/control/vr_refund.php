...
class vr_refund extends SystemControl
{
    ...
    public function refund_manageOp()
    {
        ...
        core\tpl::output('show_page', $model_vr_refund->showpage());
        core\tpl::showpage('vr_refund_manage.list');
    }
    /**
     * 所有记录
     */
    public function refund_allOp()
    {
        ...
        core\tpl::output('refund_list', $refund_list);
        core\tpl::output('show_page', $model_vr_refund->showpage());
        core\tpl::showpage('vr_refund_all.list');
    }
    /**
     * 审核页
     *
    ...
    public function editOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                success(core\language::get('nc_common_save_succ'), 'index.php?act=vr_refund&op=refund_manage');
            } else {
                error(core\language::get('nc_common_save_fail'));
            }
        }
        ...
        core\tpl::output('code_array', $code_array);
        core\tpl::showpage('vr_refund.edit');
    }
    /**
     * 查看页
     *
    ...
    public function viewOp()
    {
        ...
        $code_array = explode(',', $refund['code_sn']);
        core\tpl::output('code_array', $code_array);
        core\tpl::showpage('vr_refund.view');
    }
    /**
     * 微信退款
     *
    ...
    public function alipayOp()
    {
        ...
        if (!empty($detail_array) && $detail_array['refund_code'] == 'alipay') {
            ...
            if ($refund_amount > 0) {
                ...
                $parameter['notify_url'] = APP_URL . "/api/refund/alipay/vr_notify_url.php";
