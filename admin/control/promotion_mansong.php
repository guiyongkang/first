...
class promotion_mansong extends SystemControl
{
    public function __construct()
    {
        parent::__construct();
        //读取语言包
        core\language::read('promotion_mansong');
        //检查审核功能是否开启
        if (isset($_GET['promotion_allow']) && intval($_GET['promotion_allow']) !== 1 && intval(core\config::get('promotion_allow')) !== 1) {
            $url = array(array('url' => 'index.php?act=promotion_mansong&promotion_allow=1', 'msg' => core\language::get('open')), array('url' => 'index.php?act=dashboard&op=welcome', 'msg' => core\language::get('close')));
    ...
    public function mansong_listOp()
    {
        ...
        core\tpl::showpage('promotion_mansong.list');
    }
    /**
     * 活动详细信息
     * temp
    ...
    public function mansong_detailOp()
    {
        ...
        core\tpl::showpage('promotion_mansong.detail');
    }
    /**
     * 满即送活动取消
     **/
    ...
    public function mansong_quotaOp()
    {
        ...
        core\tpl::output('show_page', $model_mansong_quota->showpage());
        $this->show_menu('mansong_quota');
        core\tpl::showpage('promotion_mansong_quota.list');
    }
    /**
     * 设置
     **/
    public function mansong_settingOp()
    {
        ...
        core\tpl::showpage('promotion_mansong.setting');
    }
    public function mansong_setting_saveOp()
    {
        ...
        if ($result === true) {
            $this->log(lang('nc_config,nc_promotion_mansong,mansong_price'));
    ...
    {
        $menu_array = array('mansong_list' => array('menu_type' => 'link', 'menu_name' => core\language::get('mansong_list'), 'menu_url' => urlAdmin('promotion_mansong', 'mansong_list')), 'mansong_quota' => array('menu_type' => 'link', 'menu_name' => core\language::get('mansong_quota'), 'menu_url' => urlAdmin('promotion_mansong', 'mansong_quota')), 'mansong_detail' => array('menu_type' => 'link', 'menu_name' => core\language::get('mansong_detail'), 'menu_url' => urlAdmin('promotion_mansong', 'mansong_detail')), /*'mansong_setting' => array('menu_type' => 'link', 'menu_name' => core\language::get('mansong_setting'), 'menu_url' => urlAdmin('promotion_mansong', 'mansong_setting'))*/);
