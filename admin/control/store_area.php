...
class store_area extends SystemControl
{
    private $links = array(array('url' => 'act=store_area&op=store_area', 'lang' => 'nc_manage'), array('url' => 'act=store_area&op=store_area_add', 'lang' => 'nc_new'), array('url' => 'act=store_area&op=store_area_export', 'lang' => 'store_area_index_export'), array('url' => 'act=store_area&op=store_area_import', 'lang' => 'store_area_index_import'), array('url' => 'act=store_area&op=tag', 'lang' => 'store_area_index_tag'));
    ...
    public function listOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($_POST['submit_type'] == 'set') {
                ...
                if (!empty($new_list)) {
                    ...
                    $this->log(lang('nc_delete,area_index_class') . '[ID:' . $set_areas . ']', 0);
        ...
        if ($_GET['ajax'] == '1') {
            ...
            if (strtoupper(CHARSET) == 'GBK') {
                $area_list = core\language::getUTF8($area_list);
            }
            ...
            core\tpl::output('store_list', $store_own_list);
            core\tpl::showpage('store_area.index2');
        }
    }
