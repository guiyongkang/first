...
class store_joinin extends SystemControl
{
    ...
    public function edit_infoOp()
    {
        ...
        if (chksubmit()) {
            ...
            success(core\language::get('nc_common_save_succ'), 'index.php?act=store_joinin&op=edit_info');
        }
        core\tpl::output('size', $size);
        core\tpl::output('pic', $info['pic']);
        core\tpl::output('show_txt', $info['show_txt']);
        core\tpl::showpage('store_joinin_pic');
    }
    /**
     * 入驻指南
     *
    ...
    public function help_listOp()
    {
        ...
        core\tpl::showpage('store_joinin_help');
    }
    /**
     * 编辑入驻指南
     *
    ...
    public function edit_helpOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                ...
                success(core\language::get('nc_common_save_succ'), 'index.php?act=store_joinin&op=help_list');
            } else {
        ...
        core\tpl::showpage('store_joinin_help.edit');
    }
    /**
     * 上传图片
     */
