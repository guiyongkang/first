...
class withdraw extends SystemControl
{
    public function __construct()
    {
        parent::__construct();
        core\language::read('withdraw');
    }
    /**
     * 提现方法管理
     */
    ...
    public function article_class_addOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($error != '') {
                ...
                if ($result) {
                    $url = array(array('url' => 'index.php?act=article_class&op=article_class_add&ac_parent_id=' . intval($_POST['ac_parent_id']), 'msg' => $lang['article_class_add_class']), array('url' => 'index.php?act=article_class&op=article_class', 'msg' => $lang['article_class_add_back_to_list']));
        ...
        core\tpl::output('ac_parent_id', intval($_GET['ac_parent_id']));
