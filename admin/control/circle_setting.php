...
class circle_setting extends SystemControl
{
    ...
    public function indexOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($result) {
                ...
                if (intval($_POST['c_isuse']) == 1) {
                    $this->log(lang('nc_circle_open'));
                } else {
                    $this->log(lang('nc_circle_close'));
                }
        ...
        core\tpl::showpage('circle_setting.index');
    }
    /**
     * SEO 设置
     */
    public function seoOp()
    {
        ...
        $list_setting = $model_setting->getListSetting();
        core\tpl::output('list_setting', $list_setting);
        core\tpl::showpage('circle_setting.seo');
    }
    /**
     * SEC 设置
     */
    public function secOp()
    {
        ...
        $list_setting = $model_setting->getListSetting();
        core\tpl::output('list_setting', $list_setting);
        core\tpl::showpage('circle_setting.sec');
    }
    /**
     * 成员等级
     */
    public function expOp()
    {
        ...
        $list_setting = $model_setting->getListSetting();
        core\tpl::output('list_setting', $list_setting);
        core\tpl::showpage('circle_setting.exp');
    }
    /**
     * 圈子首页广告
     */
    public function adv_manageOp()
    {
        ...
        core\tpl::showpage('circle_setting.adv');
    }
    /**
     * 添加超级管理
     */
    public function superaddOp()
    {
        if (chksubmit()) {
            ...
            if ($result) {
                success(lang('nc_common_op_succ'), urlAdmin('circle_setting', 'super_list'));
            } else {
                error(lang('nc_common_op_fail'));
            }
        }
        core\tpl::showpage('circle_setting.super_add');
    }
    /**
     * 超级管理列表
     */
    public function super_listOp()
    {
        ...
        core\tpl::output('cm_list', $cm_list);
        core\tpl::showpage('circle_setting.super_list');
    }
    /**
     * 选择超管
     */
    ...
    {
        core\tpl::output('search_url', urlAdmin('circle_setting', 'member_search'));
