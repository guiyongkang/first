...
class operation extends SystemControl
{
    private $links = array(array('url' => 'act=operation&op=setting', 'lang' => 'nc_operation_set'));
    ...
    public function settingOp()
    {
        ...
        if (chksubmit()) {
            ...
            if ($error != '') {
                ...
                if ($result === true) {
                    $this->log(lang('nc_edit,nc_operation,nc_operation_set'), 1);
        ...
        core\tpl::showpage('operation.setting');
    }
}