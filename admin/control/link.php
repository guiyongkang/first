...
class link extends SystemControl
{
    public function __construct()
    {
        parent::__construct();
        core\language::read('link');
    }
    /**
     * 合作伙伴
     */
    public function linkOp()
    {
        ...
        core\tpl::output('search_link_title', $_GET['search_link_title']);
        /**
         * 分页
         */
        $page = new lib\page();
    ...
    public function link_addOp()
    {
        ...
        if ($_POST['form_submit'] == 'ok') {
            ...
            $obj_validate->validateparam = array(array("input" => $_POST["link_title"], "require" => "true", "message" => $lang['link_add_title_null']), array("input" => $_POST["link_sort"], "require" => "true", 'validator' => 'Number', "message" => $lang['link_add_sort_int']));
            ...
            if ($error != '') {
                ...
                if ($result) {
                    //H('link',null);;
                    $url = array(array('url' => 'index.php?act=link&op=link_add', 'msg' => $lang['link_add_again']), array('url' => 'index.php?act=link&op=link', 'msg' => $lang['link_add_back_to_list']));
        ...
        if ($_POST['form_submit'] == 'ok') {
            ...
            if ($error != '') {
                ...
                if ($result) {
                    ...
                    $url = array(array('url' => 'index.php?act=link&op=link_edit&link_id=' . intval($_POST['link_id']), 'msg' => $lang['link_edit_again']), array('url' => 'index.php?act=link&op=link', 'msg' => $lang['link_add_back_to_list']));
