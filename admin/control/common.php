...
class common extends SystemControl
{
    ...
    public function pic_uploadOp()
    {
        if (chksubmit()) {
            ...
            $upload->set('thumb_width', empty($_GET['width']) ? 500 : $_GET['width']);
            $upload->set('thumb_height', empty($_GET['height']) ? 499 : $_GET['height']);
    ...
    {
        core\language::read('admin_common');
        ...
        core\tpl::showpage('common.pic_cut', 'null_layout');
    }
    /**
     * 查询每月的周数组
     */
