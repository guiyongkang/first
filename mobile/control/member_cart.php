...
class member_cart extends mobileMemberControl
{
    ...
    public function cart_listOp()
    {
        ...
        foreach ($cart_list as $key => $val) {
            ...
            if (!empty($goods_data['goods_promotion_type'])) {
    ...
    public function cart_addOp()
    {
        ...
        if (!empty($goods_info['is_virtual']) || !empty($goods_info['is_fcode']) || !empty($goods_info['is_book'])) {
