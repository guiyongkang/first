...
class member_vr_buy extends mobileMemberControl
{
    ...
    public function buy_step3Op()
    {
        ...
        //是否使用充值卡支付0是/1否
        $input['rcb_pay'] = isset($_POST['rcb_pay']) ? intval($_POST['rcb_pay']) : 0;
        //是否使用预存款支付0是/1否
        $input['pd_pay'] = isset($_POST['pd_pay']) ? intval($_POST['pd_pay']) : 0;
        $input['order_from'] = 2;
    ...
    public function payOp()
    {
        ...
        $pay_info['pay_sn'] = isset($order_info['pay_sn']) ? $order_info['pay_sn'] : '';
