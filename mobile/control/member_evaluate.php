...
class member_evaluate extends mobileMemberControl
{
    ...
    public function saveOp()
    {
        ...
        foreach ($order_goods as $value) {
            ...
            $evaluate_goods_info['geval_isanonymous'] = !empty($_POST['goods'][$value['rec_id']]['anony']) ? 1 : 0;
        ...
        $store_desccredit = isset($_POST['store_desccredit']) ? intval($_POST['store_desccredit']) : 0;
        if ($store_desccredit <= 0 || $store_desccredit > 5) {
            $store_desccredit = 5;
        }
        $store_servicecredit = isset($_POST['store_servicecredit']) ? intval($_POST['store_servicecredit']) : 0;
        if ($store_servicecredit <= 0 || $store_servicecredit > 5) {
            $store_servicecredit = 5;
        }
        $store_deliverycredit = isset($_POST['store_deliverycredit']) ? intval($_POST['store_deliverycredit']) : 0;
