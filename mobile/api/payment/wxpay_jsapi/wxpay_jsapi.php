...
class wxpay_jsapi
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            ...
            'notifyUrl' => APP_URL . '/api/payment/wxpay_jsapi/notify_url.php',
            'finishedUrl' => WAP_SITE_URL . '/tmpl/member/payment_result.html?attach=_attach_',
            'undoneUrl' => WAP_SITE_URL . '/tmpl/member/payment_result_failed.html?attach=_attach_',
