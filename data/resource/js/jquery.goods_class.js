			...
			$.ajax({
				...
				success: function(data){
					...
					for(var i = 0; i < data.length; i++){
						...
						if(data[i].gc_show == 0){
							src += '<a href=\'JavaScript:void(0);\' class=\'tooltip disabled\' fieldvalue=\'0\' fieldid=\''+data[i].gc_id+'\' ajax_branch=\'goods_class_show\' fieldname=\'gc_show\' nc_type=\'inline_edit\'><img src=\''+APP_TEMPLATES_URL+'/images/transparent.gif\'></a>';
						}else{
							src += '<a href=\'JavaScript:void(0);\' class=\'tooltip enabled\' fieldvalue=\'1\' fieldid=\''+data[i].gc_id+'\' ajax_branch=\'goods_class_show\' fieldname=\'gc_show\' nc_type=\'inline_edit\'><img src=\''+APP_TEMPLATES_URL+'/images/transparent.gif\'></a>';
						}
						src += '</td>';
						*/
						//类型
