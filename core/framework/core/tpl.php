...
class tpl
{
    ...
    public static function showpage($page_name = '', $layout = '', $time = 2000)
    {
        ...
        if (file_exists($tpl_file)) {
            ...
            //页头
            $output['html_title'] = !empty($output['html_title']) ? $output['html_title'] : config::get('site_name');
            $output['seo_keywords'] = !empty($output['seo_keywords']) ? $output['seo_keywords'] : config::get('site_name');
            $output['seo_description'] = !empty($output['seo_description']) ? $output['seo_description'] : config::get('site_name');
