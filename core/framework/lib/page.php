...
class page
{
    ...
    public function __construct()
    {
        ...
        $this->pre_home = isset($lang['first_page']) ? $lang['first_page'] : '';
        $this->pre_last = isset($lang['last_page']) ? $lang['last_page'] : '';
        $this->pre_page = isset($lang['pre_page']) ? $lang['pre_page'] : '';
        $this->next_page = isset($lang['next_page']) ? $lang['next_page'] : '';
        /**
         * 设置当前页码
         */
		$_GET[$this->page_name] = isset($_GET[$this->page_name]) ? $_GET[$this->page_name] : 1;
