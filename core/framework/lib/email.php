...
final class email
{
    ...
    {
        $this->set('email_server', core\config::get('email_host'));
        $this->set('email_port', core\config::get('email_port'));
        $this->set('email_user', core\config::get('email_id'));
        $this->set('email_password', core\config::get('email_pass'));
        $this->set('email_from', core\config::get('email_addr'));
        $this->set('site_name', core\config::get('site_name'));
    ...
    {
        $message = preg_replace("/href\\=\"(?!http\\:\\/\\/)(.+?)\"/i", 'href="' . APP_URL . '\\1"', $message);
        $tmp = "<html><head>";
